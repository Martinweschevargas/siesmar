...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasRegistroPerdidaRoboIdentificacionController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        RegistroPerdidaRoboIdentificacionComfas registroPerdidaRoboIdentificacionComfasBL = new();
        ...
        public ComfasRegistroPerdidaRoboIdentificacionController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Cuadro de Registro de Perdida o Robo de Tarjeta de Identidad Naval del Personal de la Fuerza de Superficie", FromController = typeof(HomeController))]
        ...
        {
            List<RegistroPerdidaRoboIdentificacionComfasDTO> select = registroPerdidaRoboIdentificacionComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, string FechaInforme, int GradoPersonalMilitarId, int EspecialidadGenericaPersonalId, int CIPPersonal, 
            string FechaIncidente, string Motivo, string MensajeNavalReferencia)
        {
            RegistroPerdidaRoboIdentificacionComfasDTO registroPerdidaRoboIdentificacionComfasDTO = new();
            registroPerdidaRoboIdentificacionComfasDTO.UnidadNavalId = UnidadNavalId;
            registroPerdidaRoboIdentificacionComfasDTO.FechaInforme = FechaInforme;
            registroPerdidaRoboIdentificacionComfasDTO.GradoPersonalMilitarId = GradoPersonalMilitarId;
            registroPerdidaRoboIdentificacionComfasDTO.EspecialidadGenericaPersonalId = EspecialidadGenericaPersonalId;
            registroPerdidaRoboIdentificacionComfasDTO.CIPPersonal = CIPPersonal;
            registroPerdidaRoboIdentificacionComfasDTO.FechaIncidente = FechaIncidente;
            registroPerdidaRoboIdentificacionComfasDTO.Motivo = Motivo;
            registroPerdidaRoboIdentificacionComfasDTO.MensajeNavalReferencia = MensajeNavalReferencia;
            registroPerdidaRoboIdentificacionComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = registroPerdidaRoboIdentificacionComfasBL.AgregarRegistro(registroPerdidaRoboIdentificacionComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(registroPerdidaRoboIdentificacionComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, string FechaInforme, int GradoPersonalMilitarId, int EspecialidadGenericaPersonalId,
            int CIPPersonal, string FechaIncidente, string Motivo, string MensajeNavalReferencia)
        {
            RegistroPerdidaRoboIdentificacionComfasDTO registroPerdidaRoboIdentificacionComfasDTO = new();
            registroPerdidaRoboIdentificacionComfasDTO.RegistroPerdidaRoboIdentificacionId = Id;
            registroPerdidaRoboIdentificacionComfasDTO.UnidadNavalId = UnidadNavalId;
            registroPerdidaRoboIdentificacionComfasDTO.FechaInforme = FechaInforme;
            registroPerdidaRoboIdentificacionComfasDTO.GradoPersonalMilitarId = GradoPersonalMilitarId;
            registroPerdidaRoboIdentificacionComfasDTO.EspecialidadGenericaPersonalId = EspecialidadGenericaPersonalId;
            ...
            var IND_OPERACION = registroPerdidaRoboIdentificacionComfasBL.ActualizarFormato(registroPerdidaRoboIdentificacionComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (registroPerdidaRoboIdentificacionComfasBL.EliminarFormato(registroPerdidaRoboIdentificacionComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = registroPerdidaRoboIdentificacionComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = registroPerdidaRoboIdentificacionComfasBL.ObtenerLista();
