...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasPlanAnualRecaerDistribucionPresupuestoController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();
        PlanAnualRecaerDistribucionPresupuestoComfas planAnualRecaerDistribucionPresupuestoComfasBL = new();
        UnidadNaval unidadNavalBL = new();

        public ComfasPlanAnualRecaerDistribucionPresupuestoController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Cuadro de Plan Anual Recar Distribución Anual deL Presupuesto", FromController = typeof(HomeController))]
        ...
        {
            List<PlanAnualRecaerDistribucionPresupuestoComfasDTO> select = planAnualRecaerDistribucionPresupuestoComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, int TotalAsignadoDependencia, decimal ServicioSimac, decimal ServicioIndustriaPrivada,
            decimal AdquisicionRepuestos, decimal Equipos, decimal PorcentajeAvanceEjecucion)
        {
            PlanAnualRecaerDistribucionPresupuestoComfasDTO planAnualRecaerDistribucionPresupuestoComfasDTO = new();
            planAnualRecaerDistribucionPresupuestoComfasDTO.UnidadNavalId = UnidadNavalId;
            planAnualRecaerDistribucionPresupuestoComfasDTO.TotalAsignadoDependencia = TotalAsignadoDependencia;
            planAnualRecaerDistribucionPresupuestoComfasDTO.ServicioSimac = ServicioSimac;
            planAnualRecaerDistribucionPresupuestoComfasDTO.ServicioIndustriaPrivada = ServicioIndustriaPrivada;
            planAnualRecaerDistribucionPresupuestoComfasDTO.AdquisicionRepuestos = AdquisicionRepuestos;
            planAnualRecaerDistribucionPresupuestoComfasDTO.Equipos = Equipos;
            planAnualRecaerDistribucionPresupuestoComfasDTO.PorcentajeAvanceEjecucion = PorcentajeAvanceEjecucion;
            planAnualRecaerDistribucionPresupuestoComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = planAnualRecaerDistribucionPresupuestoComfasBL.AgregarRegistro(planAnualRecaerDistribucionPresupuestoComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(planAnualRecaerDistribucionPresupuestoComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, int TotalAsignadoDependencia, decimal ServicioSimac, decimal ServicioIndustriaPrivada,
            decimal AdquisicionRepuestos, decimal Equipos, decimal PorcentajeAvanceEjecucion)
        {
            PlanAnualRecaerDistribucionPresupuestoComfasDTO planAnualRecaerDistribucionPresupuestoComfasDTO = new();
            planAnualRecaerDistribucionPresupuestoComfasDTO.PlanAnualRecaerDistribucionPresupuestoId = Id;
            planAnualRecaerDistribucionPresupuestoComfasDTO.UnidadNavalId = UnidadNavalId;
            planAnualRecaerDistribucionPresupuestoComfasDTO.TotalAsignadoDependencia = TotalAsignadoDependencia;
            planAnualRecaerDistribucionPresupuestoComfasDTO.ServicioSimac = ServicioSimac;
            planAnualRecaerDistribucionPresupuestoComfasDTO.ServicioIndustriaPrivada = ServicioIndustriaPrivada;
            ...
            var IND_OPERACION = planAnualRecaerDistribucionPresupuestoComfasBL.ActualizarFormato(planAnualRecaerDistribucionPresupuestoComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (planAnualRecaerDistribucionPresupuestoComfasBL.EliminarFormato(planAnualRecaerDistribucionPresupuestoComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = planAnualRecaerDistribucionPresupuestoComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = planAnualRecaerDistribucionPresupuestoComfasBL.ObtenerLista();
