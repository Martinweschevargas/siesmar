...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class Comgoe3AlistamientoCombustibleLubricanteComgoeController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        AlistamientoCombustibleLubricanteComgoe alistamientoCombustibleLubricanteComgoeBL = new();

        UnidadNaval unidadNavalBL = new();
        AlistamientoCombustibleLubricante2 alistamientoCombustibleLubricante2BL = new();

        public Comgoe3AlistamientoCombustibleLubricanteComgoeController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<AlistamientoCombustibleLubricanteComgoeDTO> select = alistamientoCombustibleLubricanteComgoeBL.ObtenerLista();
        ...
        {
            AlistamientoCombustibleLubricanteComgoeDTO alistamientoCombustibleLubricanteComgoeDTO = new();
            alistamientoCombustibleLubricanteComgoeDTO.UnidadNavalId = UnidadNavalId;
            alistamientoCombustibleLubricanteComgoeDTO.AlistamientoCombustibleLubricante2Id = AlistamientoCombustibleLubricante2Id;

            alistamientoCombustibleLubricanteComgoeDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoCombustibleLubricanteComgoeBL.AgregarRegistro(alistamientoCombustibleLubricanteComgoeDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoCombustibleLubricanteComgoeBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, int AlistamientoCombustibleLubricante2Id)
        {
            AlistamientoCombustibleLubricanteComgoeDTO alistamientoCombustibleLubricanteComgoeDTO = new();
            alistamientoCombustibleLubricanteComgoeDTO.AlistamientoCombustibleLubricanteId = Id;
            alistamientoCombustibleLubricanteComgoeDTO.UnidadNavalId = UnidadNavalId;
            alistamientoCombustibleLubricanteComgoeDTO.AlistamientoCombustibleLubricante2Id = AlistamientoCombustibleLubricante2Id;
            ...
            var IND_OPERACION = alistamientoCombustibleLubricanteComgoeBL.ActualizarFormato(alistamientoCombustibleLubricanteComgoeDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoCombustibleLubricanteComgoeBL.EliminarFormato(alistamientoCombustibleLubricanteComgoeDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoCombustibleLubricanteComgoeBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoCombustibleLubricanteComgoeBL.ObtenerLista();
