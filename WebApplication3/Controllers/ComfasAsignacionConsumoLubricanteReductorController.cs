...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasAsignacionConsumoLubricanteReductorController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();
        AsignacionConsumoLubricanteReductorComfas asignacionConsumoLubricanteReductorComfasBL = new();
        UnidadNaval unidadNavalBL = new();

        public ComfasAsignacionConsumoLubricanteReductorController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Asignación  Lubricantes de Reductores", FromController = typeof(HomeController))]
        ...
        {
            List<AsignacionConsumoLubricanteReductorComfasDTO> select = asignacionConsumoLubricanteReductorComfasBL.ObtenerLista();
        ...
        {
            AsignacionConsumoLubricanteReductorComfasDTO asignacionConsumoCombustibleComfasDTO = new();
            asignacionConsumoCombustibleComfasDTO.AnioAsignacion = AnioAsignacion;
            asignacionConsumoCombustibleComfasDTO.UnidadNavalId = UnidadNavalId;
            asignacionConsumoCombustibleComfasDTO.CapacidadMaximaAlmacen = CapacidadMaximaAlmacen;
            asignacionConsumoCombustibleComfasDTO.Asignado = Asignado;
            asignacionConsumoCombustibleComfasDTO.ConsumoTotalAnualPuerto = ConsumoTotalAnualPuerto;
            asignacionConsumoCombustibleComfasDTO.ConsumoTotalAnualNavegacion = ConsumoTotalAnualNavegacion;
            asignacionConsumoCombustibleComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = asignacionConsumoLubricanteReductorComfasBL.AgregarRegistro(asignacionConsumoCombustibleComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(asignacionConsumoLubricanteReductorComfasBL.BuscarFormato(Id));
        }
        ...
        {
            AsignacionConsumoLubricanteReductorComfasDTO asignacionConsumoCombustibleComfasDTO = new();
            asignacionConsumoCombustibleComfasDTO.AsignacionConsumoLubricanteReductorId = Id;
            asignacionConsumoCombustibleComfasDTO.AnioAsignacion = AnioAsignacion;
            asignacionConsumoCombustibleComfasDTO.UnidadNavalId = UnidadNavalId;
            asignacionConsumoCombustibleComfasDTO.CapacidadMaximaAlmacen = CapacidadMaximaAlmacen;
            asignacionConsumoCombustibleComfasDTO.Asignado = Asignado;
            ...
            var IND_OPERACION = asignacionConsumoLubricanteReductorComfasBL.ActualizarFormato(asignacionConsumoCombustibleComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (asignacionConsumoLubricanteReductorComfasBL.EliminarFormato(asignacionConsumoCombustibleComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = asignacionConsumoLubricanteReductorComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = asignacionConsumoLubricanteReductorComfasBL.ObtenerLista();
