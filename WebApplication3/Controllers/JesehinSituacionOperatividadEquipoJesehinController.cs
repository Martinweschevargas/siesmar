...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class JesehinSituacionOperatividadEquipoJesehinController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        SituacionOperatividadEquipoJesehin formatoSituacionOperatividadEquipoJesehinBL = new();
        ...
        public JesehinSituacionOperatividadEquipoJesehinController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<SituacionOperatividadEquipoJesehinDTO> select = formatoSituacionOperatividadEquipoJesehinBL.ObtenerLista();
        ...
        {
            SituacionOperatividadEquipoJesehinDTO formatoSituacionOperatividadEquipoJesehinDTO = new();
            formatoSituacionOperatividadEquipoJesehinDTO.DescripcionMaterialId = DescripcionMaterialId;
            formatoSituacionOperatividadEquipoJesehinDTO.Cantidad = Cantidad;
            formatoSituacionOperatividadEquipoJesehinDTO.UnidadNavalId = UnidadNavalId;
            formatoSituacionOperatividadEquipoJesehinDTO.Ubicacion = Ubicacion;
            formatoSituacionOperatividadEquipoJesehinDTO.DepartamentoUbigeoId = DepartamentoUbigeoId;
            formatoSituacionOperatividadEquipoJesehinDTO.ProvinciaUbigeoId = ProvinciaUbigeoId;
            formatoSituacionOperatividadEquipoJesehinDTO.DistritoUbigeoId = DistritoUbigeoId;
            formatoSituacionOperatividadEquipoJesehinDTO.CondicionId = CondicionId;
            formatoSituacionOperatividadEquipoJesehinDTO.Observaciones = Observaciones;
            
            formatoSituacionOperatividadEquipoJesehinDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = formatoSituacionOperatividadEquipoJesehinBL.AgregarRegistro(formatoSituacionOperatividadEquipoJesehinDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(formatoSituacionOperatividadEquipoJesehinBL.BuscarFormato(Id));
        }
        ...
        {
            SituacionOperatividadEquipoJesehinDTO formatoSituacionOperatividadEquipoJesehinDTO = new();
            formatoSituacionOperatividadEquipoJesehinDTO.SituacionOperatividadEquipoId = Id;
            formatoSituacionOperatividadEquipoJesehinDTO.DescripcionMaterialId = DescripcionMaterialId;
            formatoSituacionOperatividadEquipoJesehinDTO.Cantidad = Cantidad;
            formatoSituacionOperatividadEquipoJesehinDTO.UnidadNavalId = UnidadNavalId;
            formatoSituacionOperatividadEquipoJesehinDTO.Ubicacion = Ubicacion;
            ...
            var IND_OPERACION = formatoSituacionOperatividadEquipoJesehinBL.ActualizarFormato(formatoSituacionOperatividadEquipoJesehinDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (formatoSituacionOperatividadEquipoJesehinBL.EliminarFormato(formatoSituacionOperatividadEquipoJesehinDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = formatoSituacionOperatividadEquipoJesehinBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = formatoSituacionOperatividadEquipoJesehinBL.ObtenerLista();
