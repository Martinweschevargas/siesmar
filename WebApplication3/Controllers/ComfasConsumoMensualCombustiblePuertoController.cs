...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasConsumoMensualCombustiblePuertoController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();
        ConsumoMensualCombustiblePuertoComfas consumoMensualCombustiblePuertoComfasBL = new();
        UnidadNaval unidadNavalBL = new();
        Mes mesBL = new();


        public ComfasConsumoMensualCombustiblePuertoController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Cuadro de Reporte del Consumo Mensual de Combustible en Puerto", FromController = typeof(HomeController))]
        ...
        {
            List<ConsumoMensualCombustiblePuertoComfasDTO> select = consumoMensualCombustiblePuertoComfasBL.ObtenerLista();
        ...
        {
            ConsumoMensualCombustiblePuertoComfasDTO consumoMensualCombustiblePuertoComfasDTO = new();
            consumoMensualCombustiblePuertoComfasDTO.UnidadNavalId = UnidadNavalId;
            consumoMensualCombustiblePuertoComfasDTO.MesId = MesId;
            consumoMensualCombustiblePuertoComfasDTO.TotalMensual = TotalMensual;
            consumoMensualCombustiblePuertoComfasDTO.TotalAnual = TotalAnual;
            consumoMensualCombustiblePuertoComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = consumoMensualCombustiblePuertoComfasBL.AgregarRegistro(consumoMensualCombustiblePuertoComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(consumoMensualCombustiblePuertoComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id,  int UnidadNavalId, int MesId, int TotalMensual, int TotalAnual)
        {
            ConsumoMensualCombustiblePuertoComfasDTO consumoMensualCombustiblePuertoComfasDTO = new();
            consumoMensualCombustiblePuertoComfasDTO.ConsumoMensualCombustiblePuertoId = Id;
            consumoMensualCombustiblePuertoComfasDTO.UnidadNavalId = UnidadNavalId;
            consumoMensualCombustiblePuertoComfasDTO.MesId = MesId;
            consumoMensualCombustiblePuertoComfasDTO.TotalMensual = TotalMensual;
            consumoMensualCombustiblePuertoComfasDTO.TotalAnual = TotalAnual;
            ...
            var IND_OPERACION = consumoMensualCombustiblePuertoComfasBL.ActualizarFormato(consumoMensualCombustiblePuertoComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (consumoMensualCombustiblePuertoComfasBL.EliminarFormato(consumoMensualCombustiblePuertoComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = consumoMensualCombustiblePuertoComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = consumoMensualCombustiblePuertoComfasBL.ObtenerLista();
