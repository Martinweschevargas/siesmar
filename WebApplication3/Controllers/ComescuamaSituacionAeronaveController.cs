...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComescuamaSituacionAeronaveController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        SituacionAeronave situacionAeronaveBL = new();
        ...
        public ComescuamaSituacionAeronaveController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Situación de Aeronaves", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = unidadNavalDTO, data2 = tipoPlataformaAeronaveDTO, data3 = dependenciaDTO, data4 = distritoUbigeoDTO, 
                data5 = capacidadOperativaRequeridaDTO, data6 = condicionDTO});
        }
        public IActionResult CargaTabla()
        {
            List<SituacionAeronaveDTO> select = situacionAeronaveBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, string Categoria, int TipoPlataformaAeronaveId, int DependenciaId, string Ubicacion,
            string DescDepartamento, string DescProvincia, int DistritoUbigeoId, int CapacidadOperativaRequeridaId, int CondicionId, string Observaciones)
        {
            SituacionAeronaveDTO situacionAeronaveDTO = new();
            situacionAeronaveDTO.UnidadNavalId = UnidadNavalId;
            situacionAeronaveDTO.Categoria = Categoria;
            situacionAeronaveDTO.TipoPlataformaAeronaveId = TipoPlataformaAeronaveId;
            situacionAeronaveDTO.DependenciaId = DependenciaId;
            situacionAeronaveDTO.Ubicacion = Ubicacion;
            situacionAeronaveDTO.DescDepartamento = DescDepartamento;
            situacionAeronaveDTO.DescProvincia = DescProvincia;
            situacionAeronaveDTO.DistritoUbigeoId = DistritoUbigeoId;
            situacionAeronaveDTO.CapacidadOperativaRequeridaId = CapacidadOperativaRequeridaId;
            situacionAeronaveDTO.CondicionId = CondicionId;
            situacionAeronaveDTO.Observaciones = Observaciones;
            situacionAeronaveDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = situacionAeronaveBL.AgregarRegistro(situacionAeronaveDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(situacionAeronaveBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id,int UnidadNavalId, string Categoria, int TipoPlataformaAeronaveId, int DependenciaId, string Ubicacion,
            string DescDepartamento, string DescProvincia, int DistritoUbigeoId, int CapacidadOperativaRequeridaId, int CondicionId, string Observaciones)
        {
            SituacionAeronaveDTO situacionAeronaveDTO = new();
            situacionAeronaveDTO.SituacionAeronaveId = Id;
            situacionAeronaveDTO.UnidadNavalId = UnidadNavalId;
            situacionAeronaveDTO.Categoria = Categoria;
            situacionAeronaveDTO.TipoPlataformaAeronaveId = TipoPlataformaAeronaveId;
            situacionAeronaveDTO.DependenciaId = DependenciaId;
            ...
            var IND_OPERACION = situacionAeronaveBL.ActualizarFormato(situacionAeronaveDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (situacionAeronaveBL.EliminarFormato(situacionAeronaveDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = situacionAeronaveBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = situacionAeronaveBL.ObtenerLista();
