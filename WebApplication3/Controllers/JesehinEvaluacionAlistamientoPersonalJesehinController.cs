...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class JesehinEvaluacionAlistamientoPersonalJesehinController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        EvaluacionAlistamientoPersonalJesehin evaluacionAlistamientoPersonalJesehinBL = new();

        UnidadNaval unidadNavalBL = new();
        GradoPersonalMilitar gradoPersonalMilitarBL = new();
        EspecialidadGenericaPersonal especialidadGenericaPersonalBL = new();

        public JesehinEvaluacionAlistamientoPersonalJesehinController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<EvaluacionAlistamientoPersonalJesehinDTO> select = evaluacionAlistamientoPersonalJesehinBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, string FechaEvaluacion, int DNIPersonal, int CIPPersonal, string Cargo, int GradoPersonalMilitarId, int EspecialidadGenericaPersonalId, int GradoPersonalMilitarActual, int EspecialidadGenericaPersonalActual, decimal GradoJerarquico, decimal ServicioExperiencia, decimal EspecializacionProfesional, decimal CursoProfesionalRequerido, decimal PuntajeTotalPersonal)
        {
            EvaluacionAlistamientoPersonalJesehinDTO evaluacionAlistamientoPersonalJesehinDTO = new();
            evaluacionAlistamientoPersonalJesehinDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoPersonalJesehinDTO.FechaEvaluacion = FechaEvaluacion;
            evaluacionAlistamientoPersonalJesehinDTO.DNIPersonal = DNIPersonal;
            evaluacionAlistamientoPersonalJesehinDTO.CIPPersonal = CIPPersonal;
            evaluacionAlistamientoPersonalJesehinDTO.Cargo = Cargo;
            evaluacionAlistamientoPersonalJesehinDTO.GradoPersonalMilitarId = GradoPersonalMilitarId;
            evaluacionAlistamientoPersonalJesehinDTO.EspecialidadGenericaPersonalId = EspecialidadGenericaPersonalId;
            evaluacionAlistamientoPersonalJesehinDTO.GradoPersonalMilitarActual = GradoPersonalMilitarActual;
            evaluacionAlistamientoPersonalJesehinDTO.EspecialidadGenericaPersonalActual = EspecialidadGenericaPersonalActual;
            evaluacionAlistamientoPersonalJesehinDTO.GradoJerarquico = GradoJerarquico;
            evaluacionAlistamientoPersonalJesehinDTO.ServicioExperiencia = ServicioExperiencia;
            evaluacionAlistamientoPersonalJesehinDTO.EspecializacionProfesional = EspecializacionProfesional;
            evaluacionAlistamientoPersonalJesehinDTO.CursoProfesionalRequerido = CursoProfesionalRequerido;
            evaluacionAlistamientoPersonalJesehinDTO.PuntajeTotalPersonal = PuntajeTotalPersonal;
            
            evaluacionAlistamientoPersonalJesehinDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = evaluacionAlistamientoPersonalJesehinBL.AgregarRegistro(evaluacionAlistamientoPersonalJesehinDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(evaluacionAlistamientoPersonalJesehinBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, string FechaEvaluacion, int DNIPersonal, int CIPPersonal, string Cargo, int GradoPersonalMilitarId, int EspecialidadGenericaPersonalId, int GradoPersonalMilitarActual, int EspecialidadGenericaPersonalActual, decimal GradoJerarquico, decimal ServicioExperiencia, decimal EspecializacionProfesional, decimal CursoProfesionalRequerido, decimal PuntajeTotalPersonal)
        {
            EvaluacionAlistamientoPersonalJesehinDTO evaluacionAlistamientoPersonalJesehinDTO = new();
            evaluacionAlistamientoPersonalJesehinDTO.EvaluacionAlistamientoPersonalId = Id;
            evaluacionAlistamientoPersonalJesehinDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoPersonalJesehinDTO.FechaEvaluacion = FechaEvaluacion;
            evaluacionAlistamientoPersonalJesehinDTO.DNIPersonal = DNIPersonal;
            evaluacionAlistamientoPersonalJesehinDTO.CIPPersonal = CIPPersonal;
            ...
            var IND_OPERACION = evaluacionAlistamientoPersonalJesehinBL.ActualizarFormato(evaluacionAlistamientoPersonalJesehinDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (evaluacionAlistamientoPersonalJesehinBL.EliminarFormato(evaluacionAlistamientoPersonalJesehinDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = evaluacionAlistamientoPersonalJesehinBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = evaluacionAlistamientoPersonalJesehinBL.ObtenerLista();
