...
{
    public class ComesclaEvalAlistamientoPersonalController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        EvaluacionAlistamientoPersonalComescla evaluacionAlistamientoPersonalComesclaBL = new();
        ...
        public ComesclaEvalAlistamientoPersonalController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = unidadNavalDTO, data2 = especialidadGenericaPersonalDTO, data3 = gradoPersonalMilitarDTO });
        }

        public IActionResult CargaTabla()
        {
            List<EvaluacionAlistamientoPersonalComesclaDTO> select = evaluacionAlistamientoPersonalComesclaBL.ObtenerLista();
        ...
        public ActionResult Insertar( int UnidadNavalId, string FechaEvaluacion, int DNIPersonal, int CIPPersonal, string Cargo, 
        ...
        {
            EvaluacionAlistamientoPersonalComesclaDTO evaluacionAlistamientoPersonalComesclaDTO = new();
            evaluacionAlistamientoPersonalComesclaDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoPersonalComesclaDTO.FechaEvaluacion = FechaEvaluacion;
            evaluacionAlistamientoPersonalComesclaDTO.DNIPersonal = DNIPersonal;
            evaluacionAlistamientoPersonalComesclaDTO.CIPPersonal = CIPPersonal;
            evaluacionAlistamientoPersonalComesclaDTO.Cargo = Cargo;
            evaluacionAlistamientoPersonalComesclaDTO.GradoPersonalMilitarEsperado = GradoPersonalMilitarEsperado;
            evaluacionAlistamientoPersonalComesclaDTO.EspecialidadGenericaEsperado = EspecialidadGenericaEsperado;
            evaluacionAlistamientoPersonalComesclaDTO.GradoPersonalMilitarActual = GradoPersonalMilitarActual;
            evaluacionAlistamientoPersonalComesclaDTO.EspecialidadGenericaActual = EspecialidadGenericaActual;
            evaluacionAlistamientoPersonalComesclaDTO.GradoJerarquico = GradoJerarquico;
            evaluacionAlistamientoPersonalComesclaDTO.ServicioExperiencia = ServicioExperiencia;
            evaluacionAlistamientoPersonalComesclaDTO.EspecializacionProfesional = EspecializacionProfesional;
            evaluacionAlistamientoPersonalComesclaDTO.CursoProfesionalRequerido = CursoProfesionalRequerido;
            evaluacionAlistamientoPersonalComesclaDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = evaluacionAlistamientoPersonalComesclaBL.AgregarRegistro(evaluacionAlistamientoPersonalComesclaDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(evaluacionAlistamientoPersonalComesclaBL.BuscarFormato(Id));
        }
        ...
        {
            EvaluacionAlistamientoPersonalComesclaDTO evaluacionAlistamientoPersonalComesclaDTO = new();
            evaluacionAlistamientoPersonalComesclaDTO.EvaluacionAlistamientoPersonalId = Id;
            evaluacionAlistamientoPersonalComesclaDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoPersonalComesclaDTO.FechaEvaluacion = FechaEvaluacion;
            evaluacionAlistamientoPersonalComesclaDTO.DNIPersonal = DNIPersonal;
            evaluacionAlistamientoPersonalComesclaDTO.CIPPersonal = CIPPersonal;
            ...
            var IND_OPERACION = evaluacionAlistamientoPersonalComesclaBL.ActualizarFormato(evaluacionAlistamientoPersonalComesclaDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (evaluacionAlistamientoPersonalComesclaBL.EliminarFormato(evaluacionAlistamientoPersonalComesclaDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = evaluacionAlistamientoPersonalComesclaBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = evaluacionAlistamientoPersonalComesclaBL.ObtenerLista();
