...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class CombasnaiOperatividadEquipoContraincendioController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        OperatividadEquipoContraincendioCombasnai operatividadEquipoContraincendioBL = new();
        ...
        public CombasnaiOperatividadEquipoContraincendioController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Situación de Operatividad de Equipos de Lucha Contraincendio", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = unidadNavalDTO, data2 = departamentoUbigeoDTO, data3 = provinciaUbigeoDTO,
                data4 = distritoUbigeoDTO, data5 = condicionDTO });
        }

        public IActionResult CargaTabla()
        {
            List<OperatividadEquipoContraincendioCombasnaiDTO> select = operatividadEquipoContraincendioBL.ObtenerLista();
        ...
        public ActionResult Insertar(int DescripcionMaterialId, int CantidadMaterial, string Ubicacion, int DepartamentoUbigeoId, int ProvinciaUbigeoId, 
            int DistritoUbigeoId, int CondicionId, string Observacion)
        {
            OperatividadEquipoContraincendioCombasnaiDTO operatividadEquipoContraincendioDTO = new();
            operatividadEquipoContraincendioDTO.DescripcionMaterialId = DescripcionMaterialId;
            operatividadEquipoContraincendioDTO.CantidadMaterial = CantidadMaterial;
            operatividadEquipoContraincendioDTO.Ubicacion = Ubicacion;
            operatividadEquipoContraincendioDTO.DepartamentoUbigeoId = DepartamentoUbigeoId;
            operatividadEquipoContraincendioDTO.ProvinciaUbigeoId = ProvinciaUbigeoId;
            operatividadEquipoContraincendioDTO.DistritoUbigeoId = DistritoUbigeoId;
            operatividadEquipoContraincendioDTO.CondicionId = CondicionId;
            operatividadEquipoContraincendioDTO.Observacion = Observacion;
            operatividadEquipoContraincendioDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = operatividadEquipoContraincendioBL.AgregarRegistro(operatividadEquipoContraincendioDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(operatividadEquipoContraincendioBL.BuscarFormato(Id));
        }
        ...
        {
            OperatividadEquipoContraincendioCombasnaiDTO operatividadEquipoContraincendioDTO = new();
            operatividadEquipoContraincendioDTO.OperatividadEquipoContraincendioId = Id;
            operatividadEquipoContraincendioDTO.DescripcionMaterialId = DescripcionMaterialId;
            operatividadEquipoContraincendioDTO.CantidadMaterial = CantidadMaterial;
            operatividadEquipoContraincendioDTO.Ubicacion = Ubicacion;
            operatividadEquipoContraincendioDTO.DepartamentoUbigeoId = DepartamentoUbigeoId;
            ...
            var IND_OPERACION = operatividadEquipoContraincendioBL.ActualizarFormato(operatividadEquipoContraincendioDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (operatividadEquipoContraincendioBL.EliminarFormato(operatividadEquipoContraincendioDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = operatividadEquipoContraincendioBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = operatividadEquipoContraincendioBL.ObtenerLista();
