...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasParteNumericoPersonalController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        ParteNumericoPersonalComfas ParteNumericoPersonalComfasBL = new();
        ...
        public ComfasParteNumericoPersonalController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Parte Numérico del Personal de la Fuerza de Superficie", FromController = typeof(HomeController))]
        ...
        {
            List<ParteNumericoPersonalComfasDTO> select = ParteNumericoPersonalComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar( int UnidadNavalId, string FechaParte, int GradoPersonalMilitarId, int EspecialidadGenericaPersonalId, 
            int PlantaOrganica, int PlantaActual, int EfectivoDeficit)
        {
            ParteNumericoPersonalComfasDTO ParteNumericoPersonalComfasDTO = new();
            ParteNumericoPersonalComfasDTO.UnidadNavalId = UnidadNavalId;
            ParteNumericoPersonalComfasDTO.FechaParte = FechaParte;
            ParteNumericoPersonalComfasDTO.GradoPersonalMilitarId = GradoPersonalMilitarId;
            ParteNumericoPersonalComfasDTO.EspecialidadGenericaPersonalId = EspecialidadGenericaPersonalId;
            ParteNumericoPersonalComfasDTO.PlantaOrganica = PlantaOrganica;
            ParteNumericoPersonalComfasDTO.PlantaActual = PlantaActual;
            ParteNumericoPersonalComfasDTO.EfectivoDeficit = EfectivoDeficit;
            ParteNumericoPersonalComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = ParteNumericoPersonalComfasBL.AgregarRegistro(ParteNumericoPersonalComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(ParteNumericoPersonalComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, string FechaParte, int GradoPersonalMilitarId, int EspecialidadGenericaPersonalId,
            int PlantaOrganica, int PlantaActual, int EfectivoDeficit)
        {
            ParteNumericoPersonalComfasDTO ParteNumericoPersonalComfasDTO = new();
            ParteNumericoPersonalComfasDTO.ParteNumericoPersonalComfasId = Id;
            ParteNumericoPersonalComfasDTO.UnidadNavalId = UnidadNavalId;
            ParteNumericoPersonalComfasDTO.FechaParte = FechaParte;
            ParteNumericoPersonalComfasDTO.GradoPersonalMilitarId = GradoPersonalMilitarId;
            ParteNumericoPersonalComfasDTO.EspecialidadGenericaPersonalId = EspecialidadGenericaPersonalId;
            ...
            var IND_OPERACION = ParteNumericoPersonalComfasBL.ActualizarFormato(ParteNumericoPersonalComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (ParteNumericoPersonalComfasBL.EliminarFormato(ParteNumericoPersonalComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = ParteNumericoPersonalComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = ParteNumericoPersonalComfasBL.ObtenerLista();
