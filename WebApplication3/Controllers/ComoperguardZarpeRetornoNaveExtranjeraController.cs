...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComoperguardZarpeRetornoNaveExtranjeraController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        ZarpeRetornoNaveExtranjera zarpeRetornoNaveExtranjeraBL = new();
        ...
        public ComoperguardZarpeRetornoNaveExtranjeraController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Zarpe de Retorno de Naves Extranjeras Capturadas en el Ambito Maritimo Fluvial y Lacustre", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = jefaturaDistritoCapitaniaDTO, data2 = capitaniaDTO, data3 = mesDTO, data4 = paisUbigeoDTO,
                data5 = tipoNaveDTO, data6 = unidadNavalDTO, data7 = puertoPeruDTO,  data8 = ambitoNaveDTO  });
        }

        public IActionResult CargaTabla()
        {
            List<ZarpeRetornoNaveExtranjeraDTO> select = zarpeRetornoNaveExtranjeraBL.ObtenerLista();
        ...
        public ActionResult Insertar( int JefaturaDistritoCapitaniaId, int CapitaniaId, string HoraCaptura, int DiaCaptura, int MesId, 
            int AnioCaptura, string NombreNaveExtranjera, string MatriculaNaveExtranjera, int PaisUbigeoId, int TipoNaveId, int UnidadNavalId, 
            int CascoUnidadNaval, int PuertoPeruId, int AmbitoNaveId, string HoraArribo, int DiaArribo, int MesArribo, int AnioArribo,
            string PuertoDestino, int PaisDestino, string ETA, string Observaciones)
        {
            ZarpeRetornoNaveExtranjeraDTO zarpeRetornoNaveExtranjeraDTO = new();
            zarpeRetornoNaveExtranjeraDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            zarpeRetornoNaveExtranjeraDTO.CapitaniaId = CapitaniaId;
            zarpeRetornoNaveExtranjeraDTO.HoraCaptura = HoraCaptura;
            zarpeRetornoNaveExtranjeraDTO.DiaCaptura = DiaCaptura;
            zarpeRetornoNaveExtranjeraDTO.MesId = MesId;
            zarpeRetornoNaveExtranjeraDTO.AnioCaptura = AnioCaptura;
            zarpeRetornoNaveExtranjeraDTO.NombreNaveExtranjera = NombreNaveExtranjera;
            zarpeRetornoNaveExtranjeraDTO.MatriculaNaveExtranjera = MatriculaNaveExtranjera;
            zarpeRetornoNaveExtranjeraDTO.PaisUbigeoId = PaisUbigeoId;
            zarpeRetornoNaveExtranjeraDTO.TipoNaveId = TipoNaveId;
            zarpeRetornoNaveExtranjeraDTO.UnidadNavalId = UnidadNavalId;
            zarpeRetornoNaveExtranjeraDTO.CascoUnidadNaval = CascoUnidadNaval;
            zarpeRetornoNaveExtranjeraDTO.PuertoPeruId = PuertoPeruId;
            zarpeRetornoNaveExtranjeraDTO.AmbitoNaveId = AmbitoNaveId;
            zarpeRetornoNaveExtranjeraDTO.HoraArribo = HoraArribo;
            zarpeRetornoNaveExtranjeraDTO.DiaArribo = DiaArribo;
            zarpeRetornoNaveExtranjeraDTO.MesArribo = MesArribo;
            zarpeRetornoNaveExtranjeraDTO.AnioArribo = AnioArribo;
            zarpeRetornoNaveExtranjeraDTO.PuertoDestino = PuertoDestino;
            zarpeRetornoNaveExtranjeraDTO.PaisDestino = PaisDestino;
            zarpeRetornoNaveExtranjeraDTO.ETA = ETA;
            zarpeRetornoNaveExtranjeraDTO.Observaciones = Observaciones;
            zarpeRetornoNaveExtranjeraDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = zarpeRetornoNaveExtranjeraBL.AgregarRegistro(zarpeRetornoNaveExtranjeraDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(zarpeRetornoNaveExtranjeraBL.BuscarFormato(Id));
        }
        ...
        {
            ZarpeRetornoNaveExtranjeraDTO zarpeRetornoNaveExtranjeraDTO = new();
            zarpeRetornoNaveExtranjeraDTO.ZarpeRetornoNaveExtranjeraId = Id;
            zarpeRetornoNaveExtranjeraDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            zarpeRetornoNaveExtranjeraDTO.CapitaniaId = CapitaniaId;
            zarpeRetornoNaveExtranjeraDTO.HoraCaptura = HoraCaptura;
            zarpeRetornoNaveExtranjeraDTO.DiaCaptura = DiaCaptura;
            ...
            var IND_OPERACION = zarpeRetornoNaveExtranjeraBL.ActualizarFormato(zarpeRetornoNaveExtranjeraDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (zarpeRetornoNaveExtranjeraBL.EliminarFormato(zarpeRetornoNaveExtranjeraDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = zarpeRetornoNaveExtranjeraBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = zarpeRetornoNaveExtranjeraBL.ObtenerLista();
