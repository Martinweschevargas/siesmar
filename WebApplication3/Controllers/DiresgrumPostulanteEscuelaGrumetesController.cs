...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class DiresgrumPostulanteEscuelaGrumetesController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        PostulanteEscuelaGrumetesDAO postulanteEscuelaGrumetesBL = new();
        MesDAO mesBL = new();
        SubUnidadEjecutoraDAO subUnidadEjecutoraBL = new();
        FuenteFinanciamientoDAO fuenteFinanciamientoBL = new();
       // GenericaGastos
        public DiresgrumPostulanteEscuelaGrumetesController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Postulantes a la Escuela de Grumetes", FromController = typeof(HomeController))]
        ...
        {
            List<PostulanteEscuelaGrumetesDTO> select = postulanteEscuelaGrumetesBL.ObtenerLista();
        ...
        public ActionResult Insertar( int DNIPostulanteEscuela, string SexoPostulanteEscuela, int LugarNacimiento, string FechaNacimiento,
            int LugarDomicilio, int LugarPresentacionPostulante, int ZonaNavalId, int GradoEstudioAlcanzadoId, int GradoEstudioEspecifId,
            int NumeroContingenciaPostulante, string ResultadoPostulacion)
        {
            PostulanteEscuelaGrumetesDTO postulanteEscuelaGrumetesDTO = new();
            postulanteEscuelaGrumetesDTO.DNIPostulanteEscuela = DNIPostulanteEscuela;
            postulanteEscuelaGrumetesDTO.SexoPostulanteEscuela = SexoPostulanteEscuela;
            postulanteEscuelaGrumetesDTO.LugarNacimiento = LugarNacimiento;
            postulanteEscuelaGrumetesDTO.FechaNacimiento = FechaNacimiento;
            postulanteEscuelaGrumetesDTO.LugarDomicilio = LugarDomicilio;
            postulanteEscuelaGrumetesDTO.LugarPresentacionPostulante = LugarPresentacionPostulante;
            postulanteEscuelaGrumetesDTO.ZonaNavalId = ZonaNavalId;
            postulanteEscuelaGrumetesDTO.GradoEstudioAlcanzadoId = GradoEstudioAlcanzadoId;
            postulanteEscuelaGrumetesDTO.GradoEstudioEspecifId = GradoEstudioEspecifId;
            postulanteEscuelaGrumetesDTO.NumeroContingenciaPostulante = NumeroContingenciaPostulante;
            postulanteEscuelaGrumetesDTO.ResultadoPostulacion = ResultadoPostulacion;
            postulanteEscuelaGrumetesDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = postulanteEscuelaGrumetesBL.AgregarRegistro(postulanteEscuelaGrumetesDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(postulanteEscuelaGrumetesBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int DNIPostulanteEscuela, string SexoPostulanteEscuela, int LugarNacimiento, string FechaNacimiento, 
            int LugarDomicilio, int LugarPresentacionPostulante, int ZonaNavalId, int GradoEstudioAlcanzadoId, int GradoEstudioEspecifId, 
            int NumeroContingenciaPostulante, string ResultadoPostulacion)
        {
            PostulanteEscuelaGrumetesDTO postulanteEscuelaGrumetesDTO = new();
            postulanteEscuelaGrumetesDTO.PostulanteEscuelaGrumeteId = Id;
            postulanteEscuelaGrumetesDTO.DNIPostulanteEscuela = DNIPostulanteEscuela;
            postulanteEscuelaGrumetesDTO.SexoPostulanteEscuela = SexoPostulanteEscuela;
            postulanteEscuelaGrumetesDTO.LugarNacimiento = LugarNacimiento;
            postulanteEscuelaGrumetesDTO.FechaNacimiento = FechaNacimiento;
            ...
            var IND_OPERACION = postulanteEscuelaGrumetesBL.ActualizaFormato(postulanteEscuelaGrumetesDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (postulanteEscuelaGrumetesBL.EliminarFormato(postulanteEscuelaGrumetesDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = postulanteEscuelaGrumetesBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = postulanteEscuelaGrumetesBL.ObtenerLista();
