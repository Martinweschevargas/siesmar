...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComoperguardAperturaCierrePuertosController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        AperturaCierrePuertos aperturaCierrePuertosBL = new();
        JefaturaDistritoCapitania jefaturaDistritoCapitaniaBL = new();
        Capitania capitaniaBL = new();
        TipoPuertoPeru tipoPuertoPeruBL = new();

        public ComoperguardAperturaCierrePuertosController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Apertura y Cierre de Puertos", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            List<TipoPuertoPeruDTO> tipoPuertoPeruDTO = tipoPuertoPeruBL.ObtenerCapintanias();


            return Json(new { data1 = jefaturaDistritoCapitaniaDTO, data2 = capitaniaDTO, data3 = tipoPuertoPeruDTO });
        }

        public IActionResult CargaTabla()
        {
            List<AperturaCierrePuertosDTO> select = aperturaCierrePuertosBL.ObtenerLista();
        ...
        public ActionResult Insertar(int JefaturaDistritoCapitaniaId, int CapitaniaId, string Condicion, int TipoPuertoPeruId,
            string FechaInicio, string FechaTermino, string ResolucionCapitania, string FechaResolucion, string GFHMensajeNaval)
        {
            AperturaCierrePuertosDTO aperturaCierrePuertosDTO = new();
            aperturaCierrePuertosDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            aperturaCierrePuertosDTO.CapitaniaId = CapitaniaId;
            aperturaCierrePuertosDTO.Condicion = Condicion;
            aperturaCierrePuertosDTO.TipoPuertoPeruId = TipoPuertoPeruId;
            aperturaCierrePuertosDTO.FechaInicio = FechaInicio;
            aperturaCierrePuertosDTO.FechaTermino = FechaTermino;
            aperturaCierrePuertosDTO.ResolucionCapitania = ResolucionCapitania;
            aperturaCierrePuertosDTO.FechaResolucion = FechaResolucion;
            aperturaCierrePuertosDTO.GFHMensajeNaval = GFHMensajeNaval;
            aperturaCierrePuertosDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = aperturaCierrePuertosBL.AgregarRegistro(aperturaCierrePuertosDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(aperturaCierrePuertosBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int JefaturaDistritoCapitaniaId, int CapitaniaId, string Condicion, int TipoPuertoPeruId,
            string FechaInicio, string FechaTermino, string ResolucionCapitania, string FechaResolucion, string GFHMensajeNaval)
        {
            AperturaCierrePuertosDTO aperturaCierrePuertosDTO = new();
            aperturaCierrePuertosDTO.AperturaCierrePuertoId = Id;
            aperturaCierrePuertosDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            aperturaCierrePuertosDTO.CapitaniaId = CapitaniaId;
            aperturaCierrePuertosDTO.Condicion = Condicion;
            aperturaCierrePuertosDTO.TipoPuertoPeruId = TipoPuertoPeruId;
            ...
            var IND_OPERACION = aperturaCierrePuertosBL.ActualizarFormato(aperturaCierrePuertosDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (aperturaCierrePuertosBL.EliminarFormato(aperturaCierrePuertosDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = aperturaCierrePuertosBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = aperturaCierrePuertosBL.ObtenerLista();
