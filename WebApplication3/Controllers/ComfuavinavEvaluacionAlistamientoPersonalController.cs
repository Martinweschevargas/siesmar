...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfuavinavEvaluacionAlistamientoPersonalController : Controller
    {
            ...
            decimal EspecializacionProfesional, decimal CursoProfesionalRequerido)
        {
            ...
            evaluacionAlistPersonalComfuavinavDTO.UnidadNavalId = UnidadNavalId;
            ...
            evaluacionAlistPersonalComfuavinavDTO.CargoPersonal = CargoPersonal;
            evaluacionAlistPersonalComfuavinavDTO.GradoPersonalMilitarEsperado = GradoPersonalMilitarEsperado;
            evaluacionAlistPersonalComfuavinavDTO.EspecialidadGenericaEsperado = EspecialidadGenericaEsperado;
            evaluacionAlistPersonalComfuavinavDTO.GradoPersonalMilitarActual = GradoPersonalMilitarActual;
            evaluacionAlistPersonalComfuavinavDTO.EspecialidadGenericaActual = EspecialidadGenericaActual;
            ...
            var IND_OPERACION = evaluacionAlistPersonalComfuavinavBL.AgregarRegistro(evaluacionAlistPersonalComfuavinavDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(evaluacionAlistPersonalComfuavinavBL.BuscarFormato(Id));
        }
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = evaluacionAlistPersonalComfuavinavBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
