...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComoperguardNavePeruanaCapturadaInternacionalController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        NavePeruanaCapturadaInternacional navePeruanaCapturadaInternacionalBL = new();
        ...
        public ComoperguardNavePeruanaCapturadaInternacionalController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Naves Peruanas Capturadas en Aguas Internacionales", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = jefaturaDistritoCapitaniaDTO, data2 = capitaniaDTO, data3 = mesDTO, data4 = tipoNaveDTO,
                data5 = autoridadEmiteZarpeDTO,data6 = ambitoNaveDTO,  data7 = puertoPeruDTO, data8 = puertoPeruDTO });
        }

        public IActionResult CargaTabla()
        {
            List<NavePeruanaCapturadaInternacionalDTO> select = navePeruanaCapturadaInternacionalBL.ObtenerLista();
        ...
        public ActionResult Insertar( int JefaturaDistritoCapitaniaId, int CapitaniaId, string HoraCaptura, int DiaCaptura, int MesId, 
            int AnioCaptura, string NombreNave, string MatriculaNave, int TipoNaveId, int CantidadTripulantes, int CantidadPasajeros,
            int AutoridadEmiteZarpeId, string Latitud, string Longitud, int AmbitoNaveId, int PuertoPeruId, int PaisUbigeoId, string Observaciones )
        {
            NavePeruanaCapturadaInternacionalDTO navePeruanaCapturadaInternacionalDTO = new();
            navePeruanaCapturadaInternacionalDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            navePeruanaCapturadaInternacionalDTO.CapitaniaId = CapitaniaId;
            navePeruanaCapturadaInternacionalDTO.HoraCaptura = HoraCaptura;
            navePeruanaCapturadaInternacionalDTO.DiaCaptura = DiaCaptura;
            navePeruanaCapturadaInternacionalDTO.MesId = MesId;
            navePeruanaCapturadaInternacionalDTO.AnioCaptura = AnioCaptura;
            navePeruanaCapturadaInternacionalDTO.NombreNave = NombreNave;
            navePeruanaCapturadaInternacionalDTO.MatriculaNave = MatriculaNave;
            navePeruanaCapturadaInternacionalDTO.TipoNaveId = TipoNaveId;
            navePeruanaCapturadaInternacionalDTO.CantidadTripulantes = CantidadTripulantes;
            navePeruanaCapturadaInternacionalDTO.CantidadPasajeros = CantidadPasajeros;
            navePeruanaCapturadaInternacionalDTO.AutoridadEmiteZarpeId = AutoridadEmiteZarpeId;
            navePeruanaCapturadaInternacionalDTO.Latitud = Latitud;
            navePeruanaCapturadaInternacionalDTO.Longitud = Longitud;
            navePeruanaCapturadaInternacionalDTO.AmbitoNaveId = AmbitoNaveId;
            navePeruanaCapturadaInternacionalDTO.PuertoPeruId = PuertoPeruId;
            navePeruanaCapturadaInternacionalDTO.PaisUbigeoId = PaisUbigeoId;
            navePeruanaCapturadaInternacionalDTO.Observaciones = Observaciones;

            navePeruanaCapturadaInternacionalDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = navePeruanaCapturadaInternacionalBL.AgregarRegistro(navePeruanaCapturadaInternacionalDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(navePeruanaCapturadaInternacionalBL.BuscarFormato(Id));
        }
        ...
        {
            NavePeruanaCapturadaInternacionalDTO navePeruanaCapturadaInternacionalDTO = new();
            navePeruanaCapturadaInternacionalDTO.NavePeruanaCapturadaInternacionalId = Id;
            navePeruanaCapturadaInternacionalDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            navePeruanaCapturadaInternacionalDTO.CapitaniaId = CapitaniaId;
            navePeruanaCapturadaInternacionalDTO.HoraCaptura = HoraCaptura;
            navePeruanaCapturadaInternacionalDTO.DiaCaptura = DiaCaptura;
            ...
            var IND_OPERACION = navePeruanaCapturadaInternacionalBL.ActualizarFormato(navePeruanaCapturadaInternacionalDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (navePeruanaCapturadaInternacionalBL.EliminarFormato(navePeruanaCapturadaInternacionalDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = navePeruanaCapturadaInternacionalBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = navePeruanaCapturadaInternacionalBL.ObtenerLista();
