...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComoperguardNaveExtranjeraCapturadaController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        NaveExtranjeraCapturada naveExtranjeraCapturadaBL = new();
        ...
        public ComoperguardNaveExtranjeraCapturadaController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Naves Extranjeras Capturadas en Ámbito Marítimo, FluviaL, Lacustre", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = jefaturaDistritoCapitaniaDTO, data2 = capitaniaDTO, data3 = mesDTO, data4 = paisUbigeoDTO,
                data5 = tipoNaveDTO, data6 = unidadNavalDTO, data7 = ambitoNaveDTO });
        }

        public IActionResult CargaTabla()
        {
            List<NaveExtranjeraCapturadaDTO> select = naveExtranjeraCapturadaBL.ObtenerLista();
        ...
        public ActionResult Insertar( int JefaturaDistritoCapitaniaId, int CapitaniaId, string HoraCaptura, int DiaCaptura, int MesId,
            ...
            int AmbitoNaveId, string TenorInfracciones, string ArticuloInfraccion, string ProcesoAdministrativo, string Observaciones)
        {
            NaveExtranjeraCapturadaDTO naveExtranjeraCapturadaDTO = new();
            naveExtranjeraCapturadaDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            naveExtranjeraCapturadaDTO.CapitaniaId = CapitaniaId;
            naveExtranjeraCapturadaDTO.HoraCaptura = HoraCaptura;
            naveExtranjeraCapturadaDTO.DiaCaptura = DiaCaptura;
            naveExtranjeraCapturadaDTO.MesId = MesId;
            naveExtranjeraCapturadaDTO.AnioCaptura = AnioCaptura;
            naveExtranjeraCapturadaDTO.NombreNaveExtranjera = NombreNaveExtranjera;
            naveExtranjeraCapturadaDTO.MatriculaNaveExtranjera = MatriculaNaveExtranjera;
            naveExtranjeraCapturadaDTO.PaisUbigeoId = PaisUbigeoId;
            naveExtranjeraCapturadaDTO.TipoNaveId = TipoNaveId;
            naveExtranjeraCapturadaDTO.UnidadNavalId = UnidadNavalId;
            naveExtranjeraCapturadaDTO.AmbitoNaveId = AmbitoNaveId;
            naveExtranjeraCapturadaDTO.TenorInfracciones = TenorInfracciones;
            naveExtranjeraCapturadaDTO.ArticuloInfraccion = ArticuloInfraccion;
            naveExtranjeraCapturadaDTO.ProcesoAdministrativo = ProcesoAdministrativo;
            naveExtranjeraCapturadaDTO.Observaciones = Observaciones;
            naveExtranjeraCapturadaDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = naveExtranjeraCapturadaBL.AgregarRegistro(naveExtranjeraCapturadaDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(naveExtranjeraCapturadaBL.BuscarFormato(Id));
        }
        ...
        {
            NaveExtranjeraCapturadaDTO naveExtranjeraCapturadaDTO = new();
            naveExtranjeraCapturadaDTO.NavesExtranjerasCapturadasId = Id;
            naveExtranjeraCapturadaDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            naveExtranjeraCapturadaDTO.CapitaniaId = CapitaniaId;
            naveExtranjeraCapturadaDTO.HoraCaptura = HoraCaptura;
            naveExtranjeraCapturadaDTO.DiaCaptura = DiaCaptura;
            ...
            var IND_OPERACION = naveExtranjeraCapturadaBL.ActualizarFormato(naveExtranjeraCapturadaDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (naveExtranjeraCapturadaBL.EliminarFormato(naveExtranjeraCapturadaDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = naveExtranjeraCapturadaBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = naveExtranjeraCapturadaBL.ObtenerLista();
