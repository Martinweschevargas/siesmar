...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class CombasnaiSituacionEmbarcacionMenorController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        SituacionEmbarcacionMenorCombasnai situacionEmbarcacionMenorCombasnaiBL = new();
        ...
        public CombasnaiSituacionEmbarcacionMenorController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = unidadNavalDTO, data2 = tipoPlataformaNaveDTO, data3 = dependenciaDTO, data4 = departamentoUbigeoDTO,
                data5 = provinciaUbigeoDTO, data6 = distritoUbigeoDTO, data7 = capacidadOperativaRequeridaDTO, data8 = condicionDTO });
        }

        public IActionResult CargaTabla()
        {
            List<SituacionEmbarcacionMenorCombasnaiDTO> select = situacionEmbarcacionMenorCombasnaiBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, string CategoriaEmbarcacion, int TipoPlataformaNaveId, int DependenciaId, string Ubicacion,
            int DepartamentoUbigeoId, int ProvinciaUbigeoId, int DistritoUbigeoId, int CapacidadOperativaRequeridaId, int CondicionId, string Observacion)
        {
            SituacionEmbarcacionMenorCombasnaiDTO SituacionEmbarcacionMenorCombasnaiDTO = new();
            SituacionEmbarcacionMenorCombasnaiDTO.UnidadNavalId = UnidadNavalId;
            SituacionEmbarcacionMenorCombasnaiDTO.CategoriaEmbarcacion = CategoriaEmbarcacion;
            SituacionEmbarcacionMenorCombasnaiDTO.TipoPlataformaNaveId = TipoPlataformaNaveId;
            SituacionEmbarcacionMenorCombasnaiDTO.DependenciaId = DependenciaId;
            SituacionEmbarcacionMenorCombasnaiDTO.Ubicacion = Ubicacion;
            SituacionEmbarcacionMenorCombasnaiDTO.DepartamentoUbigeoId = DepartamentoUbigeoId;
            SituacionEmbarcacionMenorCombasnaiDTO.ProvinciaUbigeoId = ProvinciaUbigeoId;
            SituacionEmbarcacionMenorCombasnaiDTO.DistritoUbigeoId = DistritoUbigeoId;
            SituacionEmbarcacionMenorCombasnaiDTO.CapacidadOperativaRequeridaId = CapacidadOperativaRequeridaId;
            SituacionEmbarcacionMenorCombasnaiDTO.CondicionId = CondicionId;
            SituacionEmbarcacionMenorCombasnaiDTO.Observacion = Observacion;
            SituacionEmbarcacionMenorCombasnaiDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = situacionEmbarcacionMenorCombasnaiBL.AgregarRegistro(SituacionEmbarcacionMenorCombasnaiDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(situacionEmbarcacionMenorCombasnaiBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, string CategoriaEmbarcacion, int TipoPlataformaNaveId, int DependenciaId, string Ubicacion,
            int DepartamentoUbigeoId, int ProvinciaUbigeoId, int DistritoUbigeoId, int CapacidadOperativaRequeridaId, int CondicionId, string Observacion)
        {
            SituacionEmbarcacionMenorCombasnaiDTO SituacionEmbarcacionMenorCombasnaiDTO = new();
            SituacionEmbarcacionMenorCombasnaiDTO.SituacionEmbarcacionMenorId = Id;
            SituacionEmbarcacionMenorCombasnaiDTO.UnidadNavalId = UnidadNavalId;
            SituacionEmbarcacionMenorCombasnaiDTO.CategoriaEmbarcacion = CategoriaEmbarcacion;
            SituacionEmbarcacionMenorCombasnaiDTO.TipoPlataformaNaveId = TipoPlataformaNaveId;
            SituacionEmbarcacionMenorCombasnaiDTO.DependenciaId = DependenciaId;
            ...
            var IND_OPERACION = situacionEmbarcacionMenorCombasnaiBL.ActualizarFormato(SituacionEmbarcacionMenorCombasnaiDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (situacionEmbarcacionMenorCombasnaiBL.EliminarFormato(SituacionEmbarcacionMenorCombasnaiDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = situacionEmbarcacionMenorCombasnaiBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = situacionEmbarcacionMenorCombasnaiBL.ObtenerLista();
