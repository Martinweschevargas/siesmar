...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class JesehinAlistamientoCombustibleLubricanteJesehinController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        AlistamientoCombustibleLubricanteJesehin alistamientoCombustibleLubricanteJesehinBL = new();
        UnidadNaval unidadNavalBL = new();
        AlistamientoCombustibleLubricante2 alistamientoCombustibleLubricante2BL = new();

        public JesehinAlistamientoCombustibleLubricanteJesehinController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<AlistamientoCombustibleLubricanteJesehinDTO> select = alistamientoCombustibleLubricanteJesehinBL.ObtenerLista();
        ...
        {
            AlistamientoCombustibleLubricanteJesehinDTO alistamientoCombustibleLubricanteJesehinDTO = new();
            alistamientoCombustibleLubricanteJesehinDTO.UnidadNavalId = UnidadNavalId;
            alistamientoCombustibleLubricanteJesehinDTO.AlistamientoCombustibleLubricante2Id = AlistamientoCombustibleLubricante2Id;
            alistamientoCombustibleLubricanteJesehinDTO.PromedioPonderado = PromedioPonderado;
            alistamientoCombustibleLubricanteJesehinDTO.SubPromedioParcial = SubPromedioParcial;
            
            alistamientoCombustibleLubricanteJesehinDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoCombustibleLubricanteJesehinBL.AgregarRegistro(alistamientoCombustibleLubricanteJesehinDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoCombustibleLubricanteJesehinBL.BuscarFormato(Id));
        }
        ...
        {
            AlistamientoCombustibleLubricanteJesehinDTO alistamientoCombustibleLubricanteJesehinDTO = new();
            alistamientoCombustibleLubricanteJesehinDTO.AlistamientoCombustibleLubricanteId = Id;
            alistamientoCombustibleLubricanteJesehinDTO.UnidadNavalId = UnidadNavalId;
            alistamientoCombustibleLubricanteJesehinDTO.AlistamientoCombustibleLubricante2Id = AlistamientoCombustibleLubricante2Id;
            alistamientoCombustibleLubricanteJesehinDTO.PromedioPonderado = PromedioPonderado;
            alistamientoCombustibleLubricanteJesehinDTO.SubPromedioParcial = SubPromedioParcial;
            ...
            var IND_OPERACION = alistamientoCombustibleLubricanteJesehinBL.ActualizarFormato(alistamientoCombustibleLubricanteJesehinDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoCombustibleLubricanteJesehinBL.EliminarFormato(alistamientoCombustibleLubricanteJesehinDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoCombustibleLubricanteJesehinBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoCombustibleLubricanteJesehinBL.ObtenerLista();
