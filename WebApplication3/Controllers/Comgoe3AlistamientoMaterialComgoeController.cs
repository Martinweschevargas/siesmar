...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class Comgoe3AlistamientoMaterialComgoeController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        AlistamientoMaterialComgoe alistamientoMaterialComgoeBL = new();
        UnidadNaval unidadNavalBL = new();
        CapacidadOperativa capacidadOperativaBL = new();
        AlistamientoMaterialRequerido3N alistamientoMaterialRequerido3NBL = new();

        public Comgoe3AlistamientoMaterialComgoeController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<AlistamientoMaterialComgoeDTO> select = alistamientoMaterialComgoeBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, int CapacidadOperativaId, int AlistamientoMaterialRequerido3NId, int Requerido, int Operativo, decimal PorcentajeOperativo)
        {
            AlistamientoMaterialComgoeDTO alistamientoMaterialComgoeDTO = new();
            alistamientoMaterialComgoeDTO.UnidadNavalId = UnidadNavalId;
            alistamientoMaterialComgoeDTO.CapacidadOperativaId = CapacidadOperativaId;
            alistamientoMaterialComgoeDTO.AlistamientoMaterialRequerido3NId = AlistamientoMaterialRequerido3NId;
            alistamientoMaterialComgoeDTO.Requerido = Requerido;
            alistamientoMaterialComgoeDTO.Operativo = Operativo;
            alistamientoMaterialComgoeDTO.PorcentajeOperatividad = PorcentajeOperativo;

            alistamientoMaterialComgoeDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoMaterialComgoeBL.AgregarRegistro(alistamientoMaterialComgoeDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoMaterialComgoeBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, int CapacidadOperativaId, int AlistamientoMaterialRequerido3NId, int Requerido, int Operativo, decimal PorcentajeOperativo)
        {
            AlistamientoMaterialComgoeDTO alistamientoMaterialComgoeDTO = new();
            alistamientoMaterialComgoeDTO.AlistamientoMaterialId = Id;
            alistamientoMaterialComgoeDTO.UnidadNavalId = UnidadNavalId;
            alistamientoMaterialComgoeDTO.CapacidadOperativaId = CapacidadOperativaId;
            alistamientoMaterialComgoeDTO.AlistamientoMaterialRequerido3NId = AlistamientoMaterialRequerido3NId;
            alistamientoMaterialComgoeDTO.Requerido = Requerido;
            ...
            var IND_OPERACION = alistamientoMaterialComgoeBL.ActualizarFormato(alistamientoMaterialComgoeDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoMaterialComgoeBL.EliminarFormato(alistamientoMaterialComgoeDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoMaterialComgoeBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoMaterialComgoeBL.ObtenerLista();
