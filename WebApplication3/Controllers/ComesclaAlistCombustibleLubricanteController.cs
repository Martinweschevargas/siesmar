...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComesclaAlistCombustibleLubricanteController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        AlistamientoCombustibleLubricanteComescla alistamientoCombustibleLubricanteComesclaBL = new();

        UnidadNaval unidadNavalBL = new();
        AlistamientoCombustibleLubricante2 alistamientoCombustibleLubricante2BL = new();


        public ComesclaAlistCombustibleLubricanteController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<AlistamientoCombustibleLubricanteComesclaDTO> select = alistamientoCombustibleLubricanteComesclaBL.ObtenerLista();
        ...
        {
            AlistamientoCombustibleLubricanteComesclaDTO alistamientoCombustibleLubricanteComesclaDTO = new();
            alistamientoCombustibleLubricanteComesclaDTO.UnidadNavalId = UnidadNavalId;
            alistamientoCombustibleLubricanteComesclaDTO.AlistamientoCombustibleLubricante2Id = AlistamientoCombustibleLubricante2Id;
            alistamientoCombustibleLubricanteComesclaDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoCombustibleLubricanteComesclaBL.AgregarRegistro(alistamientoCombustibleLubricanteComesclaDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoCombustibleLubricanteComesclaBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, int AlistamientoCombustibleLubricante2Id)
        {
            AlistamientoCombustibleLubricanteComesclaDTO alistamientoCombustibleLubricanteComesclaDTO = new();
            alistamientoCombustibleLubricanteComesclaDTO.AlistamientoCombustibleLubricanteId = Id;
            alistamientoCombustibleLubricanteComesclaDTO.UnidadNavalId = UnidadNavalId;
            alistamientoCombustibleLubricanteComesclaDTO.AlistamientoCombustibleLubricante2Id = AlistamientoCombustibleLubricante2Id;
            alistamientoCombustibleLubricanteComesclaDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoCombustibleLubricanteComesclaBL.ActualizarFormato(alistamientoCombustibleLubricanteComesclaDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoCombustibleLubricanteComesclaBL.EliminarFormato(alistamientoCombustibleLubricanteComesclaDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoCombustibleLubricanteComesclaBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoCombustibleLubricanteComesclaBL.ObtenerLista();
