...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfuinmarAlistamientoMunicionComfuinmarController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        AlistamientoMunicionComfuinmar alistamientoMunicionComfuinmarBL = new();
        UnidadNaval unidadNavalBL = new();
        AlistamientoMunicion alistamientoMunicionBL = new();
        Carga cargaBL = new();

        public ComfuinmarAlistamientoMunicionComfuinmarController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult cargaCombs()
        {
            ...
            List<CargaDTO> listaCargas = cargaBL.ObtenerListaCargas("AlistamientoMunicionComfuinmar");
            return Json(new
            {
        ...
        {
            List<AlistamientoMunicionComfuinmarDTO> select = alistamientoMunicionComfuinmarBL.ObtenerLista();
        ...
        public ActionResult Insertar(string CodigoUnidadNaval, string CodigoAlistamientoMunicion, 
            int NroMunicionesExistentes, int CargaId, string Fecha)
        {
            AlistamientoMunicionComfuinmarDTO alistamientoMunicionComfuinmarDTO = new();
            alistamientoMunicionComfuinmarDTO.CodigoUnidadNaval = CodigoUnidadNaval;
            alistamientoMunicionComfuinmarDTO.CodigoAlistamientoMunicion = CodigoAlistamientoMunicion;
            alistamientoMunicionComfuinmarDTO.NroMunicionesExistentes = NroMunicionesExistentes;
            alistamientoMunicionComfuinmarDTO.CargaId = CargaId;
            alistamientoMunicionComfuinmarDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoMunicionComfuinmarBL.AgregarRegistro(alistamientoMunicionComfuinmarDTO, Fecha);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoMunicionComfuinmarBL.EditarFormato(Id));
        }

        public ActionResult Actualizar(int Id, string CodigoUnidadNaval, string CodigoAlistamientoMunicion,
            int NroMunicionesExistentes)
        {
            AlistamientoMunicionComfuinmarDTO alistamientoMunicionComfuinmarDTO = new();
            alistamientoMunicionComfuinmarDTO.AlistamientoMunicionConfuinmarId = Id;
            alistamientoMunicionComfuinmarDTO.CodigoUnidadNaval = CodigoUnidadNaval;
            alistamientoMunicionComfuinmarDTO.CodigoAlistamientoMunicion = CodigoAlistamientoMunicion;
            alistamientoMunicionComfuinmarDTO.NroMunicionesExistentes = NroMunicionesExistentes;
            alistamientoMunicionComfuinmarDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoMunicionComfuinmarBL.ActualizarFormato(alistamientoMunicionComfuinmarDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoMunicionComfuinmarBL.EliminarFormato(alistamientoMunicionComfuinmarDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public ActionResult EliminarCarga(int Id)
        {
            string mensaje = "";
            AlistamientoMunicionComfuinmarDTO alistamientoMunicionComfuinmarDTO = new();
            alistamientoMunicionComfuinmarDTO.CargaId = Id;
            alistamientoMunicionComfuinmarDTO.UsuarioIngresoRegistro = User.obtenerUsuario();
            if (alistamientoMunicionComfuinmarBL.EliminarCarga(alistamientoMunicionComfuinmarDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
            return Content(mensaje);
            ...
            try
            {
                ...
                for (int i = 1; i <= cantidadFilas; i++)
                {
                    ...
                    lista.Add(new AlistamientoMunicionComfuinmarDTO
                    {
                        ...
                        NroMunicionesExistentes = int.Parse(fila.GetCell(2).ToString())
                    });
                }
            }
            catch (Exception e)
        ...
        public ActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel, string Fecha)
        {
            ...
            dt.Columns.AddRange(new DataColumn[4]
            {
                    ...
                    new DataColumn("NroMunicionesExistentes", typeof(int)),
            ...
            var IND_OPERACION = alistamientoMunicionComfuinmarBL.InsertarDatos(dt, Fecha);
        ...
        {
            var path = $"{this._webHostEnviroment.WebRootPath}\\Formatos\\ComfuinmarAlistamientoMunicion.xlsx";
            var fs = new FileStream(path, FileMode.Open);

            return File(fs, "application/octet-stream", "ComfuinmarAlistamientoMunicion.xlsx");
        }
