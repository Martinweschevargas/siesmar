...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasAlistamientoMaterialController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();
        AlistamientoMaterialComfas alistamientoMaterialComfasBL = new();
        UnidadNaval unidadNavalBL = new();
        CapacidadOperativa capacidadOperativaBL = new();

        public ComfasAlistamientoMaterialController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<AlistamientoMaterialComfasDTO> select = alistamientoMaterialComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar( int UnidadNavalId, int CapacidadOperativaId, int CapacidadIntrinseca1, int PonderacionCapacidad1, int Subclasificacion2, 
            int PonderacionCapacidad2, int Subclasificacion3, int PonderacionCapacidad3, int Requerido, int Operativo, decimal NivelAlistamientoParcial)
        {
            AlistamientoMaterialComfasDTO alistamientoMaterialComfasDTO = new();
            alistamientoMaterialComfasDTO.UnidadNavalId = UnidadNavalId;
            alistamientoMaterialComfasDTO.CapacidadOperativaId = CapacidadOperativaId;
            alistamientoMaterialComfasDTO.CapacidadIntrinseca1 = CapacidadIntrinseca1;
            alistamientoMaterialComfasDTO.PonderacionCapacidad1 = PonderacionCapacidad1;
            alistamientoMaterialComfasDTO.Subclasificacion2 = Subclasificacion2;
            alistamientoMaterialComfasDTO.PonderacionCapacidad2 = PonderacionCapacidad2;
            alistamientoMaterialComfasDTO.Subclasificacion3 = Subclasificacion3;
            alistamientoMaterialComfasDTO.PonderacionCapacidad3 = PonderacionCapacidad3;
            alistamientoMaterialComfasDTO.Requerido = Requerido;
            alistamientoMaterialComfasDTO.Operativo = Operativo;
            alistamientoMaterialComfasDTO.NivelAlistamientoParcial = NivelAlistamientoParcial;
            alistamientoMaterialComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoMaterialComfasBL.AgregarRegistro(alistamientoMaterialComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoMaterialComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id,int UnidadNavalId, int CapacidadOperativaId, int CapacidadIntrinseca1, int PonderacionCapacidad1, int Subclasificacion2, 
            int PonderacionCapacidad2, int Subclasificacion3, int PonderacionCapacidad3, int Requerido, int Operativo, decimal NivelAlistamientoParcial)
        {
            AlistamientoMaterialComfasDTO alistamientoMaterialComfasDTO = new();
            alistamientoMaterialComfasDTO.AlistamientoMaterialId = Id;
            alistamientoMaterialComfasDTO.UnidadNavalId = UnidadNavalId;
            alistamientoMaterialComfasDTO.CapacidadOperativaId = CapacidadOperativaId;
            alistamientoMaterialComfasDTO.CapacidadIntrinseca1 = CapacidadIntrinseca1;
            alistamientoMaterialComfasDTO.PonderacionCapacidad1 = PonderacionCapacidad1;
            ...
            var IND_OPERACION = alistamientoMaterialComfasBL.ActualizarFormato(alistamientoMaterialComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoMaterialComfasBL.EliminarFormato(alistamientoMaterialComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoMaterialComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoMaterialComfasBL.ObtenerLista();
