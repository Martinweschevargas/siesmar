...
{
    public class ComflotfluAlistamientoMaterialComflotfluController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        AlistamientoMaterialComflotflu alistamientoMaterialComflotfluBL = new();
        UnidadNaval unidadNavalBL = new();
        AlistamientoMaterialRequerido3N alistamientoMaterialRequerido3NBL = new();

        public ComflotfluAlistamientoMaterialComflotfluController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<AlistamientoMaterialComflotfluDTO> select = alistamientoMaterialComflotfluBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, int AlistamientoMaterialRequerido3NId, int Requerido, int Operativo, string PorcentajeOperativo)
        {
            AlistamientoMaterialComflotfluDTO alistamientoMaterialComflotfluDTO = new();
            alistamientoMaterialComflotfluDTO.UnidadNavalId = UnidadNavalId;
            alistamientoMaterialComflotfluDTO.AlistamientoMaterialRequerido3NId = AlistamientoMaterialRequerido3NId;
            alistamientoMaterialComflotfluDTO.Requerido = Requerido;
            alistamientoMaterialComflotfluDTO.Operativo = Operativo;
            alistamientoMaterialComflotfluDTO.PorcentajeOperatividad = PorcentajeOperativo;
            
            alistamientoMaterialComflotfluDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoMaterialComflotfluBL.AgregarRegistro(alistamientoMaterialComflotfluDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoMaterialComflotfluBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, int AlistamientoMaterialRequerido3NId, int Requerido, int Operativo, string PorcentajeOperativo)
        {
            AlistamientoMaterialComflotfluDTO alistamientoMaterialComflotfluDTO = new();
            alistamientoMaterialComflotfluDTO.AlistamientoMaterialId = Id;
            alistamientoMaterialComflotfluDTO.UnidadNavalId = UnidadNavalId;
            alistamientoMaterialComflotfluDTO.AlistamientoMaterialRequerido3NId = AlistamientoMaterialRequerido3NId;
            alistamientoMaterialComflotfluDTO.Requerido = Requerido;
            alistamientoMaterialComflotfluDTO.Operativo = Operativo;
            ...
            var IND_OPERACION = alistamientoMaterialComflotfluBL.ActualizarFormato(alistamientoMaterialComflotfluDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoMaterialComflotfluBL.EliminarFormato(alistamientoMaterialComflotfluDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoMaterialComflotfluBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoMaterialComflotfluBL.ObtenerLista();
