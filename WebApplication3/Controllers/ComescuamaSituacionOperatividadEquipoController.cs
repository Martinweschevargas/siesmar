...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComescuamaSituacionOperatividadEquipoController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        SituacionOperatividadEquipoComescuama situacionOperatividadEquipoComescuamaBL = new();
        ...
        public ComescuamaSituacionOperatividadEquipoController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = descripcionMaterialDTO, data2 = unidadNavalDTO, data3 = distritoUbigeoDTO, data4 = condicionDTO });
        }

        public IActionResult CargaTabla()
        {
            List<SituacionOperatividadEquipoComescuamaDTO> select = situacionOperatividadEquipoComescuamaBL.ObtenerLista();
        ...
        public ActionResult Insertar( int DescripcionMaterialId, int Cantidad, int UnidadNavalId, string Ubicacion, int DistritoUbigeoId, 
            int CondicionId, string Observacion)
        {
            SituacionOperatividadEquipoComescuamaDTO situacionOperatividadEquipoComescuamaDTO = new();
            situacionOperatividadEquipoComescuamaDTO.DescripcionMaterialId = DescripcionMaterialId;
            situacionOperatividadEquipoComescuamaDTO.Cantidad = Cantidad;
            situacionOperatividadEquipoComescuamaDTO.UnidadNavalId = UnidadNavalId;
            situacionOperatividadEquipoComescuamaDTO.Ubicacion = Ubicacion;
            situacionOperatividadEquipoComescuamaDTO.DistritoUbigeoId = DistritoUbigeoId;
            situacionOperatividadEquipoComescuamaDTO.CondicionId = CondicionId;
            situacionOperatividadEquipoComescuamaDTO.Observacion = Observacion;
            situacionOperatividadEquipoComescuamaDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = situacionOperatividadEquipoComescuamaBL.AgregarRegistro(situacionOperatividadEquipoComescuamaDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(situacionOperatividadEquipoComescuamaBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id,int DescripcionMaterialId, int Cantidad, int UnidadNavalId, string Ubicacion, int DistritoUbigeoId, 
            int CondicionId, string Observacion)
        {
            SituacionOperatividadEquipoComescuamaDTO situacionOperatividadEquipoComescuamaDTO = new();
            situacionOperatividadEquipoComescuamaDTO.SituacionOperatividadEquipoId = Id;
            situacionOperatividadEquipoComescuamaDTO.DescripcionMaterialId = DescripcionMaterialId;
            situacionOperatividadEquipoComescuamaDTO.Cantidad = Cantidad;
            situacionOperatividadEquipoComescuamaDTO.UnidadNavalId = UnidadNavalId;
            situacionOperatividadEquipoComescuamaDTO.Ubicacion = Ubicacion;
            ...
            var IND_OPERACION = situacionOperatividadEquipoComescuamaBL.ActualizarFormato(situacionOperatividadEquipoComescuamaDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (situacionOperatividadEquipoComescuamaBL.EliminarFormato(situacionOperatividadEquipoComescuamaDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = situacionOperatividadEquipoComescuamaBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = situacionOperatividadEquipoComescuamaBL.ObtenerLista();
