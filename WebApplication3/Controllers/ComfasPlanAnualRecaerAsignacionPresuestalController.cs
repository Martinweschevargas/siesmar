...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasPlanAnualRecaerAsignacionPresuestalController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        PlanAnualRecaerAsignacionPresuestalComfas planAnualRecaerAsignacionPresuestalComfasBL = new();


        public ComfasPlanAnualRecaerAsignacionPresuestalController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Cuadro de Plan Anual Recar Asignación Presupuestal", FromController = typeof(HomeController))]
        ...
        {
            List<PlanAnualRecaerAsignacionPresuestalComfasDTO> select = planAnualRecaerAsignacionPresuestalComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar( decimal AsignadoProgramaAnual, decimal Bienes, decimal Servicios, decimal AsignadoAnual, decimal GastosBienes, 
            decimal GastosServicios)
        {
            PlanAnualRecaerAsignacionPresuestalComfasDTO planAnualRecaerAsignacionPresuestalComfasDTO = new();
            planAnualRecaerAsignacionPresuestalComfasDTO.AsignadoProgramaAnual = AsignadoProgramaAnual;
            planAnualRecaerAsignacionPresuestalComfasDTO.Bienes = Bienes;
            planAnualRecaerAsignacionPresuestalComfasDTO.Servicios = Servicios;
            planAnualRecaerAsignacionPresuestalComfasDTO.AsignadoAnual = AsignadoAnual;
            planAnualRecaerAsignacionPresuestalComfasDTO.GastosBienes = GastosBienes;
            planAnualRecaerAsignacionPresuestalComfasDTO.GastosServicios = GastosServicios;
            planAnualRecaerAsignacionPresuestalComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = planAnualRecaerAsignacionPresuestalComfasBL.AgregarRegistro(planAnualRecaerAsignacionPresuestalComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(planAnualRecaerAsignacionPresuestalComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id,  decimal AsignadoProgramaAnual, decimal Bienes, decimal Servicios, decimal AsignadoAnual, decimal GastosBienes,
            decimal GastosServicios)
        {
            PlanAnualRecaerAsignacionPresuestalComfasDTO planAnualRecaerAsignacionPresuestalComfasDTO = new();
            planAnualRecaerAsignacionPresuestalComfasDTO.PlanAnualRecaerAsignacionPresuestalId = Id;
            planAnualRecaerAsignacionPresuestalComfasDTO.AsignadoProgramaAnual = AsignadoProgramaAnual;
            planAnualRecaerAsignacionPresuestalComfasDTO.Bienes = Bienes;
            planAnualRecaerAsignacionPresuestalComfasDTO.Servicios = Servicios;
            planAnualRecaerAsignacionPresuestalComfasDTO.AsignadoAnual = AsignadoAnual;
            ...
            var IND_OPERACION = planAnualRecaerAsignacionPresuestalComfasBL.ActualizarFormato(planAnualRecaerAsignacionPresuestalComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (planAnualRecaerAsignacionPresuestalComfasBL.EliminarFormato(planAnualRecaerAsignacionPresuestalComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = planAnualRecaerAsignacionPresuestalComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = planAnualRecaerAsignacionPresuestalComfasBL.ObtenerLista();
