...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class JesehinEvaluacionAlistamientoEntrenamientoJesehinController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        EvaluacionAlistamientoEntrenamientoJesehin evaluacionAlistamientoEntrenamientoJesehinBL = new();
        ...
        public JesehinEvaluacionAlistamientoEntrenamientoJesehinController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<EvaluacionAlistamientoEntrenamientoJesehinDTO> select = evaluacionAlistamientoEntrenamientoJesehinBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, string NivelEntrenamiento, int CapacidadOperativaId, string TipoCapacidadOperativa, int EjercicioEntrenamientoAspectoId, int CalificativoAsignadoEjercicioId, int PuntajeObtenidoEjercicio, string FechaPeriodoEvaluar, string FechaRealizacionEjercicio, int TiempoVigencia, string FechaCaducidadEjercicio)
        {
            EvaluacionAlistamientoEntrenamientoJesehinDTO evaluacionAlistamientoEntrenamientoJesehinDTO = new();
            evaluacionAlistamientoEntrenamientoJesehinDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoEntrenamientoJesehinDTO.NivelEntrenamiento = NivelEntrenamiento;
            evaluacionAlistamientoEntrenamientoJesehinDTO.CapacidadOperativaId = CapacidadOperativaId;
            evaluacionAlistamientoEntrenamientoJesehinDTO.TipoCapacidadOperativa = TipoCapacidadOperativa;
            evaluacionAlistamientoEntrenamientoJesehinDTO.EjercicioEntrenamientoAspectoId = EjercicioEntrenamientoAspectoId;
            evaluacionAlistamientoEntrenamientoJesehinDTO.CalificativoAsignadoEjercicioId = CalificativoAsignadoEjercicioId;
            evaluacionAlistamientoEntrenamientoJesehinDTO.PuntajeObtenidoEjercicio = PuntajeObtenidoEjercicio;
            evaluacionAlistamientoEntrenamientoJesehinDTO.FechaPeriodoEvaluar = FechaPeriodoEvaluar;
            evaluacionAlistamientoEntrenamientoJesehinDTO.FechaRealizacionEjercicio = FechaRealizacionEjercicio;
            evaluacionAlistamientoEntrenamientoJesehinDTO.TiempoVigencia = TiempoVigencia;
            evaluacionAlistamientoEntrenamientoJesehinDTO.FechaCaducidadEjercicio = FechaCaducidadEjercicio;
            
            evaluacionAlistamientoEntrenamientoJesehinDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = evaluacionAlistamientoEntrenamientoJesehinBL.AgregarRegistro(evaluacionAlistamientoEntrenamientoJesehinDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(evaluacionAlistamientoEntrenamientoJesehinBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, string NivelEntrenamiento, int CapacidadOperativaId, string TipoCapacidadOperativa, int EjercicioEntrenamientoAspectoId, int CalificativoAsignadoEjercicioId, int PuntajeObtenidoEjercicio, string FechaPeriodoEvaluar, string FechaRealizacionEjercicio, int TiempoVigencia, string FechaCaducidadEjercicio)
        {
            EvaluacionAlistamientoEntrenamientoJesehinDTO evaluacionAlistamientoEntrenamientoJesehinDTO = new();
            evaluacionAlistamientoEntrenamientoJesehinDTO.EvaluacionAlistamientoEntrenamientoId = Id;
            evaluacionAlistamientoEntrenamientoJesehinDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoEntrenamientoJesehinDTO.NivelEntrenamiento = NivelEntrenamiento;
            evaluacionAlistamientoEntrenamientoJesehinDTO.CapacidadOperativaId = CapacidadOperativaId;
            evaluacionAlistamientoEntrenamientoJesehinDTO.TipoCapacidadOperativa = TipoCapacidadOperativa;
            ...
            var IND_OPERACION = evaluacionAlistamientoEntrenamientoJesehinBL.ActualizarFormato(evaluacionAlistamientoEntrenamientoJesehinDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (evaluacionAlistamientoEntrenamientoJesehinBL.EliminarFormato(evaluacionAlistamientoEntrenamientoJesehinDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = evaluacionAlistamientoEntrenamientoJesehinBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = evaluacionAlistamientoEntrenamientoJesehinBL.ObtenerLista();
