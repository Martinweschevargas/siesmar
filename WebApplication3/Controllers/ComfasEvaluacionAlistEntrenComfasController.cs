...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasEvaluacionAlistEntrenamientoController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        EvaluacionAlistamientoEntrenamientoComfas evaluacionAlistamientoEntrenamientoComfasBL = new();
        ...
        public ComfasEvaluacionAlistEntrenamientoController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = unidadNavalDTO, data2 = capacidadOperativaDTO, data3 = ejercicioEntrenamientoDTO, data4 = ejercicioEntrenamientoAspectoDTO,
                data5 = calificativoAsignadoEjercicioDTO });
        }

        public IActionResult CargaTabla()
        {
            List<EvaluacionAlistamientoEntrenamientoComfasDTO> select = evaluacionAlistamientoEntrenamientoComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar( int UnidadNavalId, string NivelEntrenamiento, int CapacidadOperativaId, int CodigoEjercicioEntrenamiento, 
            int EjercicioEntrenamientoId, int EjercicioEntrenamientoAspectoId, int PesoEjercicioEntrenamienti, int CalificativoAsignadoEjercicioId,
            string FechaPeriodoEvaluar, string FechaRealizacionEjercicio, int TiempoVigencia)
        {
            EvaluacionAlistamientoEntrenamientoComfasDTO evaluacionAlistamientoEntrenamientoComfasDTO = new();
            evaluacionAlistamientoEntrenamientoComfasDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoEntrenamientoComfasDTO.NivelEntrenamiento = NivelEntrenamiento;
            evaluacionAlistamientoEntrenamientoComfasDTO.CapacidadOperativaId = CapacidadOperativaId;
            evaluacionAlistamientoEntrenamientoComfasDTO.CodigoEjercicioEntrenamiento = CodigoEjercicioEntrenamiento;
            evaluacionAlistamientoEntrenamientoComfasDTO.EjercicioEntrenamientoId = EjercicioEntrenamientoId;
            evaluacionAlistamientoEntrenamientoComfasDTO.EjercicioEntrenamientoAspectoId = EjercicioEntrenamientoAspectoId;
            evaluacionAlistamientoEntrenamientoComfasDTO.PesoEjercicioEntrenamienti = PesoEjercicioEntrenamienti;
            evaluacionAlistamientoEntrenamientoComfasDTO.CalificativoAsignadoEjercicioId = CalificativoAsignadoEjercicioId;
            evaluacionAlistamientoEntrenamientoComfasDTO.FechaPeriodoEvaluar = FechaPeriodoEvaluar;
            evaluacionAlistamientoEntrenamientoComfasDTO.FechaRealizacionEjercicio = FechaRealizacionEjercicio;
            evaluacionAlistamientoEntrenamientoComfasDTO.TiempoVigencia = TiempoVigencia;
            evaluacionAlistamientoEntrenamientoComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = evaluacionAlistamientoEntrenamientoComfasBL.AgregarRegistro(evaluacionAlistamientoEntrenamientoComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(evaluacionAlistamientoEntrenamientoComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, string NivelEntrenamiento, int CapacidadOperativaId,
            int CodigoEjercicioEntrenamiento, int EjercicioEntrenamientoId, int EjercicioEntrenamientoAspectoId, int PesoEjercicioEntrenamienti,
            int CalificativoAsignadoEjercicioId, string FechaPeriodoEvaluar, string FechaRealizacionEjercicio, int TiempoVigencia)
        {
            EvaluacionAlistamientoEntrenamientoComfasDTO evaluacionAlistamientoEntrenamientoComfasDTO = new();
            evaluacionAlistamientoEntrenamientoComfasDTO.EvaluacionAlistamientoEntrenamientoId = Id;
            evaluacionAlistamientoEntrenamientoComfasDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoEntrenamientoComfasDTO.NivelEntrenamiento = NivelEntrenamiento;
            evaluacionAlistamientoEntrenamientoComfasDTO.CapacidadOperativaId = CapacidadOperativaId;
            evaluacionAlistamientoEntrenamientoComfasDTO.CodigoEjercicioEntrenamiento = CodigoEjercicioEntrenamiento;
            ...
            var IND_OPERACION = evaluacionAlistamientoEntrenamientoComfasBL.ActualizarFormato(evaluacionAlistamientoEntrenamientoComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (evaluacionAlistamientoEntrenamientoComfasBL.EliminarFormato(evaluacionAlistamientoEntrenamientoComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = evaluacionAlistamientoEntrenamientoComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = evaluacionAlistamientoEntrenamientoComfasBL.ObtenerLista();
