...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class Combima1AlistCombustibleLubricanteController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        AlistCombustibleLubricanteCombima1 alistCombustibleLubricanteCombima1BL = new();

        UnidadNaval unidadNavalBL = new();
        AlistamientoCombustibleLubricante2 alistamientoCombustibleLubricante2BL = new();
        public Combima1AlistCombustibleLubricanteController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<AlistCombustibleLubricanteCombima1DTO> select = alistCombustibleLubricanteCombima1BL.ObtenerLista();
        ...
        {
            AlistCombustibleLubricanteCombima1DTO alistCombustibleLubricanteCombima1DTO = new();
            alistCombustibleLubricanteCombima1DTO.UnidadNavalId = UnidadNavalId;
            alistCombustibleLubricanteCombima1DTO.AlistamientoCombustibleLubricante2Id = AlistamientoCombustibleLubricante2Id;
            alistCombustibleLubricanteCombima1DTO.PromedioPonderado = PromedioPonderado;
            alistCombustibleLubricanteCombima1DTO.SubPromedioParcial = SubPromedioParcial;
            alistCombustibleLubricanteCombima1DTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistCombustibleLubricanteCombima1BL.AgregarRegistro(alistCombustibleLubricanteCombima1DTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistCombustibleLubricanteCombima1BL.BuscarFormato(Id));
        }
        ...
        {
            AlistCombustibleLubricanteCombima1DTO alistCombustibleLubricanteCombima1DTO = new();
            alistCombustibleLubricanteCombima1DTO.AlistamientoCombustibleLubricanteId = Id;
            alistCombustibleLubricanteCombima1DTO.UnidadNavalId = UnidadNavalId;
            alistCombustibleLubricanteCombima1DTO.AlistamientoCombustibleLubricante2Id = AlistamientoCombustibleLubricante2Id;
            alistCombustibleLubricanteCombima1DTO.PromedioPonderado = PromedioPonderado;
            alistCombustibleLubricanteCombima1DTO.SubPromedioParcial = SubPromedioParcial;
            ...
            var IND_OPERACION = alistCombustibleLubricanteCombima1BL.ActualizarFormato(alistCombustibleLubricanteCombima1DTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistCombustibleLubricanteCombima1BL.EliminarFormato(alistCombustibleLubricanteCombima1DTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistCombustibleLubricanteCombima1BL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistCombustibleLubricanteCombima1BL.ObtenerLista();
