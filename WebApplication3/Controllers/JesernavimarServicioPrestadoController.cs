...
using Marina.Siesmar.LogicaNegocios.Formatos.Jesernavimar;
...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class JesernavimarServicioPrestadoController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        ServicioPrestado servicioPrestadoBL = new();
        ...
        public JesernavimarServicioPrestadoController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Servicios prestados", FromController = typeof(HomeController))]
        ...
        {
            List<ServicioPrestadoDTO> select = servicioPrestadoBL.ObtenerLista();
        ...
        public ActionResult Insertar(string CodigoUnidadNaval, string DocumentoServicio, string FechaServicioPrestado, int UnidadAuxiliarNaval, string NroViajeComercial, int PuertoPeruZarpe, int DepartamentoZarpe, int ProvinciaZarpe, int DistritoZarpe, string FechaHoraZarpe, string Ocurrencia, int PuertoPeruArribo, int DepartamentoArribo, int ProvinciaArribo, int DistritoArribo, string FechaHoraArribo, string EmpresaReceptoraServicio, int CargaId, int mes, int anio)
        {
            ServicioPrestadoDTO servicioPrestadoDTO = new();
            servicioPrestadoDTO.CodigoUnidadNaval = CodigoUnidadNaval;
            servicioPrestadoDTO.DocumentoServicio = DocumentoServicio;
            servicioPrestadoDTO.FechaServicioPrestado = FechaServicioPrestado;
            servicioPrestadoDTO.UnidadAuxiliarNaval = UnidadAuxiliarNaval;
            servicioPrestadoDTO.NroViajeComercial = NroViajeComercial;
            servicioPrestadoDTO.PuertoPeruZarpe = PuertoPeruZarpe;
            servicioPrestadoDTO.DepartamentoZarpe = DepartamentoZarpe;
            servicioPrestadoDTO.ProvinciaZarpe = ProvinciaZarpe;
            servicioPrestadoDTO.DistritoZarpe = DistritoZarpe;
            servicioPrestadoDTO.FechaHoraZarpe = FechaHoraZarpe;
            servicioPrestadoDTO.Ocurrencia = Ocurrencia;
            servicioPrestadoDTO.PuertoPeruArribo = PuertoPeruArribo;
            servicioPrestadoDTO.DepartamentoArribo = DepartamentoArribo;
            servicioPrestadoDTO.ProvinciaArribo = ProvinciaArribo;
            servicioPrestadoDTO.DistritoArribo = DistritoArribo;
            servicioPrestadoDTO.FechaHoraArribo = FechaHoraArribo;
            servicioPrestadoDTO.CargaId = CargaId;
            servicioPrestadoDTO.EmpresaReceptoraServicio = EmpresaReceptoraServicio;
            
            servicioPrestadoDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = servicioPrestadoBL.AgregarRegistro(servicioPrestadoDTO, mes , anio);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(servicioPrestadoBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, string CodigoUnidadNaval, string DocumentoServicio, string FechaServicioPrestado, int UnidadAuxiliarNaval, string NroViajeComercial, int PuertoPeruZarpe, int DepartamentoZarpe, int ProvinciaZarpe, int DistritoZarpe, string FechaHoraZarpe, string Ocurrencia, int PuertoPeruArribo, int DepartamentoArribo, int ProvinciaArribo, int DistritoArribo, string FechaHoraArribo, string EmpresaReceptoraServicio)
        {
            ServicioPrestadoDTO servicioPrestadoDTO = new();
            servicioPrestadoDTO.ServicioPrestadoId = Id;
            servicioPrestadoDTO.CodigoUnidadNaval = CodigoUnidadNaval;
            servicioPrestadoDTO.DocumentoServicio = DocumentoServicio;
            servicioPrestadoDTO.FechaServicioPrestado = FechaServicioPrestado;
            servicioPrestadoDTO.UnidadAuxiliarNaval = UnidadAuxiliarNaval;
            ...
            var IND_OPERACION = servicioPrestadoBL.ActualizarFormato(servicioPrestadoDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (servicioPrestadoBL.EliminarFormato(servicioPrestadoDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        //    try
        //    {
        //        var estado = servicioPrestadoBL.InsercionMasiva(lista);
        //        if (estado == true)
        //        {
        //            mensaje = "ok";
        //        }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = servicioPrestadoBL.ObtenerLista();
