...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComestreAlistamientoCombustibleLubricanteComestreController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        AlistamientoCombustibleLubricanteComestre alistamientoCombustibleLubricanteComestreBL = new();

        UnidadNaval unidadNavalBL = new();
        AlistamientoCombustibleLubricante2 alistamientoCombustibleLubricante2BL = new();

        public ComestreAlistamientoCombustibleLubricanteComestreController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<AlistamientoCombustibleLubricanteComestreDTO> select = alistamientoCombustibleLubricanteComestreBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, int AlistamientoCombustibleLubricante2Id, decimal PromedioPonderado, decimal SubPromedioParcial)
        {
            AlistamientoCombustibleLubricanteComestreDTO alistamientoCombustibleLubricanteComestreDTO = new();
            alistamientoCombustibleLubricanteComestreDTO.UnidadNavalId = UnidadNavalId;
            alistamientoCombustibleLubricanteComestreDTO.AlistamientoCombustibleLubricante2Id = AlistamientoCombustibleLubricante2Id;
            alistamientoCombustibleLubricanteComestreDTO.PromedioPonderado = PromedioPonderado;
            alistamientoCombustibleLubricanteComestreDTO.SubPromedioParcial = SubPromedioParcial;

            alistamientoCombustibleLubricanteComestreDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoCombustibleLubricanteComestreBL.AgregarRegistro(alistamientoCombustibleLubricanteComestreDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoCombustibleLubricanteComestreBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, int AlistamientoCombustibleLubricante2Id, decimal PromedioPonderado, decimal SubPromedioParcial)
        {
            AlistamientoCombustibleLubricanteComestreDTO alistamientoCombustibleLubricanteComestreDTO = new();
            alistamientoCombustibleLubricanteComestreDTO.AlistamientoCombustibleLubricanteId = Id;
            alistamientoCombustibleLubricanteComestreDTO.UnidadNavalId = UnidadNavalId;
            alistamientoCombustibleLubricanteComestreDTO.AlistamientoCombustibleLubricante2Id = AlistamientoCombustibleLubricante2Id;
            alistamientoCombustibleLubricanteComestreDTO.PromedioPonderado = PromedioPonderado;
            alistamientoCombustibleLubricanteComestreDTO.SubPromedioParcial = SubPromedioParcial;
            ...
            var IND_OPERACION = alistamientoCombustibleLubricanteComestreBL.ActualizarFormato(alistamientoCombustibleLubricanteComestreDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoCombustibleLubricanteComestreBL.EliminarFormato(alistamientoCombustibleLubricanteComestreDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoCombustibleLubricanteComestreBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoCombustibleLubricanteComestreBL.ObtenerLista();
