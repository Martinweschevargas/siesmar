...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasCuadroRegistroViajeController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        CuadroRegistroViaje cuadroRegistroViajeBL = new();
        ...
        public ComfasCuadroRegistroViajeController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Cuadro de Registro de Viajes al Extranjero e Interior del País, del Personal de la Fuerza de Superficie", FromController = typeof(HomeController))]
        ...
        {
            List<CuadroRegistroViajeDTO> select = cuadroRegistroViajeBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, string FechaRegistro, int GradoPersonalMilitarId, int EspecialidadGenericaPersonalId, int CIPPersonal,
            int UbigeoOrigen, int UbigeoDestino, string FechaInicio, string FechaTermino, int TiempoDuracion, string MedioViaje, string DocumentoAutorizacion, 
            string MotivoViaje)
        {
            CuadroRegistroViajeDTO cuadroRegistroViajeDTO = new();
            cuadroRegistroViajeDTO.UnidadNavalId = UnidadNavalId;
            cuadroRegistroViajeDTO.FechaRegistro = FechaRegistro;
            cuadroRegistroViajeDTO.GradoPersonalMilitarId = GradoPersonalMilitarId;
            cuadroRegistroViajeDTO.EspecialidadGenericaPersonalId = EspecialidadGenericaPersonalId;
            cuadroRegistroViajeDTO.CIPPersonal = CIPPersonal;
            cuadroRegistroViajeDTO.UbigeoOrigen = UbigeoOrigen;
            cuadroRegistroViajeDTO.UbigeoDestino = UbigeoDestino;
            cuadroRegistroViajeDTO.FechaInicio = FechaInicio;
            cuadroRegistroViajeDTO.FechaTermino = FechaTermino;
            cuadroRegistroViajeDTO.TiempoDuracion = TiempoDuracion;
            cuadroRegistroViajeDTO.MedioViaje = MedioViaje;
            cuadroRegistroViajeDTO.DocumentoAutorizacion = DocumentoAutorizacion;
            cuadroRegistroViajeDTO.MotivoViaje = MotivoViaje;
            cuadroRegistroViajeDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = cuadroRegistroViajeBL.AgregarRegistro(cuadroRegistroViajeDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(cuadroRegistroViajeBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id,  int UnidadNavalId, string FechaRegistro, int GradoPersonalMilitarId, int EspecialidadGenericaPersonalId,
            int CIPPersonal, int UbigeoOrigen, int UbigeoDestino, string FechaInicio, string FechaTermino, int TiempoDuracion, string MedioViaje,
            string DocumentoAutorizacion, string MotivoViaje)
        {
            CuadroRegistroViajeDTO cuadroRegistroViajeDTO = new();
            cuadroRegistroViajeDTO.CuadroRegistroViajeId = Id;
            cuadroRegistroViajeDTO.UnidadNavalId = UnidadNavalId;
            cuadroRegistroViajeDTO.FechaRegistro = FechaRegistro;
            cuadroRegistroViajeDTO.GradoPersonalMilitarId = GradoPersonalMilitarId;
            cuadroRegistroViajeDTO.EspecialidadGenericaPersonalId = EspecialidadGenericaPersonalId;
            ...
            var IND_OPERACION = cuadroRegistroViajeBL.ActualizarFormato(cuadroRegistroViajeDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (cuadroRegistroViajeBL.EliminarFormato(cuadroRegistroViajeDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = cuadroRegistroViajeBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = cuadroRegistroViajeBL.ObtenerLista();
