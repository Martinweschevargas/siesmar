...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComoperguardFalloResueltoSiniestroAcuaticoController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        FalloResueltoSiniestroAcuatico falloResueltoSiniestroAcuaticoBL = new();
        ...
        public ComoperguardFalloResueltoSiniestroAcuaticoController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Fallos Resueltos por Siniestros Acuáticos", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = jefaturaDistritoCapitaniaDTO, data2 = capitaniaDTO, data3 = mesDTO, data4 = tipoNaveDTO,
                data5 = paisUbigeoDTO, data6 = tipoSiniestroDTO });
        }

        public IActionResult CargaTabla()
        {
            List<FalloResueltoSiniestroAcuaticoDTO> select = falloResueltoSiniestroAcuaticoBL.ObtenerLista();
        ...
        public ActionResult Insertar(int JefaturaDistritoCapitaniaId, int CapitaniaId, string HoraCaptura, int DiaCaptura, int MesId,
            int AnioSiniestro, int TipoNaveId, string NombreNaveSiniestro, string MatriculaNaveSiniestro, int ABEdad, int PaisUbigeoId,
            int TipoSiniestroId, int PersonasRescatadasVida, int PersonasFallecidas, int PersonasDesaparecida, int PersonasEvacuadas,
            int TotalPersonas, string ReferenciaDocumento, string FechaDocumento, string ResumenFallo)
        {
            FalloResueltoSiniestroAcuaticoDTO falloResueltoSiniestroAcuaticoDTO = new();
            falloResueltoSiniestroAcuaticoDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            falloResueltoSiniestroAcuaticoDTO.CapitaniaId = CapitaniaId;
            falloResueltoSiniestroAcuaticoDTO.HoraCaptura = HoraCaptura;
            falloResueltoSiniestroAcuaticoDTO.DiaCaptura = DiaCaptura;
            falloResueltoSiniestroAcuaticoDTO.MesId = MesId;
            falloResueltoSiniestroAcuaticoDTO.AnioSiniestro = AnioSiniestro;
            falloResueltoSiniestroAcuaticoDTO.TipoNaveId = TipoNaveId;
            falloResueltoSiniestroAcuaticoDTO.NombreNaveSiniestro = NombreNaveSiniestro;
            falloResueltoSiniestroAcuaticoDTO.MatriculaNaveSiniestro = MatriculaNaveSiniestro;
            falloResueltoSiniestroAcuaticoDTO.ABEdad = ABEdad;
            falloResueltoSiniestroAcuaticoDTO.PaisUbigeoId = PaisUbigeoId;
            falloResueltoSiniestroAcuaticoDTO.TipoSiniestroId = TipoSiniestroId;
            falloResueltoSiniestroAcuaticoDTO.PersonasRescatadasVida = PersonasRescatadasVida;
            falloResueltoSiniestroAcuaticoDTO.PersonasFallecidas = PersonasFallecidas;
            falloResueltoSiniestroAcuaticoDTO.PersonasDesaparecida = PersonasDesaparecida;
            falloResueltoSiniestroAcuaticoDTO.PersonasEvacuadas = PersonasEvacuadas;
            falloResueltoSiniestroAcuaticoDTO.TotalPersonas = TotalPersonas;
            falloResueltoSiniestroAcuaticoDTO.ReferenciaDocumento = ReferenciaDocumento;
            falloResueltoSiniestroAcuaticoDTO.FechaDocumento = FechaDocumento;
            falloResueltoSiniestroAcuaticoDTO.ResumenFallo = ResumenFallo;
            falloResueltoSiniestroAcuaticoDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = falloResueltoSiniestroAcuaticoBL.AgregarRegistro(falloResueltoSiniestroAcuaticoDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(falloResueltoSiniestroAcuaticoBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int JefaturaDistritoCapitaniaId, int CapitaniaId, string HoraCaptura, int DiaCaptura, int MesId, 
            int AnioSiniestro, int TipoNaveId, string NombreNaveSiniestro, string MatriculaNaveSiniestro, int ABEdad, int PaisUbigeoId,
            int TipoSiniestroId, int PersonasRescatadasVida, int PersonasFallecidas, int PersonasDesaparecida, int PersonasEvacuadas,
            int TotalPersonas, string ReferenciaDocumento, string FechaDocumento, string ResumenFallo)
        {
            FalloResueltoSiniestroAcuaticoDTO falloResueltoSiniestroAcuaticoDTO = new();
            falloResueltoSiniestroAcuaticoDTO.FalloResueltoSiniestroAcuaticoId = Id;
            falloResueltoSiniestroAcuaticoDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            falloResueltoSiniestroAcuaticoDTO.CapitaniaId = CapitaniaId;
            falloResueltoSiniestroAcuaticoDTO.HoraCaptura = HoraCaptura;
            falloResueltoSiniestroAcuaticoDTO.DiaCaptura = DiaCaptura;
            ...
            var IND_OPERACION = falloResueltoSiniestroAcuaticoBL.ActualizarFormato(falloResueltoSiniestroAcuaticoDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (falloResueltoSiniestroAcuaticoBL.EliminarFormato(falloResueltoSiniestroAcuaticoDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = falloResueltoSiniestroAcuaticoBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = falloResueltoSiniestroAcuaticoBL.ObtenerLista();
