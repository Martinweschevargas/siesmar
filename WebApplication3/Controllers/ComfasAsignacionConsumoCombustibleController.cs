...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasAsignacionConsumoCombustibleController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        AsignacionConsumoCombustibleComfas asignacionConsumoCombustibleComfasBL = new();

        UnidadNaval unidadNavalBL = new();



        public ComfasAsignacionConsumoCombustibleController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Asignación Consumo Combustible", FromController = typeof(HomeController))]
        ...
        {
            List<AsignacionConsumoCombustibleComfasDTO> select = asignacionConsumoCombustibleComfasBL.ObtenerLista();
        ...
        {
            AsignacionConsumoCombustibleComfasDTO asignacionConsumoCombustibleComfasDTO = new();
            ...
            var IND_OPERACION = asignacionConsumoCombustibleComfasBL.AgregarRegistro(asignacionConsumoCombustibleComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(asignacionConsumoCombustibleComfasBL.BuscarFormato(Id));
        }
        ...
        {
            AsignacionConsumoCombustibleComfasDTO asignacionConsumoCombustibleComfasDTO = new();
            asignacionConsumoCombustibleComfasDTO.AsignacionConsumoCombustibleId = Id;
            asignacionConsumoCombustibleComfasDTO.AnioAsignacion = AnioAsignacion;
            asignacionConsumoCombustibleComfasDTO.UnidadNavalId = UnidadNavalId;
            asignacionConsumoCombustibleComfasDTO.CapacidadMaximaAlmacen = CapacidadMaximaAlmacen;
            asignacionConsumoCombustibleComfasDTO.Asignado = Asignado;
            ...
            var IND_OPERACION = asignacionConsumoCombustibleComfasBL.ActualizarFormato(asignacionConsumoCombustibleComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (asignacionConsumoCombustibleComfasBL.EliminarFormato(asignacionConsumoCombustibleComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = asignacionConsumoCombustibleComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = asignacionConsumoCombustibleComfasBL.ObtenerLista();
