...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComoperpacEvacuadoTiempoPazController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        EvacuadoTiempoPaz evacuadoTiempoPazBL = new();
        ...
        public ComoperpacEvacuadoTiempoPazController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Evacuados en Tiempo de Paz", FromController = typeof(HomeController))]
        ...
        {
            List<EvacuadoTiempoPazDTO> select = evacuadoTiempoPazBL.ObtenerLista();
        ...
        public ActionResult Insertar(int ZonaNavalId, int DistritoUbigeoId, int GradoPersonalId,
            int TipoBajaId, string MotivoEvacuadoTiempoPaz)
        {
            EvacuadoTiempoPazDTO evacuadoTiempoPazDTO = new();
            evacuadoTiempoPazDTO.ZonaNavalId = ZonaNavalId;
            evacuadoTiempoPazDTO.DistritoUbigeoId = DistritoUbigeoId;
            evacuadoTiempoPazDTO.GradoPersonalId = GradoPersonalId;
            evacuadoTiempoPazDTO.TipoBajaId = TipoBajaId;
            evacuadoTiempoPazDTO.MotivoEvacuadoTiempoPaz = MotivoEvacuadoTiempoPaz;
            evacuadoTiempoPazDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = evacuadoTiempoPazBL.AgregarRegistro(evacuadoTiempoPazDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(evacuadoTiempoPazBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int ZonaNavalId, int DistritoUbigeoId, int GradoPersonalId, int TipoBajaId, string MotivoEvacuadoTiempoPaz)
        {
            EvacuadoTiempoPazDTO evacuadoTiempoPazDTO = new();
            evacuadoTiempoPazDTO.EvacuadoTiempoPazId = Id;
            evacuadoTiempoPazDTO.ZonaNavalId = ZonaNavalId;
            evacuadoTiempoPazDTO.DistritoUbigeoId = DistritoUbigeoId;
            evacuadoTiempoPazDTO.GradoPersonalId = GradoPersonalId;
            evacuadoTiempoPazDTO.TipoBajaId = TipoBajaId;
            ...
            var IND_OPERACION = evacuadoTiempoPazBL.ActualizarFormato(evacuadoTiempoPazDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (evacuadoTiempoPazBL.EliminarFormato(evacuadoTiempoPazDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult MostrarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            for (int i = 1; i <= cantidadFilas; i++)
            {
                ...
                {
                    ZonaNavalId = int.Parse(fila.GetCell(0).ToString()),
                    DistritoUbigeoId = int.Parse(fila.GetCell(1).ToString()),
                    GradoPersonalId = int.Parse(fila.GetCell(2).ToString()),
                    TipoBajaId = int.Parse(fila.GetCell(3).ToString()),
                    MotivoEvacuadoTiempoPaz = fila.GetCell(4).ToString(),
                });
            }
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            dt.Columns.AddRange(new DataColumn[6]
            {
                    ...
                    new DataColumn("MotivoEvacuadoTiempoPaz", typeof(string)),
            ...
            var IND_OPERACION = evacuadoTiempoPazBL.InsertarDatos(dt);
            return Content(IND_OPERACION);
        }
        ...
        public IActionResult ReporteCiberataque()
        {
            ...
            var capitania = evacuadoTiempoPazBL.ObtenerLista();
        ...
        {
            var path = $"{this._webHostEnviroment.WebRootPath}\\Formatos\\ComoperpacEvacuadoTiempoPaz.xlsx";
            var fs = new FileStream(path, FileMode.Open);

            return File(fs, "application/octet-stream", "ComoperpacEvacuadoTiempoPaz.xlsx");
        }
