...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasConsumoMensualLubricantePuertoController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        ConsumoMensualLubricantePuertoComfas consumoMensualLubricantePuertoComfasBL = new();

        UnidadNaval unidadNavalBL = new();
        Mes mesBL = new();


        public ComfasConsumoMensualLubricantePuertoController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Cuadro de Reporte del Consumo Mensual de Lubricantes en Puerto", FromController = typeof(HomeController))]
        ...
        {
            List<ConsumoMensualLubricantePuertoComfasDTO> select = consumoMensualLubricantePuertoComfasBL.ObtenerLista();
        ...
        {
            ConsumoMensualLubricantePuertoComfasDTO consumoMensualLubricantePuertoComfasDTO = new();
            consumoMensualLubricantePuertoComfasDTO.UnidadNavalId = UnidadNavalId;
            consumoMensualLubricantePuertoComfasDTO.MesId = MesId;
            consumoMensualLubricantePuertoComfasDTO.LubricanteMotores = LubricanteMotores;
            consumoMensualLubricantePuertoComfasDTO.LubricanteReductores = LubricanteReductores;
            consumoMensualLubricantePuertoComfasDTO.TotalMensual = TotalMensual;
            consumoMensualLubricantePuertoComfasDTO.TotalAnual = TotalAnual;
            consumoMensualLubricantePuertoComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = consumoMensualLubricantePuertoComfasBL.AgregarRegistro(consumoMensualLubricantePuertoComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(consumoMensualLubricantePuertoComfasBL.BuscarFormato(Id));
        }
        ...
        {
            ConsumoMensualLubricantePuertoComfasDTO consumoMensualLubricantePuertoComfasDTO = new();
            consumoMensualLubricantePuertoComfasDTO.ConsumoMensualLubricantePuertoId = Id;
            consumoMensualLubricantePuertoComfasDTO.UnidadNavalId = UnidadNavalId;
            consumoMensualLubricantePuertoComfasDTO.MesId = MesId;
            consumoMensualLubricantePuertoComfasDTO.LubricanteMotores = LubricanteMotores;
            consumoMensualLubricantePuertoComfasDTO.LubricanteReductores = LubricanteReductores;
            ...
            var IND_OPERACION = consumoMensualLubricantePuertoComfasBL.ActualizarFormato(consumoMensualLubricantePuertoComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (consumoMensualLubricantePuertoComfasBL.EliminarFormato(consumoMensualLubricantePuertoComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = consumoMensualLubricantePuertoComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = consumoMensualLubricantePuertoComfasBL.ObtenerLista();
