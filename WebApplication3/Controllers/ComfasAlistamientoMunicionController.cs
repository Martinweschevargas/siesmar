...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasAlistamientoMunicionController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        AlistamientoMunicionComfas alistamientoMunicionComfasBL = new();

        UnidadNaval unidadNavalBL = new();
        SistemaMunicion sistemaMunicionBL = new();
        SubsistemaMunicion subsistemaMunicionBL = new();


        public ComfasAlistamientoMunicionController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult cargaCombs()
        {
            ...
            List<SubsistemaMunicionDTO> subsistemaMunicionSTO = subsistemaMunicionBL.ObtenerSubsistemaMunicions();
          
            return Json(new { data1 = unidadNavalDTO, data2 = sistemaMunicionDTO, data3 = subsistemaMunicionSTO });
        }

        public IActionResult CargaTabla()
        {
            List<AlistamientoMunicionComfasDTO> select = alistamientoMunicionComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar( int UnidadNavalId, int SistemaMunicionId, int SubsistemaMunicionId, int Equipo, int Municion, int Existente, int Necesaria,
            int CoeficientePonderacion)
        {
            AlistamientoMunicionComfasDTO alistamientoMunicionComfasDTO = new();
            alistamientoMunicionComfasDTO.UnidadNavalId = UnidadNavalId;
            alistamientoMunicionComfasDTO.SistemaMunicionId = SistemaMunicionId;
            alistamientoMunicionComfasDTO.SubsistemaMunicionId = SubsistemaMunicionId;
            alistamientoMunicionComfasDTO.Equipo = Equipo;
            alistamientoMunicionComfasDTO.Municion = Municion;
            alistamientoMunicionComfasDTO.Existente = Existente;
            alistamientoMunicionComfasDTO.Necesaria = Necesaria;
            alistamientoMunicionComfasDTO.CoeficientePonderacion = CoeficientePonderacion;
            alistamientoMunicionComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoMunicionComfasBL.AgregarRegistro(alistamientoMunicionComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoMunicionComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, int SistemaMunicionId, int SubsistemaMunicionId, int Equipo, int Municion, int Existente,
            int Necesaria, int CoeficientePonderacion)
        {
            AlistamientoMunicionComfasDTO alistamientoMunicionComfasDTO = new();
            alistamientoMunicionComfasDTO.AlistamientoMunicionComfasId = Id;
            alistamientoMunicionComfasDTO.UnidadNavalId = UnidadNavalId;
            alistamientoMunicionComfasDTO.SistemaMunicionId = SistemaMunicionId;
            alistamientoMunicionComfasDTO.SubsistemaMunicionId = SubsistemaMunicionId;
            alistamientoMunicionComfasDTO.Equipo = Equipo;
            ...
            var IND_OPERACION = alistamientoMunicionComfasBL.ActualizarFormato(alistamientoMunicionComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoMunicionComfasBL.EliminarFormato(alistamientoMunicionComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoMunicionComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoMunicionComfasBL.ObtenerLista();
