...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComesguardIngresoDatoServicioLavanderiaController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        IngresoDatoServicioLavanderia ingresoDatoServicioLavanderiaBL = new();
        ...
        public ComesguardIngresoDatoServicioLavanderiaController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Formato para el ingreso de datos del servicio de lavandería", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            List<CargaDTO> listaCargas = cargaBL.ObtenerListaCargas("IngresoDatoServicioLavanderia");
        ...
        {
            List<IngresoDatoServicioLavanderiaDTO> select = ingresoDatoServicioLavanderiaBL.ObtenerLista();
        ...
        public ActionResult Insertar(string FechaIngreso, string FechaRecojo, string CIP, string CodigoGradoPersonalMilitar,
            string CodigoEspecialidadGenericaPersonal, string Sexo, string CodigoDependencia, int CantidadPrendas, int CargaId)
        {
            IngresoDatoServicioLavanderiaDTO ingresoDatoServicioPeluqueriaDTO = new();
            ...
            var IND_OPERACION = ingresoDatoServicioLavanderiaBL.AgregarRegistro(ingresoDatoServicioPeluqueriaDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(ingresoDatoServicioLavanderiaBL.BuscarFormato(Id));
        }
        ...
        public ActionResult Actualizar(int Id, string FechaIngreso, string FechaRecojo, string CIP, string CodigoGradoPersonalMilitar,
            string CodigoEspecialidadGenericaPersonal, string Sexo, string CodigoDependencia, int CantidadPrendas)
        {
            IngresoDatoServicioLavanderiaDTO ingresoDatoServicioPeluqueriaDTO = new();
            ingresoDatoServicioPeluqueriaDTO.IngresoDatoServicioLavanderiaId = Id;
            ingresoDatoServicioPeluqueriaDTO.FechaIngreso = FechaIngreso;
            ingresoDatoServicioPeluqueriaDTO.FechaRecojo = FechaRecojo;
            ingresoDatoServicioPeluqueriaDTO.CIP = CIP;
            ingresoDatoServicioPeluqueriaDTO.CodigoGradoPersonalMilitar = CodigoGradoPersonalMilitar;
            ...
            var IND_OPERACION = ingresoDatoServicioLavanderiaBL.ActualizarFormato(ingresoDatoServicioPeluqueriaDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (ingresoDatoServicioLavanderiaBL.EliminarFormato(ingresoDatoServicioPeluqueriaDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
            ...
            try
            {
                ...
                for (int i = 1; i <= cantidadFilas; i++)
                {
                    ...
                    lista.Add(new IngresoDatoServicioLavanderiaDTO
                    {
                        ...
                        CantidadPrendas = int.Parse(fila.GetCell(7).ToString()),
                    });
                }
            }
            catch (Exception e)
        ...
        public ActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            var IND_OPERACION = ingresoDatoServicioLavanderiaBL.InsertarDatos(dt);
            return Content(IND_OPERACION);
        }

        public IActionResult ReporteCIDSL(int? CargaId = null)
        {
            string mimtype = "";
            var path = $"{this._webHostEnviroment.WebRootPath}\\Reports\\Comesguard\\IngresoDatoServicioLavanderia.rdlc";
            Dictionary<string, string> parameters = new Dictionary<string, string>();
            var DocenteEsnas = ingresoDatoServicioLavanderiaBL.ObtenerLista(CargaId);
            LocalReport localReport = new LocalReport(path);
            localReport.AddDataSource("IngresoDatoServicioLavanderia", DocenteEsnas);
        ...
        {
            var path = $"{this._webHostEnviroment.WebRootPath}\\Formatos\\IngresoDatoServicioLavanderia.xlsx";
            var fs = new FileStream(path, FileMode.Open);

            return File(fs, "application/octet-stream", "IngresoDatoServicioLavanderia.xlsx");
        }
    }
