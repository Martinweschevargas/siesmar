...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasDiqueoCarenaUnidadNavalController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();
        DiqueoCarenaUnidadNavalComfas diqueoCarenaUnidadNavalComfasBL = new();
        UnidadNaval unidadNavalBL = new();

        public ComfasDiqueoCarenaUnidadNavalController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Cuadro de Diqueo y Carena de Unidades Navales", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = unidadNavalDTO});
        }

        public IActionResult CargaTabla()
        {
            List<DiqueoCarenaUnidadNavalComfasDTO> select = diqueoCarenaUnidadNavalComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar( int UnidadNavalId, string FechaIngresoUltimoDiqueo, string FechaSalidaUltimoDiqueo, string FechaIngresoProximoDiqueo,
            string FechaSalidaProximoDiqueo, string PrioridadProximoDiqueo, string Lugar, string Observaciones)
        {
            DiqueoCarenaUnidadNavalComfasDTO diqueoCarenaUnidadNavalComfasDTO = new();
            diqueoCarenaUnidadNavalComfasDTO.UnidadNavalId = UnidadNavalId;
            diqueoCarenaUnidadNavalComfasDTO.FechaIngresoUltimoDiqueo = FechaIngresoUltimoDiqueo;
            diqueoCarenaUnidadNavalComfasDTO.FechaSalidaUltimoDiqueo = FechaSalidaUltimoDiqueo;
            diqueoCarenaUnidadNavalComfasDTO.FechaIngresoProximoDiqueo = FechaIngresoProximoDiqueo;
            diqueoCarenaUnidadNavalComfasDTO.FechaSalidaProximoDiqueo = FechaSalidaProximoDiqueo;
            diqueoCarenaUnidadNavalComfasDTO.PrioridadProximoDiqueo = PrioridadProximoDiqueo;
            diqueoCarenaUnidadNavalComfasDTO.Lugar = Lugar;
            diqueoCarenaUnidadNavalComfasDTO.Observaciones = Observaciones;
            diqueoCarenaUnidadNavalComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = diqueoCarenaUnidadNavalComfasBL.AgregarRegistro(diqueoCarenaUnidadNavalComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(diqueoCarenaUnidadNavalComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id,int UnidadNavalId, string FechaIngresoUltimoDiqueo, string FechaSalidaUltimoDiqueo, string FechaIngresoProximoDiqueo,
            string FechaSalidaProximoDiqueo, string PrioridadProximoDiqueo, string Lugar, string Observaciones)
        {
            DiqueoCarenaUnidadNavalComfasDTO diqueoCarenaUnidadNavalComfasDTO = new();
            diqueoCarenaUnidadNavalComfasDTO.DiqueoCarenaUnidadNavalId = Id;
            diqueoCarenaUnidadNavalComfasDTO.UnidadNavalId = UnidadNavalId;
            diqueoCarenaUnidadNavalComfasDTO.FechaIngresoUltimoDiqueo = FechaIngresoUltimoDiqueo;
            diqueoCarenaUnidadNavalComfasDTO.FechaSalidaUltimoDiqueo = FechaSalidaUltimoDiqueo;
            diqueoCarenaUnidadNavalComfasDTO.FechaIngresoProximoDiqueo = FechaIngresoProximoDiqueo;
            ...
            var IND_OPERACION = diqueoCarenaUnidadNavalComfasBL.ActualizarFormato(diqueoCarenaUnidadNavalComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (diqueoCarenaUnidadNavalComfasBL.EliminarFormato(diqueoCarenaUnidadNavalComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = diqueoCarenaUnidadNavalComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = diqueoCarenaUnidadNavalComfasBL.ObtenerLista();
