...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasConsumoMensualCombustibleNavegacionController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        ConsumoMensualCombustibleNavegacionComfas consumoMensualCombustibleNavegacionComfasBL = new();

        UnidadNaval unidadNavalBL = new();
        Mes mesBL = new();


        public ComfasConsumoMensualCombustibleNavegacionController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Cuadro de Reporte del Consumo Mensual de Combustible en Navegación", FromController = typeof(HomeController))]
        ...
        {
            List<ConsumoMensualCombustibleNavegacionComfasDTO> select = consumoMensualCombustibleNavegacionComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar( int UnidadNavalId, int MesId, int TotalMensual, int TotalAnual)
        {
            ConsumoMensualCombustibleNavegacionComfasDTO consumoMensualCombustibleNavegacionComfasDTO = new();
            consumoMensualCombustibleNavegacionComfasDTO.UnidadNavalId = UnidadNavalId;
            consumoMensualCombustibleNavegacionComfasDTO.MesId = MesId;
            consumoMensualCombustibleNavegacionComfasDTO.TotalMensual = TotalMensual;
            consumoMensualCombustibleNavegacionComfasDTO.TotalAnual = TotalAnual;
            consumoMensualCombustibleNavegacionComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = consumoMensualCombustibleNavegacionComfasBL.AgregarRegistro(consumoMensualCombustibleNavegacionComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(consumoMensualCombustibleNavegacionComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id,  int UnidadNavalId, int MesId, int TotalMensual, int TotalAnual)
        {
            ConsumoMensualCombustibleNavegacionComfasDTO consumoMensualCombustibleNavegacionComfasDTO = new();
            consumoMensualCombustibleNavegacionComfasDTO.ConsumoMensualCombustibleNavegacionId = Id;
            consumoMensualCombustibleNavegacionComfasDTO.UnidadNavalId = UnidadNavalId;
            consumoMensualCombustibleNavegacionComfasDTO.MesId = MesId;
            consumoMensualCombustibleNavegacionComfasDTO.TotalMensual = TotalMensual;
            consumoMensualCombustibleNavegacionComfasDTO.TotalAnual = TotalAnual;
            ...
            var IND_OPERACION = consumoMensualCombustibleNavegacionComfasBL.ActualizarFormato(consumoMensualCombustibleNavegacionComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (consumoMensualCombustibleNavegacionComfasBL.EliminarFormato(consumoMensualCombustibleNavegacionComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = consumoMensualCombustibleNavegacionComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = consumoMensualCombustibleNavegacionComfasBL.ObtenerLista();
