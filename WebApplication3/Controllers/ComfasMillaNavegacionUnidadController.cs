...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasMillaNavegacionUnidadController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        MillaNavegacionUnidadComfas millaNavegacionUnidadComfasBL = new();

        UnidadNaval unidadNavalBL = new();
        Mes mesBL = new();


        public ComfasMillaNavegacionUnidadController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Millas Navegadas por Unidades de la Fuerza de Superficie", FromController = typeof(HomeController))]
        ...
        {
            List<MillaNavegacionUnidadComfasDTO> select = millaNavegacionUnidadComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar( int UnidadNavalId, int MesId, decimal Millas, string HorasMinutos)
        {
            MillaNavegacionUnidadComfasDTO millaNavegacionUnidadComfasDTO = new();
            millaNavegacionUnidadComfasDTO.UnidadNavalId = UnidadNavalId;
            millaNavegacionUnidadComfasDTO.MesId = MesId;
            millaNavegacionUnidadComfasDTO.Millas = Millas;
            millaNavegacionUnidadComfasDTO.HorasMinutos = HorasMinutos;
            millaNavegacionUnidadComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = millaNavegacionUnidadComfasBL.AgregarRegistro(millaNavegacionUnidadComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(millaNavegacionUnidadComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id,  int UnidadNavalId, int MesId, decimal Millas, string HorasMinutos)
        {
            MillaNavegacionUnidadComfasDTO millaNavegacionUnidadComfasDTO = new();
            millaNavegacionUnidadComfasDTO.MillaNavegacionUnidadComfasId = Id;
            millaNavegacionUnidadComfasDTO.UnidadNavalId = UnidadNavalId;
            millaNavegacionUnidadComfasDTO.MesId = MesId;
            millaNavegacionUnidadComfasDTO.Millas = Millas;
            millaNavegacionUnidadComfasDTO.HorasMinutos = HorasMinutos;
            ...
            var IND_OPERACION = millaNavegacionUnidadComfasBL.ActualizarFormato(millaNavegacionUnidadComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (millaNavegacionUnidadComfasBL.EliminarFormato(millaNavegacionUnidadComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = millaNavegacionUnidadComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = millaNavegacionUnidadComfasBL.ObtenerLista();
