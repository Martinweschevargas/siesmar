...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class Comgoe3EvaluacionAlistamientoEntrenamientoComgoeController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        EvaluacionAlistamientoEntrenamientoComgoe evaluacionAlistamientoEntrenamientoComgoeBL = new();
        ...
        public Comgoe3EvaluacionAlistamientoEntrenamientoComgoeController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<EvaluacionAlistamientoEntrenamientoComgoeDTO> select = evaluacionAlistamientoEntrenamientoComgoeBL.ObtenerLista();
        ...
        {
            EvaluacionAlistamientoEntrenamientoComgoeDTO evaluacionAlistamientoEntrenamientoComgoeDTO = new();
            evaluacionAlistamientoEntrenamientoComgoeDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoEntrenamientoComgoeDTO.NivelEntrenamiento = NivelEntrenamiento;
            evaluacionAlistamientoEntrenamientoComgoeDTO.CapacidadOperativaId = CapacidadOperativaId;
            evaluacionAlistamientoEntrenamientoComgoeDTO.TipoCapacidadOperativa = TipoCapacidadOperativa;
            evaluacionAlistamientoEntrenamientoComgoeDTO.EjercicioEntrenamientoAspectoId = EjercicioEntrenamientoAspectoId;
            evaluacionAlistamientoEntrenamientoComgoeDTO.CalificativoAsignadoEjercicioId = CalificativoAsignadoEjercicioId;
            evaluacionAlistamientoEntrenamientoComgoeDTO.FechaPeriodoEvaluar = FechaPeriodoEvaluar;
            evaluacionAlistamientoEntrenamientoComgoeDTO.FechaRealizacionEjercicio = FechaRealizacionEjercicio;
            evaluacionAlistamientoEntrenamientoComgoeDTO.TiempoVigencia = TiempoVigencia;
            
            evaluacionAlistamientoEntrenamientoComgoeDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = evaluacionAlistamientoEntrenamientoComgoeBL.AgregarRegistro(evaluacionAlistamientoEntrenamientoComgoeDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(evaluacionAlistamientoEntrenamientoComgoeBL.BuscarFormato(Id));
        }
        ...
        {
            EvaluacionAlistamientoEntrenamientoComgoeDTO evaluacionAlistamientoEntrenamientoComgoeDTO = new();
            evaluacionAlistamientoEntrenamientoComgoeDTO.EvaluacionAlistamientoEntrenamientoId = Id;
            evaluacionAlistamientoEntrenamientoComgoeDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoEntrenamientoComgoeDTO.NivelEntrenamiento = NivelEntrenamiento;
            evaluacionAlistamientoEntrenamientoComgoeDTO.CapacidadOperativaId = CapacidadOperativaId;
            evaluacionAlistamientoEntrenamientoComgoeDTO.TipoCapacidadOperativa = TipoCapacidadOperativa;
            ...
            var IND_OPERACION = evaluacionAlistamientoEntrenamientoComgoeBL.ActualizarFormato(evaluacionAlistamientoEntrenamientoComgoeDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (evaluacionAlistamientoEntrenamientoComgoeBL.EliminarFormato(evaluacionAlistamientoEntrenamientoComgoeDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult MostrarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            List<EvaluacionAlistamientoEntrenamientoComgoeDTO> lista = new List<EvaluacionAlistamientoEntrenamientoComgoeDTO>();

            for (int i = 1; i <= cantidadFilas; i++)
            {
                IRow fila = HojaExcel.GetRow(i);

                lista.Add(new EvaluacionAlistamientoEntrenamientoComgoeDTO
                {
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = evaluacionAlistamientoEntrenamientoComgoeBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = evaluacionAlistamientoEntrenamientoComgoeBL.ObtenerLista();
