...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComesclaEjercicioTipoArmaMenorController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        EjercicioTipoArmaMenorComescla ejercicioTipoArmaMenorComesclaBL = new();
        ...
        public ComesclaEjercicioTipoArmaMenorController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<EjercicioTipoArmaMenorComesclaDTO> select = ejercicioTipoArmaMenorComesclaBL.ObtenerLista();
        ...
        {
            EjercicioTipoArmaMenorComesclaDTO ejercicioTipoArmaMenorComesclaDTO = new();
            ejercicioTipoArmaMenorComesclaDTO.TipoPersonalMilitarId = TipoPersonalMilitarId;
            ejercicioTipoArmaMenorComesclaDTO.GradoPersonalMilitarId = GradoPersonalMilitarId;
            ejercicioTipoArmaMenorComesclaDTO.FechaEjercicio = FechaEjercicio;
            ejercicioTipoArmaMenorComesclaDTO.TipoArmamentoId = TipoArmamentoId;
            ejercicioTipoArmaMenorComesclaDTO.PosicionTipoArmaId = PosicionTipoArmaId;
            ejercicioTipoArmaMenorComesclaDTO.DistanciaMetros = DistanciaMetros;
            ejercicioTipoArmaMenorComesclaDTO.CantidadTiro = CantidadTiro;
            ejercicioTipoArmaMenorComesclaDTO.PorcentajeEvaluacion = PorcentajeEvaluacion;
            ejercicioTipoArmaMenorComesclaDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = ejercicioTipoArmaMenorComesclaBL.AgregarRegistro(ejercicioTipoArmaMenorComesclaDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(ejercicioTipoArmaMenorComesclaBL.BuscarFormato(Id));
        }
        ...
        {
            EjercicioTipoArmaMenorComesclaDTO ejercicioTipoArmaMenorComesclaDTO = new();
            ejercicioTipoArmaMenorComesclaDTO.EjercicioTipoArmaMenorId = Id;
            ejercicioTipoArmaMenorComesclaDTO.TipoPersonalMilitarId = TipoPersonalMilitarId;
            ejercicioTipoArmaMenorComesclaDTO.GradoPersonalMilitarId = GradoPersonalMilitarId;
            ejercicioTipoArmaMenorComesclaDTO.FechaEjercicio = FechaEjercicio;
            ejercicioTipoArmaMenorComesclaDTO.TipoArmamentoId = TipoArmamentoId;
            ...
            var IND_OPERACION = ejercicioTipoArmaMenorComesclaBL.ActualizarFormato(ejercicioTipoArmaMenorComesclaDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (ejercicioTipoArmaMenorComesclaBL.EliminarFormato(ejercicioTipoArmaMenorComesclaDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = ejercicioTipoArmaMenorComesclaBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = ejercicioTipoArmaMenorComesclaBL.ObtenerLista();
