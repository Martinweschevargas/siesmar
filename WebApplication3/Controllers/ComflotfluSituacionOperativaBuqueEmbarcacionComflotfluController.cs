...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComflotfluSituacionOperativaBuqueEmbarcacionComflotfluController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        SituacionOperativaBuqueEmbarcacionComflotflu situacionOperativaBuqueEmbarcacionComflotfluBL = new();
        ...
        public ComflotfluSituacionOperativaBuqueEmbarcacionComflotfluController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<SituacionOperativaBuqueEmbarcacionComflotfluDTO> select = situacionOperativaBuqueEmbarcacionComflotfluBL.ObtenerLista();
        ...
        {
            SituacionOperativaBuqueEmbarcacionComflotfluDTO situacionOperativaBuqueEmbarcacionComflotfluDTO = new();
            situacionOperativaBuqueEmbarcacionComflotfluDTO.UnidadNavalId = UnidadNavalId;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.TipoNaveId = TipoNaveId;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.TipoPlataforma = TipoPlataforma;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.UnidadNavalDestino = UnidadNavalDestino;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.Ubicacion = Ubicacion;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.DepartamentoUbigeoId = DepartamentoUbigeoId;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.ProvinciaUbigeoId = ProvinciaUbigeoId;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.DistritoUbigeoId = DistritoUbigeoId;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.CapacidadOperativaRequeridaId = CapacidadOperativaRequeridaId;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.CondicionId = CondicionId;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.Observaciones = Observaciones;
            
            situacionOperativaBuqueEmbarcacionComflotfluDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = situacionOperativaBuqueEmbarcacionComflotfluBL.AgregarRegistro(situacionOperativaBuqueEmbarcacionComflotfluDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(situacionOperativaBuqueEmbarcacionComflotfluBL.BuscarFormato(Id));
        }
        ...
        {
            SituacionOperativaBuqueEmbarcacionComflotfluDTO situacionOperativaBuqueEmbarcacionComflotfluDTO = new();
            situacionOperativaBuqueEmbarcacionComflotfluDTO.SituacionOperativaBuqueEmbarcacionId = Id;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.UnidadNavalId = UnidadNavalId;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.TipoNaveId = TipoNaveId;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.TipoPlataforma = TipoPlataforma;
            situacionOperativaBuqueEmbarcacionComflotfluDTO.UnidadNavalDestino = UnidadNavalDestino;
            ...
            var IND_OPERACION = situacionOperativaBuqueEmbarcacionComflotfluBL.ActualizarFormato(situacionOperativaBuqueEmbarcacionComflotfluDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (situacionOperativaBuqueEmbarcacionComflotfluBL.EliminarFormato(situacionOperativaBuqueEmbarcacionComflotfluDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = situacionOperativaBuqueEmbarcacionComflotfluBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = situacionOperativaBuqueEmbarcacionComflotfluBL.ObtenerLista();
