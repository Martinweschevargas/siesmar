...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComoperguardKilometroRecorridoUnidadTerrestreController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        KilometroRecorridoUnidadTerrestre kilometroRecorridoUnidadTerrestreBL = new();

        JefaturaDistritoCapitania jefaturaDistritoCapitaniaBL = new();
        Capitania capitaniaBL = new();
        TipoVehiculoMovil tipoVehiculoMovil = new();
        MarcaVehiculo marcaVehiculoBL = new();
        UnidadMovilTerrestre unidadMovilTerrestreBL=new();

        public ComoperguardKilometroRecorridoUnidadTerrestreController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Kilometros Recorridos por Unidades Terrestres", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            List<TipoVehiculoMovilDTO> tipoVehiculoMovilDTO = tipoVehiculoMovil.ObtenerCapintanias();
            List<MarcaVehiculoDTO> marcaVehiculoDTO = marcaVehiculoBL.ObtenerMarcaVehiculos();
            List<UnidadMovilTerrestreDTO> unidadMovilTerrestreDTO = unidadMovilTerrestreBL.ObtenerUnidadMovilTerrestres();

            return Json(new { data1 = jefaturaDistritoCapitaniaDTO, data2 = capitaniaDTO, data3 = tipoVehiculoMovilDTO, data4 = marcaVehiculoDTO,
                data5 = unidadMovilTerrestreDTO});
        }

        public IActionResult CargaTabla()
        {
            List<KilometroRecorridoUnidadTerrestreDTO> select = kilometroRecorridoUnidadTerrestreBL.ObtenerLista();
        ...
        public ActionResult Insertar(int JefaturaDistritoCapitaniaId, int CapitaniaId, int TipoVehiculoMovilId, int MarcaVehiculoId,
            int UnidadMovilTerrestreId, int KmRecorridos, int CombustibleConsumido, string FechaInicio, string FechaTermino,
            string Observaciones)
        {
            KilometroRecorridoUnidadTerrestreDTO kilometroRecorridoUnidadTerrestreDTO = new();
            kilometroRecorridoUnidadTerrestreDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            kilometroRecorridoUnidadTerrestreDTO.CapitaniaId = CapitaniaId;
            kilometroRecorridoUnidadTerrestreDTO.TipoVehiculoMovilId = TipoVehiculoMovilId;
            kilometroRecorridoUnidadTerrestreDTO.MarcaVehiculoId = MarcaVehiculoId;
            kilometroRecorridoUnidadTerrestreDTO.UnidadMovilTerrestreId = UnidadMovilTerrestreId;
            kilometroRecorridoUnidadTerrestreDTO.KmRecorridos = KmRecorridos;
            kilometroRecorridoUnidadTerrestreDTO.CombustibleConsumido = CombustibleConsumido;
            kilometroRecorridoUnidadTerrestreDTO.FechaInicio = FechaInicio;
            kilometroRecorridoUnidadTerrestreDTO.FechaTermino = FechaTermino;
            kilometroRecorridoUnidadTerrestreDTO.Observaciones = Observaciones;
            kilometroRecorridoUnidadTerrestreDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = kilometroRecorridoUnidadTerrestreBL.AgregarRegistro(kilometroRecorridoUnidadTerrestreDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(kilometroRecorridoUnidadTerrestreBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int JefaturaDistritoCapitaniaId, int CapitaniaId, int TipoVehiculoMovilId, int MarcaVehiculoId,
            int UnidadMovilTerrestreId, int KmRecorridos, int CombustibleConsumido, string FechaInicio, string FechaTermino, string Observaciones)
        {
            KilometroRecorridoUnidadTerrestreDTO kilometroRecorridoUnidadTerrestreDTO = new();
            kilometroRecorridoUnidadTerrestreDTO.KilometroRecorridoUnidadTerrestreId = Id;
            kilometroRecorridoUnidadTerrestreDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            kilometroRecorridoUnidadTerrestreDTO.CapitaniaId = CapitaniaId;
            kilometroRecorridoUnidadTerrestreDTO.TipoVehiculoMovilId = TipoVehiculoMovilId;
            kilometroRecorridoUnidadTerrestreDTO.MarcaVehiculoId = MarcaVehiculoId;
            ...
            var IND_OPERACION = kilometroRecorridoUnidadTerrestreBL.ActualizarFormato(kilometroRecorridoUnidadTerrestreDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (kilometroRecorridoUnidadTerrestreBL.EliminarFormato(kilometroRecorridoUnidadTerrestreDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = kilometroRecorridoUnidadTerrestreBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = kilometroRecorridoUnidadTerrestreBL.ObtenerLista();
