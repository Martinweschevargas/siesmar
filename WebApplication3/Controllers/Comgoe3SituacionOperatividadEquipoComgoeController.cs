...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class Comgoe3SituacionOperatividadEquipoComgoeController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        SituacionOperatividadEquipoComgoe situacionOperatividadEquipoComgoeBL = new();
        ...
        public Comgoe3SituacionOperatividadEquipoComgoeController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<SituacionOperatividadEquipoComgoeDTO> select = situacionOperatividadEquipoComgoeBL.ObtenerLista();
        ...
        {
            SituacionOperatividadEquipoComgoeDTO situacionOperatividadEquipoComgoeDTO = new();
            situacionOperatividadEquipoComgoeDTO.DescripcionMaterialId = DescripcionMaterialId;
            situacionOperatividadEquipoComgoeDTO.Cantidad = Cantidad;
            situacionOperatividadEquipoComgoeDTO.UnidadNavalId = UnidadNavalId;
            situacionOperatividadEquipoComgoeDTO.Ubicacion = Ubicacion;
            situacionOperatividadEquipoComgoeDTO.DepartamentoUbigeoId = DepartamentoUbigeoId;
            situacionOperatividadEquipoComgoeDTO.ProvinciaUbigeoId = ProvinciaUbigeoId;
            situacionOperatividadEquipoComgoeDTO.DistritoUbigeoId = DistritoUbigeoId;
            situacionOperatividadEquipoComgoeDTO.CondicionId = CondicionId;
            situacionOperatividadEquipoComgoeDTO.Observaciones = Observaciones;
            
            situacionOperatividadEquipoComgoeDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = situacionOperatividadEquipoComgoeBL.AgregarRegistro(situacionOperatividadEquipoComgoeDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(situacionOperatividadEquipoComgoeBL.BuscarFormato(Id));
        }
        ...
        {
            SituacionOperatividadEquipoComgoeDTO situacionOperatividadEquipoComgoeDTO = new();
            situacionOperatividadEquipoComgoeDTO.FormatoSituacionOperatividadEquipoId = Id;
            situacionOperatividadEquipoComgoeDTO.DescripcionMaterialId = DescripcionMaterialId;
            situacionOperatividadEquipoComgoeDTO.Cantidad = Cantidad;
            situacionOperatividadEquipoComgoeDTO.UnidadNavalId = UnidadNavalId;
            situacionOperatividadEquipoComgoeDTO.Ubicacion = Ubicacion;
            ...
            var IND_OPERACION = situacionOperatividadEquipoComgoeBL.ActualizarFormato(situacionOperatividadEquipoComgoeDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (situacionOperatividadEquipoComgoeBL.EliminarFormato(situacionOperatividadEquipoComgoeDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = situacionOperatividadEquipoComgoeBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = situacionOperatividadEquipoComgoeBL.ObtenerLista();
