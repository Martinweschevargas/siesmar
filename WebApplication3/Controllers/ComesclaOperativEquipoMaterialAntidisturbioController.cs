...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComesclaOperativEquipoMaterialAntidisturbioController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        OperatividadEquipoMaterialAntidisturbioComescla operatividadEquipoMaterialAntidisturbioComesclaBL = new();
        ...
        public ComesclaOperativEquipoMaterialAntidisturbioController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Situación de Operatividad de Equipos y Material Antidisturbio", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = descripcionMaterialDTO, data2 = departamentoUbigeoDTO, data3 = provinciaUbigeoDTO,
                data4 = distritoUbigeoDTO, data5 = condicionDTO });
        }

        public IActionResult CargaTabla()
        {
            List<OperatividadEquipoMaterialAntidisturbioComesclaDTO> select = operatividadEquipoMaterialAntidisturbioComesclaBL.ObtenerLista();
        ...
        public ActionResult Insertar( int DescripcionMaterialId, int CantidadMaterial, string Ubicacion, int DepartamentoUbigeoId,
            int ProvinciaUbigeoId, int DistritoUbigeoId, int CondicionId, string Observacion)
        {
            OperatividadEquipoMaterialAntidisturbioComesclaDTO operatividadEquipoMaterialAntidisturbioComesclaDTO = new();
            operatividadEquipoMaterialAntidisturbioComesclaDTO.DescripcionMaterialId = DescripcionMaterialId;
            operatividadEquipoMaterialAntidisturbioComesclaDTO.CantidadMaterial = CantidadMaterial;
            operatividadEquipoMaterialAntidisturbioComesclaDTO.Ubicacion = Ubicacion;
            operatividadEquipoMaterialAntidisturbioComesclaDTO.DepartamentoUbigeoId = DepartamentoUbigeoId;
            operatividadEquipoMaterialAntidisturbioComesclaDTO.ProvinciaUbigeoId = ProvinciaUbigeoId;
            operatividadEquipoMaterialAntidisturbioComesclaDTO.DistritoUbigeoId = DistritoUbigeoId;
            operatividadEquipoMaterialAntidisturbioComesclaDTO.CondicionId = CondicionId;
            operatividadEquipoMaterialAntidisturbioComesclaDTO.Observacion = Observacion;
            operatividadEquipoMaterialAntidisturbioComesclaDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = operatividadEquipoMaterialAntidisturbioComesclaBL.AgregarRegistro(operatividadEquipoMaterialAntidisturbioComesclaDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(operatividadEquipoMaterialAntidisturbioComesclaBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int DescripcionMaterialId, int CantidadMaterial, string Ubicacion, int DepartamentoUbigeoId,
            int ProvinciaUbigeoId, int DistritoUbigeoId, int CondicionId, string Observacion )
        {
            OperatividadEquipoMaterialAntidisturbioComesclaDTO operatividadEquipoMaterialAntidisturbioComesclaDTO = new();
            operatividadEquipoMaterialAntidisturbioComesclaDTO.OperatividadEquiposMaterialAntidisturbioId = Id;
            operatividadEquipoMaterialAntidisturbioComesclaDTO.DescripcionMaterialId = DescripcionMaterialId;
            operatividadEquipoMaterialAntidisturbioComesclaDTO.CantidadMaterial = CantidadMaterial;
            operatividadEquipoMaterialAntidisturbioComesclaDTO.Ubicacion = Ubicacion;
            operatividadEquipoMaterialAntidisturbioComesclaDTO.DepartamentoUbigeoId = DepartamentoUbigeoId;
            ...
            var IND_OPERACION = operatividadEquipoMaterialAntidisturbioComesclaBL.ActualizarFormato(operatividadEquipoMaterialAntidisturbioComesclaDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (operatividadEquipoMaterialAntidisturbioComesclaBL.EliminarFormato(operatividadEquipoMaterialAntidisturbioComesclaDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = operatividadEquipoMaterialAntidisturbioComesclaBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = operatividadEquipoMaterialAntidisturbioComesclaBL.ObtenerLista();
