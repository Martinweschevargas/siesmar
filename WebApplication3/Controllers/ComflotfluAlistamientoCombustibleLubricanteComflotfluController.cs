...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComflotfluAlistamientoCombustibleLubricanteComflotfluController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        AlistamientoCombustibleLubricanteComflotflu alistamientoCombustibleLubricanteComflotfluBL = new();

        UnidadNaval unidadNavalBL = new();
        AlistamientoCombustibleLubricante2 alistamientoCombustibleLubricante2BL = new();

        public ComflotfluAlistamientoCombustibleLubricanteComflotfluController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<AlistamientoCombustibleLubricanteComflotfluDTO> select = alistamientoCombustibleLubricanteComflotfluBL.ObtenerLista();
        ...
        {
            AlistamientoCombustibleLubricanteComflotfluDTO alistamientoCombustibleLubricanteComflotfluDTO = new();
            alistamientoCombustibleLubricanteComflotfluDTO.UnidadNavalId = UnidadNavalId;
            alistamientoCombustibleLubricanteComflotfluDTO.AlistamientoCombustibleLubricante2Id = AlistamientoCombustibleLubricante2Id;
            
            alistamientoCombustibleLubricanteComflotfluDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoCombustibleLubricanteComflotfluBL.AgregarRegistro(alistamientoCombustibleLubricanteComflotfluDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoCombustibleLubricanteComflotfluBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, int AlistamientoCombustibleLubricante2Id)
        {
            AlistamientoCombustibleLubricanteComflotfluDTO alistamientoCombustibleLubricanteComflotfluDTO = new();
            alistamientoCombustibleLubricanteComflotfluDTO.AlistamientoCombustibleLubricanteId = Id;
            alistamientoCombustibleLubricanteComflotfluDTO.UnidadNavalId = UnidadNavalId;
            alistamientoCombustibleLubricanteComflotfluDTO.AlistamientoCombustibleLubricante2Id = AlistamientoCombustibleLubricante2Id;
            ...
            var IND_OPERACION = alistamientoCombustibleLubricanteComflotfluBL.ActualizarFormato(alistamientoCombustibleLubricanteComflotfluDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoCombustibleLubricanteComflotfluBL.EliminarFormato(alistamientoCombustibleLubricanteComflotfluDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoCombustibleLubricanteComflotfluBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoCombustibleLubricanteComflotfluBL.ObtenerLista();
