...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasAsignacionConsumoLubricanteMotorController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        AsignacionConsumoLubricanteMotorComfas asignacionConsumoLubricanteMotorComfasBL = new();

        UnidadNaval unidadNavalBL = new();



        public ComfasAsignacionConsumoLubricanteMotorController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Asignación  Lubricantes de Motores", FromController = typeof(HomeController))]
        ...
        {
            List<AsignacionConsumoLubricanteMotorComfasDTO> select = asignacionConsumoLubricanteMotorComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar( int AnioAsignacion, int UnidadNavalId, int CapacidadMaximaAlmacen, int Asignado, int ConsumoTotalAnualPuerto,
            int ConsumoTotalAnualNavegacion)
        {
            AsignacionConsumoLubricanteMotorComfasDTO asignacionConsumoLubricanteMotorComfasDTO = new();
            asignacionConsumoLubricanteMotorComfasDTO.AnioAsignacion = AnioAsignacion;
            asignacionConsumoLubricanteMotorComfasDTO.UnidadNavalId = UnidadNavalId;
            asignacionConsumoLubricanteMotorComfasDTO.CapacidadMaximaAlmacen = CapacidadMaximaAlmacen;
            asignacionConsumoLubricanteMotorComfasDTO.Asignado = Asignado;
            asignacionConsumoLubricanteMotorComfasDTO.ConsumoTotalAnualPuerto = ConsumoTotalAnualPuerto;
            asignacionConsumoLubricanteMotorComfasDTO.ConsumoTotalAnualNavegacion = ConsumoTotalAnualNavegacion;
            asignacionConsumoLubricanteMotorComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = asignacionConsumoLubricanteMotorComfasBL.AgregarRegistro(asignacionConsumoLubricanteMotorComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(asignacionConsumoLubricanteMotorComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id,int AnioAsignacion, int UnidadNavalId, int CapacidadMaximaAlmacen, int Asignado, int ConsumoTotalAnualPuerto,
            int ConsumoTotalAnualNavegacion)
        {
            AsignacionConsumoLubricanteMotorComfasDTO asignacionConsumoLubricanteMotorComfasDTO = new();
            asignacionConsumoLubricanteMotorComfasDTO.AsignacionConsumoLubricanteMotorId = Id;
            asignacionConsumoLubricanteMotorComfasDTO.AnioAsignacion = AnioAsignacion;
            asignacionConsumoLubricanteMotorComfasDTO.UnidadNavalId = UnidadNavalId;
            asignacionConsumoLubricanteMotorComfasDTO.CapacidadMaximaAlmacen = CapacidadMaximaAlmacen;
            asignacionConsumoLubricanteMotorComfasDTO.Asignado = Asignado;
            ...
            var IND_OPERACION = asignacionConsumoLubricanteMotorComfasBL.ActualizarFormato(asignacionConsumoLubricanteMotorComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (asignacionConsumoLubricanteMotorComfasBL.EliminarFormato(asignacionConsumoLubricanteMotorComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = asignacionConsumoLubricanteMotorComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = asignacionConsumoLubricanteMotorComfasBL.ObtenerLista();
