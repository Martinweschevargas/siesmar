...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasConsumoMensualLubricanteNavegacionController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        ConsumoMensualLubricanteNavegacionComfas consumoMensualLubricanteNavegacionComfasBL = new();

        UnidadNaval unidadNavalBL = new();
        Mes mesBL = new();


        public ComfasConsumoMensualLubricanteNavegacionController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Cuadro de Reporte del Consumo Mensual de Lubricantes en Navegación", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = unidadNavalDTO, data2 = mesDTO });
        }

        public IActionResult CargaTabla()
        {
            List<ConsumoMensualLubricanteNavegacionComfasDTO> select = consumoMensualLubricanteNavegacionComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, int MesId, int LubricanteMotores, int LubricanteReductores, int TotalMensual, int TotalAnual)
        {
            ConsumoMensualLubricanteNavegacionComfasDTO consumoMensualLubricanteNavegacionComfasDTO = new();
            consumoMensualLubricanteNavegacionComfasDTO.UnidadNavalId = UnidadNavalId;
            consumoMensualLubricanteNavegacionComfasDTO.MesId = MesId;
            consumoMensualLubricanteNavegacionComfasDTO.LubricanteMotores = LubricanteMotores;
            consumoMensualLubricanteNavegacionComfasDTO.LubricanteReductores = LubricanteReductores;
            consumoMensualLubricanteNavegacionComfasDTO.TotalMensual = TotalMensual;
            consumoMensualLubricanteNavegacionComfasDTO.TotalAnual = TotalAnual;
            consumoMensualLubricanteNavegacionComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = consumoMensualLubricanteNavegacionComfasBL.AgregarRegistro(consumoMensualLubricanteNavegacionComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(consumoMensualLubricanteNavegacionComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id,  int UnidadNavalId, int MesId, int LubricanteMotores, int LubricanteReductores, int TotalMensual, int TotalAnual)
        {
            ConsumoMensualLubricanteNavegacionComfasDTO consumoMensualLubricanteNavegacionComfasDTO = new();
            consumoMensualLubricanteNavegacionComfasDTO.ConsumoMensualLubricanteNavegacionId = Id;
            consumoMensualLubricanteNavegacionComfasDTO.UnidadNavalId = UnidadNavalId;
            consumoMensualLubricanteNavegacionComfasDTO.MesId = MesId;
            consumoMensualLubricanteNavegacionComfasDTO.LubricanteMotores = LubricanteMotores;
            consumoMensualLubricanteNavegacionComfasDTO.LubricanteReductores = LubricanteReductores;
            ...
            var IND_OPERACION = consumoMensualLubricanteNavegacionComfasBL.ActualizarFormato(consumoMensualLubricanteNavegacionComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (consumoMensualLubricanteNavegacionComfasBL.EliminarFormato(consumoMensualLubricanteNavegacionComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = consumoMensualLubricanteNavegacionComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = consumoMensualLubricanteNavegacionComfasBL.ObtenerLista();
