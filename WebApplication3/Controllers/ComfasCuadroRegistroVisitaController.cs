...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasCuadroRegistroVisitaController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        CuadroRegistroVisitaComfas cuadroRegistroVisitaComfasBL = new();

        UnidadNaval unidadNavalBL = new();
        PaisUbigeo paisUbigeoBL = new();
        ClaseVisita claseVisitaBL = new();


        public ComfasCuadroRegistroVisitaController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Cuadro de Registro de Visitas a la Fuerza de Superficie", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            List<ClaseVisitaDTO> claseVisitaDTO = claseVisitaBL.ObtenerClaseVisitas();
          
            return Json(new { data1 = unidadNavalDTO, data2 = paisUbigeoDTO, data3 = claseVisitaDTO });
        }

        public IActionResult CargaTabla()
        {
            List<CuadroRegistroVisitaComfasDTO> select = cuadroRegistroVisitaComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar( int UnidadNavalId, string FechaVisita, string HoraIngreso, string HoraSalida, int DNIVisitante, int PasaporteVisitante,
            int PaisUbigeoId, int ClaseVisitaId, string MotivoViaje)
        {
            CuadroRegistroVisitaComfasDTO cuadroRegistroVisitaComfasDTO = new();
            cuadroRegistroVisitaComfasDTO.UnidadNavalId = UnidadNavalId;
            cuadroRegistroVisitaComfasDTO.FechaVisita = FechaVisita;
            cuadroRegistroVisitaComfasDTO.HoraIngreso = HoraIngreso;
            cuadroRegistroVisitaComfasDTO.HoraSalida = HoraSalida;
            cuadroRegistroVisitaComfasDTO.DNIVisitante = DNIVisitante;
            cuadroRegistroVisitaComfasDTO.PasaporteVisitante = PasaporteVisitante;
            cuadroRegistroVisitaComfasDTO.PaisUbigeoId = PaisUbigeoId;
            cuadroRegistroVisitaComfasDTO.ClaseVisitaId = ClaseVisitaId;
            cuadroRegistroVisitaComfasDTO.MotivoViaje = MotivoViaje;
            cuadroRegistroVisitaComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = cuadroRegistroVisitaComfasBL.AgregarRegistro(cuadroRegistroVisitaComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(cuadroRegistroVisitaComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, string FechaVisita, string HoraIngreso, string HoraSalida, int DNIVisitante, int PasaporteVisitante,
            int PaisUbigeoId, int ClaseVisitaId, string MotivoViaje)
        {
            CuadroRegistroVisitaComfasDTO cuadroRegistroVisitaComfasDTO = new();
            cuadroRegistroVisitaComfasDTO.CuadroRegistroVisitaComfasId = Id;
            cuadroRegistroVisitaComfasDTO.UnidadNavalId = UnidadNavalId;
            cuadroRegistroVisitaComfasDTO.FechaVisita = FechaVisita;
            cuadroRegistroVisitaComfasDTO.HoraIngreso = HoraIngreso;
            cuadroRegistroVisitaComfasDTO.HoraSalida = HoraSalida;
            ...
            var IND_OPERACION = cuadroRegistroVisitaComfasBL.ActualizarFormato(cuadroRegistroVisitaComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (cuadroRegistroVisitaComfasBL.EliminarFormato(cuadroRegistroVisitaComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = cuadroRegistroVisitaComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = cuadroRegistroVisitaComfasBL.ObtenerLista();
