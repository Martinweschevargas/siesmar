...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class Combima1SituacionOperatividadEquipoController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        SituacionOperatividadEquipoCombima1 aituacionOperatividadEquipoCombima1BL = new();
        ...
        public Combima1SituacionOperatividadEquipoController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<SituacionOperatividadEquipoCombima1DTO> select = aituacionOperatividadEquipoCombima1BL.ObtenerLista();
        ...
        {
            SituacionOperatividadEquipoCombima1DTO aituacionOperatividadEquipoCombima1DTO = new();
            aituacionOperatividadEquipoCombima1DTO.DescripcionMaterialId = DescripcionMaterialId;
            aituacionOperatividadEquipoCombima1DTO.Cantidad = Cantidad;
            aituacionOperatividadEquipoCombima1DTO.UnidadNavalId = UnidadNavalId;
            aituacionOperatividadEquipoCombima1DTO.Ubicacion = Ubicacion;
            aituacionOperatividadEquipoCombima1DTO.DistritoUbigeoId = DistritoUbigeoId;
            aituacionOperatividadEquipoCombima1DTO.CondicionId = CondicionId;
            aituacionOperatividadEquipoCombima1DTO.Observacion = Observacion;
            aituacionOperatividadEquipoCombima1DTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = aituacionOperatividadEquipoCombima1BL.AgregarRegistro(aituacionOperatividadEquipoCombima1DTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(aituacionOperatividadEquipoCombima1BL.BuscarFormato(Id));
        }
        ...
        {
            SituacionOperatividadEquipoCombima1DTO aituacionOperatividadEquipoCombima1DTO = new();
            aituacionOperatividadEquipoCombima1DTO.SituacionOperatividadEquipoId = Id;
            aituacionOperatividadEquipoCombima1DTO.DescripcionMaterialId = DescripcionMaterialId;
            aituacionOperatividadEquipoCombima1DTO.Cantidad = Cantidad;
            aituacionOperatividadEquipoCombima1DTO.UnidadNavalId = UnidadNavalId;
            aituacionOperatividadEquipoCombima1DTO.Ubicacion = Ubicacion;
            ...
            var IND_OPERACION = aituacionOperatividadEquipoCombima1BL.ActualizarFormato(aituacionOperatividadEquipoCombima1DTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (aituacionOperatividadEquipoCombima1BL.EliminarFormato(aituacionOperatividadEquipoCombima1DTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = aituacionOperatividadEquipoCombima1BL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = aituacionOperatividadEquipoCombima1BL.ObtenerLista();
