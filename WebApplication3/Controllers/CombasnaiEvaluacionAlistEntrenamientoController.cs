...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class CombasnaiEvaluacionAlistEntrenamientoController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        EvaluacionAlistEntrenamientoCombasnai evaluacionAlistamientoEntrenamientoBL = new();
        ...
        public CombasnaiEvaluacionAlistEntrenamientoController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = unidadNavalDTO, data2 = capacidadOperativaDTO, data3 = calificativoAsignadoEjercicioDTO, data4 = ejercicioEntrenamientoAspectoDTO });
        }

        public IActionResult CargaTabla()
        {
            List<EvaluacionAlistEntrenamientoCombasnaiDTO> select = evaluacionAlistamientoEntrenamientoBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, string NivelEntrenamiento, int CapacidadOperativaId, string TipoCapacidadOperativa,
            int   EjercicioEntrenamientoAspectoId, int CalificativoAsignadoEjercicioId, string FechaPeriodoEvaluar, string FechaRealizacionEjercicio,
            int TiempoVigencia)
        {
            EvaluacionAlistEntrenamientoCombasnaiDTO evaluacionAlistamientoEntrenamientoDTO = new();
            evaluacionAlistamientoEntrenamientoDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoEntrenamientoDTO.NivelEntrenamiento = NivelEntrenamiento;
            evaluacionAlistamientoEntrenamientoDTO.CapacidadOperativaId = CapacidadOperativaId;
            evaluacionAlistamientoEntrenamientoDTO.TipoCapacidadOperativa = TipoCapacidadOperativa;
            evaluacionAlistamientoEntrenamientoDTO.EjercicioEntrenamientoAspectoId = EjercicioEntrenamientoAspectoId;

            evaluacionAlistamientoEntrenamientoDTO.CalificativoAsignadoEjercicioId = CalificativoAsignadoEjercicioId;
            evaluacionAlistamientoEntrenamientoDTO.FechaPeriodoEvaluar = FechaPeriodoEvaluar;
            evaluacionAlistamientoEntrenamientoDTO.FechaRealizacionEjercicio = FechaRealizacionEjercicio;
            evaluacionAlistamientoEntrenamientoDTO.TiempoVigencia = TiempoVigencia;
            evaluacionAlistamientoEntrenamientoDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = evaluacionAlistamientoEntrenamientoBL.AgregarRegistro(evaluacionAlistamientoEntrenamientoDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(evaluacionAlistamientoEntrenamientoBL.BuscarFormato(Id));
        }
        ...
        {
            EvaluacionAlistEntrenamientoCombasnaiDTO evaluacionAlistamientoEntrenamientoDTO = new();
            evaluacionAlistamientoEntrenamientoDTO.EvaluacionAlistamientoEntrenamientoId = Id;
            evaluacionAlistamientoEntrenamientoDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoEntrenamientoDTO.NivelEntrenamiento = NivelEntrenamiento;
            evaluacionAlistamientoEntrenamientoDTO.CapacidadOperativaId = CapacidadOperativaId;
            evaluacionAlistamientoEntrenamientoDTO.TipoCapacidadOperativa = TipoCapacidadOperativa;
            ...
            var IND_OPERACION = evaluacionAlistamientoEntrenamientoBL.ActualizarFormato(evaluacionAlistamientoEntrenamientoDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (evaluacionAlistamientoEntrenamientoBL.EliminarFormato(evaluacionAlistamientoEntrenamientoDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = evaluacionAlistamientoEntrenamientoBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = evaluacionAlistamientoEntrenamientoBL.ObtenerLista();
