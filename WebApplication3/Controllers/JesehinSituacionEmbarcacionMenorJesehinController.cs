...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class JesehinSituacionEmbarcacionMenorJesehinController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        SituacionEmbarcacionMenorJesehin situacionEmbarcacionMenorJesehinBL = new();
        ...
        public JesehinSituacionEmbarcacionMenorJesehinController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<SituacionEmbarcacionMenorJesehinDTO> select = situacionEmbarcacionMenorJesehinBL.ObtenerLista();
        ...
        {
            SituacionEmbarcacionMenorJesehinDTO situacionEmbarcacionMenorJesehinDTO = new();
            situacionEmbarcacionMenorJesehinDTO.UnidadNavalId = UnidadNavalId;
            situacionEmbarcacionMenorJesehinDTO.TipoNaveId = TipoNaveId;
            situacionEmbarcacionMenorJesehinDTO.TipoPlataforma = TipoPlataforma;
            situacionEmbarcacionMenorJesehinDTO.UnidadNavalDestino = UnidadNavalDestino;
            situacionEmbarcacionMenorJesehinDTO.Ubicacion = Ubicacion;
            situacionEmbarcacionMenorJesehinDTO.DepartamentoUbigeoId = DepartamentoUbigeoId;
            situacionEmbarcacionMenorJesehinDTO.ProvinciaUbigeoId = ProvinciaUbigeoId;
            situacionEmbarcacionMenorJesehinDTO.DistritoUbigeoId = DistritoUbigeoId;
            situacionEmbarcacionMenorJesehinDTO.CapacidadOperativaRequeridaId = CapacidadOperativaRequeridaId;
            situacionEmbarcacionMenorJesehinDTO.CondicionId = CondicionId;
            situacionEmbarcacionMenorJesehinDTO.Observaciones = Observaciones;
            
            situacionEmbarcacionMenorJesehinDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = situacionEmbarcacionMenorJesehinBL.AgregarRegistro(situacionEmbarcacionMenorJesehinDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(situacionEmbarcacionMenorJesehinBL.BuscarFormato(Id));
        }
        ...
        {
            SituacionEmbarcacionMenorJesehinDTO situacionEmbarcacionMenorJesehinDTO = new();
            situacionEmbarcacionMenorJesehinDTO.SituacionEmbarcacionMenorId = Id;
            situacionEmbarcacionMenorJesehinDTO.UnidadNavalId = UnidadNavalId;
            situacionEmbarcacionMenorJesehinDTO.TipoNaveId = TipoNaveId;
            situacionEmbarcacionMenorJesehinDTO.TipoPlataforma = TipoPlataforma;
            situacionEmbarcacionMenorJesehinDTO.UnidadNavalDestino = UnidadNavalDestino;
            ...
            var IND_OPERACION = situacionEmbarcacionMenorJesehinBL.ActualizarFormato(situacionEmbarcacionMenorJesehinDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (situacionEmbarcacionMenorJesehinBL.EliminarFormato(situacionEmbarcacionMenorJesehinDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = situacionEmbarcacionMenorJesehinBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = situacionEmbarcacionMenorJesehinBL.ObtenerLista();
