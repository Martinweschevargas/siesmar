...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class Comgoe3EvaluacionAlistamientoPersonalComgoeController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        EvaluacionAlistamientoPersonalComgoe evaluacionAlistamientoPersonalComgoeBL = new();

        UnidadNaval unidadNavalBL = new();
        GradoPersonalMilitar gradoPersonalMilitarBL = new();
        EspecialidadGenericaPersonal especialidadGenericaPersonalBL = new();

        public Comgoe3EvaluacionAlistamientoPersonalComgoeController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<EvaluacionAlistamientoPersonalComgoeDTO> select = evaluacionAlistamientoPersonalComgoeBL.ObtenerLista();
        ...
        {
            EvaluacionAlistamientoPersonalComgoeDTO evaluacionAlistamientoPersonalComgoeDTO = new();
            evaluacionAlistamientoPersonalComgoeDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoPersonalComgoeDTO.FechaEvaluacion = FechaEvaluacion;
            evaluacionAlistamientoPersonalComgoeDTO.DNIPersonal = DNIPersonal;
            evaluacionAlistamientoPersonalComgoeDTO.CIPPersonal = CIPPersonal;
            evaluacionAlistamientoPersonalComgoeDTO.Cargo = Cargo;
            evaluacionAlistamientoPersonalComgoeDTO.GradoPersonalMilitarId = GradoPersonalMilitarId;
            evaluacionAlistamientoPersonalComgoeDTO.EspecialidadGenericaPersonalId = EspecialidadGenericaPersonalId;
            evaluacionAlistamientoPersonalComgoeDTO.GradoPersonalMilitarActual = GradoPersonalMilitarActual;
            evaluacionAlistamientoPersonalComgoeDTO.EspecialidadGenericaPersonalActual = EspecialidadGenericaPersonalActual;
            evaluacionAlistamientoPersonalComgoeDTO.GradoJerarquico = GradoJerarquico;
            evaluacionAlistamientoPersonalComgoeDTO.ServicioExperiencia = ServicioExperiencia;
            evaluacionAlistamientoPersonalComgoeDTO.EspecializacionProfesional = EspecializacionProfesional;
            evaluacionAlistamientoPersonalComgoeDTO.CursoProfesionalRequerido = CursoProfesionalRequerido;
            
            evaluacionAlistamientoPersonalComgoeDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = evaluacionAlistamientoPersonalComgoeBL.AgregarRegistro(evaluacionAlistamientoPersonalComgoeDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(evaluacionAlistamientoPersonalComgoeBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, string FechaEvaluacion, int DNIPersonal, int CIPPersonal, string Cargo, int GradoPersonalMilitarId, int EspecialidadGenericaPersonalId, int GradoPersonalMilitarActual, int EspecialidadGenericaPersonalActual, decimal GradoJerarquico, decimal ServicioExperiencia, decimal EspecializacionProfesional, decimal CursoProfesionalRequerido)
        {
            EvaluacionAlistamientoPersonalComgoeDTO evaluacionAlistamientoPersonalComgoeDTO = new();
            evaluacionAlistamientoPersonalComgoeDTO.EvaluacionAlistamientoPersonalId = Id;
            evaluacionAlistamientoPersonalComgoeDTO.UnidadNavalId = UnidadNavalId;
            evaluacionAlistamientoPersonalComgoeDTO.FechaEvaluacion = FechaEvaluacion;
            evaluacionAlistamientoPersonalComgoeDTO.DNIPersonal = DNIPersonal;
            evaluacionAlistamientoPersonalComgoeDTO.CIPPersonal = CIPPersonal;
            ...
            var IND_OPERACION = evaluacionAlistamientoPersonalComgoeBL.ActualizarFormato(evaluacionAlistamientoPersonalComgoeDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (evaluacionAlistamientoPersonalComgoeBL.EliminarFormato(evaluacionAlistamientoPersonalComgoeDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = evaluacionAlistamientoPersonalComgoeBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = evaluacionAlistamientoPersonalComgoeBL.ObtenerLista();
