...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasCuadroDemostrativoPersonalController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        CuadroDemostrativoPersonalComfas cuadroDemostrativoPersonalComfasBL = new();
        ...
        public ComfasCuadroDemostrativoPersonalController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Cuadro Demostrativo DEL Personal de la Fuerza de Superficie", FromController = typeof(HomeController))]
        ...
        {
            List<CuadroDemostrativoPersonalComfasDTO> select = cuadroDemostrativoPersonalComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, string Fecha, int GradoPersonalMilitarId, int EspecialidadGenericaPersonalId,
            int CIPPersonal, string Condicion, int UbigeoOrigen, int UbigeoDestino, string FechaInicio, string FechaTermino, int DuracionDias,
            string DocumentoReferencia, string Motivo)
        {
            CuadroDemostrativoPersonalComfasDTO cuadroDemostrativoPersonalComfasDTO = new();
            cuadroDemostrativoPersonalComfasDTO.UnidadNavalId = UnidadNavalId;
            cuadroDemostrativoPersonalComfasDTO.Fecha = Fecha;
            cuadroDemostrativoPersonalComfasDTO.GradoPersonalMilitarId = GradoPersonalMilitarId;
            cuadroDemostrativoPersonalComfasDTO.EspecialidadGenericaPersonalId = EspecialidadGenericaPersonalId;
            cuadroDemostrativoPersonalComfasDTO.CIPPersonal = CIPPersonal;
            cuadroDemostrativoPersonalComfasDTO.Condicion = Condicion;
            cuadroDemostrativoPersonalComfasDTO.UbigeoOrigen = UbigeoOrigen;
            cuadroDemostrativoPersonalComfasDTO.UbigeoDestino = UbigeoDestino;
            cuadroDemostrativoPersonalComfasDTO.FechaInicio = FechaInicio;
            cuadroDemostrativoPersonalComfasDTO.FechaTermino = FechaTermino;
            cuadroDemostrativoPersonalComfasDTO.DuracionDias = DuracionDias;
            cuadroDemostrativoPersonalComfasDTO.DocumentoReferencia = DocumentoReferencia;
            cuadroDemostrativoPersonalComfasDTO.Motivo = Motivo;
            cuadroDemostrativoPersonalComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = cuadroDemostrativoPersonalComfasBL.AgregarRegistro(cuadroDemostrativoPersonalComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(cuadroDemostrativoPersonalComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, string Fecha, int GradoPersonalMilitarId, int EspecialidadGenericaPersonalId,
            int CIPPersonal, string Condicion, int UbigeoOrigen, int UbigeoDestino, string FechaInicio, string FechaTermino, int DuracionDias,
            string DocumentoReferencia, string Motivo)
        {
            CuadroDemostrativoPersonalComfasDTO cuadroDemostrativoPersonalComfasDTO = new();
            cuadroDemostrativoPersonalComfasDTO.CuadroDemostrativoPersonalComfasId = Id;
            cuadroDemostrativoPersonalComfasDTO.UnidadNavalId = UnidadNavalId;
            cuadroDemostrativoPersonalComfasDTO.Fecha = Fecha;
            cuadroDemostrativoPersonalComfasDTO.GradoPersonalMilitarId = GradoPersonalMilitarId;
            cuadroDemostrativoPersonalComfasDTO.EspecialidadGenericaPersonalId = EspecialidadGenericaPersonalId;
            ...
            var IND_OPERACION = cuadroDemostrativoPersonalComfasBL.ActualizarFormato(cuadroDemostrativoPersonalComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (cuadroDemostrativoPersonalComfasBL.EliminarFormato(cuadroDemostrativoPersonalComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = cuadroDemostrativoPersonalComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = cuadroDemostrativoPersonalComfasBL.ObtenerLista();
