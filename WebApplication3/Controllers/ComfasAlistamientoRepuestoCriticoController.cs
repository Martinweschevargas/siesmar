...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasAlistamientoRepuestoCriticoController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        AlistamientoRepuestoCriticoComfas alistamientoRepuestoCriticoComfasBL = new();

        UnidadNaval unidadNavalBL = new();
        SistemaRepuestoCritico sistemaRespuestoCriticoBL = new();
        SubsistemaRepuestoCritico subsistemaRepuestoCriticoBL = new();


        public ComfasAlistamientoRepuestoCriticoController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult cargaCombs()
        {
            ...
            List<SistemaRepuestoCriticoDTO> sistemaRepuestoCriticoDTO = sistemaRespuestoCriticoBL.ObtenerSistemaRepuestoCriticos();
            ...
            return Json(new { data1 = unidadNavalDTO, data2 = sistemaRepuestoCriticoDTO, data3 = subsistemaRepuestoCriticoDTO });
        }

        public IActionResult CargaTabla()
        {
            List<AlistamientoRepuestoCriticoComfasDTO> select = alistamientoRepuestoCriticoComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar( int UnidadNavalId, int SistemaRespuestoCriticoId, int SubsistemaRepuestoCriticoId, int EquipoRepuestoCritico, 
            int Repuesto, int RepuestoExistente, int RepuestoNecesario, int CoeficientePonderacion)
        {
            AlistamientoRepuestoCriticoComfasDTO alistamientoRepuestoCriticoComfasDTO = new();
            alistamientoRepuestoCriticoComfasDTO.UnidadNavalId = UnidadNavalId;
            alistamientoRepuestoCriticoComfasDTO.SistemaRespuestoCriticoId = SistemaRespuestoCriticoId;
            alistamientoRepuestoCriticoComfasDTO.SubsistemaRepuestoCriticoId = SubsistemaRepuestoCriticoId;
            alistamientoRepuestoCriticoComfasDTO.EquipoRepuestoCritico = EquipoRepuestoCritico;
            alistamientoRepuestoCriticoComfasDTO.Repuesto = Repuesto;
            alistamientoRepuestoCriticoComfasDTO.RepuestoExistente = RepuestoExistente;
            alistamientoRepuestoCriticoComfasDTO.RepuestoNecesario = RepuestoNecesario;
            alistamientoRepuestoCriticoComfasDTO.CoeficientePonderacion = CoeficientePonderacion;
            alistamientoRepuestoCriticoComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoRepuestoCriticoComfasBL.AgregarRegistro(alistamientoRepuestoCriticoComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoRepuestoCriticoComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, int SistemaRespuestoCriticoId, int SubsistemaRepuestoCriticoId, int EquipoRepuestoCritico,
            int Repuesto, int RepuestoExistente, int RepuestoNecesario, int CoeficientePonderacion)
        {
            AlistamientoRepuestoCriticoComfasDTO alistamientoRepuestoCriticoComfasDTO = new();
            alistamientoRepuestoCriticoComfasDTO.AlistamientoRepuestoCriticoId = Id;
            alistamientoRepuestoCriticoComfasDTO.UnidadNavalId = UnidadNavalId;
            alistamientoRepuestoCriticoComfasDTO.SistemaRespuestoCriticoId = SistemaRespuestoCriticoId;
            alistamientoRepuestoCriticoComfasDTO.SubsistemaRepuestoCriticoId = SubsistemaRepuestoCriticoId;
            alistamientoRepuestoCriticoComfasDTO.EquipoRepuestoCritico = EquipoRepuestoCritico;
            ...
            var IND_OPERACION = alistamientoRepuestoCriticoComfasBL.ActualizarFormato(alistamientoRepuestoCriticoComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoRepuestoCriticoComfasBL.EliminarFormato(alistamientoRepuestoCriticoComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoRepuestoCriticoComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoRepuestoCriticoComfasBL.ObtenerLista();
