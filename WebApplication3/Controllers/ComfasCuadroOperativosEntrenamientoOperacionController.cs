...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfasCuadroOperativosEntrenamientoOperacionController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        CuadroOperativosEntrenamientoOperacionComfas cuadroOperativosEntrenamientoOperacionComfasBL = new();


        public ComfasCuadroOperativosEntrenamientoOperacionController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Cuadro de Operativos y Entrenamiento Operacionales en la Mar", FromController = typeof(HomeController))]
        ...
        {
            List<CuadroOperativosEntrenamientoOperacionComfasDTO> select = cuadroOperativosEntrenamientoOperacionComfasBL.ObtenerLista();
        ...
        public ActionResult Insertar( string Fecha, string HoraInicio, string HoraTermino, string Evento, string OCEConductorControl,
            string UnidadAeronaveParticipante, string Area)
        {
            CuadroOperativosEntrenamientoOperacionComfasDTO cuadroOperativosEntrenamientoOperacionComfasDTO = new();
            cuadroOperativosEntrenamientoOperacionComfasDTO.Fecha = Fecha;
            cuadroOperativosEntrenamientoOperacionComfasDTO.HoraInicio = HoraInicio;
            cuadroOperativosEntrenamientoOperacionComfasDTO.HoraTermino = HoraTermino;
            cuadroOperativosEntrenamientoOperacionComfasDTO.Evento = Evento;
            cuadroOperativosEntrenamientoOperacionComfasDTO.OCEConductorControl = OCEConductorControl;
            cuadroOperativosEntrenamientoOperacionComfasDTO.UnidadAeronaveParticipante = UnidadAeronaveParticipante;
            cuadroOperativosEntrenamientoOperacionComfasDTO.Area = Area;
            cuadroOperativosEntrenamientoOperacionComfasDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = cuadroOperativosEntrenamientoOperacionComfasBL.AgregarRegistro(cuadroOperativosEntrenamientoOperacionComfasDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(cuadroOperativosEntrenamientoOperacionComfasBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, string Fecha, string HoraInicio, string HoraTermino, string Evento, string OCEConductorControl, 
            string UnidadAeronaveParticipante, string Area)
        {
            CuadroOperativosEntrenamientoOperacionComfasDTO cuadroOperativosEntrenamientoOperacionComfasDTO = new();
            cuadroOperativosEntrenamientoOperacionComfasDTO.CuadroOperativoEntrenamientoOperacionId = Id;
            cuadroOperativosEntrenamientoOperacionComfasDTO.Fecha = Fecha;
            cuadroOperativosEntrenamientoOperacionComfasDTO.HoraInicio = HoraInicio;
            cuadroOperativosEntrenamientoOperacionComfasDTO.HoraTermino = HoraTermino;
            cuadroOperativosEntrenamientoOperacionComfasDTO.Evento = Evento;
            ...
            var IND_OPERACION = cuadroOperativosEntrenamientoOperacionComfasBL.ActualizarFormato(cuadroOperativosEntrenamientoOperacionComfasDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (cuadroOperativosEntrenamientoOperacionComfasBL.EliminarFormato(cuadroOperativosEntrenamientoOperacionComfasDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = cuadroOperativosEntrenamientoOperacionComfasBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = cuadroOperativosEntrenamientoOperacionComfasBL.ObtenerLista();
