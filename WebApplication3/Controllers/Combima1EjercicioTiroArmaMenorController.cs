...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class Combima1EjercicioTiroArmaMenorController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        EjercicioTiroArmaMenorCombima1 ejercicioTiroArmaMenorCombima1BL = new();
        ...
        public Combima1EjercicioTiroArmaMenorController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<EjercicioTiroArmaMenorCombima1DTO> select = ejercicioTiroArmaMenorCombima1BL.ObtenerLista();
        ...
        public ActionResult Insertar(int TipoPersonalMilitarId, int GradoPersonalMilitarId, string FechaEjercicio, int TipoArmamentoId,
            int PosicionTipoArmaId, decimal DistanciaMetros, int CantidadTiro)
        {
            EjercicioTiroArmaMenorCombima1DTO ejercicioTiroArmaMenorCombima1= new();
            ejercicioTiroArmaMenorCombima1.TipoPersonalMilitarId = TipoPersonalMilitarId;
            ejercicioTiroArmaMenorCombima1.GradoPersonalMilitarId = GradoPersonalMilitarId;
            ejercicioTiroArmaMenorCombima1.FechaEjercicio = FechaEjercicio;
            ejercicioTiroArmaMenorCombima1.TipoArmamentoId = TipoArmamentoId;
            ejercicioTiroArmaMenorCombima1.PosicionTipoArmaId = PosicionTipoArmaId;
            ejercicioTiroArmaMenorCombima1.DistanciaMetros = DistanciaMetros;
            ejercicioTiroArmaMenorCombima1.CantidadTiro = CantidadTiro;
            ejercicioTiroArmaMenorCombima1.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = ejercicioTiroArmaMenorCombima1BL.AgregarRegistro(ejercicioTiroArmaMenorCombima1);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(ejercicioTiroArmaMenorCombima1BL.BuscarFormato(Id));
        }
        ...
        {
            EjercicioTiroArmaMenorCombima1DTO ejercicioTiroArmaMenorCombima1= new();
            ejercicioTiroArmaMenorCombima1.EjercicioTiroArmaMenorId = Id;
            ejercicioTiroArmaMenorCombima1.TipoPersonalMilitarId = TipoPersonalMilitarId;
            ejercicioTiroArmaMenorCombima1.GradoPersonalMilitarId = GradoPersonalMilitarId;
            ejercicioTiroArmaMenorCombima1.FechaEjercicio = FechaEjercicio;
            ejercicioTiroArmaMenorCombima1.TipoArmamentoId = TipoArmamentoId;
            ...
            var IND_OPERACION = ejercicioTiroArmaMenorCombima1BL.ActualizarFormato(ejercicioTiroArmaMenorCombima1);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (ejercicioTiroArmaMenorCombima1BL.EliminarFormato(ejercicioTiroArmaMenorCombima1) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = ejercicioTiroArmaMenorCombima1BL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = ejercicioTiroArmaMenorCombima1BL.ObtenerLista();
