...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComesclaAlistamientoMaterialController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        AlistamientoMaterialComescla alistamientoMaterialComesclaBL = new();

        CapacidadOperativa capacidadOperativaBL = new();
        AlistamientoMaterialRequerido3N alistamientoMaterialRequerido3NBL = new();

        public ComesclaAlistamientoMaterialController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = capacidadOperativaDTO, data2 = alistamientoMaterialRequerido3NDTO });
        }

        public IActionResult CargaTabla()
        {
            List<AlistamientoMaterialComesclaDTO> select = alistamientoMaterialComesclaBL.ObtenerLista();
        ...
        public ActionResult Insertar(int CapacidadOperativaId, int AlistamientoMaterialRequerido3NId, int Requerido, int Operativo, 
            string PorcentajeOperatividad)
        {
            AlistamientoMaterialComesclaDTO alistamientoMaterialComesclaDTO = new();
            alistamientoMaterialComesclaDTO.CapacidadOperativaId = CapacidadOperativaId;
            alistamientoMaterialComesclaDTO.AlistamientoMaterialRequerido3NId = AlistamientoMaterialRequerido3NId;
            alistamientoMaterialComesclaDTO.Requerido = Requerido;
            alistamientoMaterialComesclaDTO.Operativo = Operativo;
            alistamientoMaterialComesclaDTO.PorcentajeOperatividad = PorcentajeOperatividad;
            alistamientoMaterialComesclaDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoMaterialComesclaBL.AgregarRegistro(alistamientoMaterialComesclaDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoMaterialComesclaBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int CapacidadOperativaId, int AlistamientoMaterialRequerido3NId, int Requerido, int Operativo,
            string PorcentajeOperatividad )
        {
            AlistamientoMaterialComesclaDTO alistamientoMaterialComesclaDTO = new();
            alistamientoMaterialComesclaDTO.AlistamientoMaterialId = Id;
            alistamientoMaterialComesclaDTO.CapacidadOperativaId = CapacidadOperativaId;
            alistamientoMaterialComesclaDTO.AlistamientoMaterialRequerido3NId = AlistamientoMaterialRequerido3NId;
            alistamientoMaterialComesclaDTO.Requerido = Requerido;
            alistamientoMaterialComesclaDTO.Operativo = Operativo;
            ...
            var IND_OPERACION = alistamientoMaterialComesclaBL.ActualizarFormato(alistamientoMaterialComesclaDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoMaterialComesclaBL.EliminarFormato(alistamientoMaterialComesclaDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoMaterialComesclaBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoMaterialComesclaBL.ObtenerLista();
