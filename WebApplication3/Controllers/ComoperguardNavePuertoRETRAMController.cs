...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComoperguardNavePuertoRETRAMController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        NavePuertoRETRAM navePuertoRETRAMBL = new();
        ...
        public ComoperguardNavePuertoRETRAMController(IWebHostEnvironment webHostEnvironment)
        {
            this._webHostEnviroment = webHostEnvironment;
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        }

        [Breadcrumb(FromAction = "Index", Title = "Naves en Puerto – RETRAM", FromController = typeof(HomeController))]
        ...
        public IActionResult cargaCombs()
        {
            ...
            return Json(new { data1 = jefaturaDistritoCapitaniaDTO, data2 = capitaniaDTO, data3 = paisUbigeoDTO, data4 = tipoNaveDTO,
                data5 = puertoPeruDTO});
        }

        public IActionResult CargaTabla()
        {
            List<NavePuertoRETRAMDTO> select = navePuertoRETRAMBL.ObtenerLista();
        ...
        public ActionResult Insertar(int JefaturaDistritoCapitaniaId, int CapitaniaId, string IndicativoLlamada, string NombreBuque,
            int PaisUbigeoId, int TipoNaveId, string NumeroOMI, string AB, int PaisProcedencia, string FechaArribo, string HoraArribo,
            int PuertoPeruId, string TiempoPermanencia, int ProximosPuertos, int TripulantesChilenos, int TripulantesEcuatorianos,
            string Observaciones)
        {
            NavePuertoRETRAMDTO navePuertoRETRAMDTO = new();
            navePuertoRETRAMDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            navePuertoRETRAMDTO.CapitaniaId = CapitaniaId;
            navePuertoRETRAMDTO.IndicativoLlamada = IndicativoLlamada;
            navePuertoRETRAMDTO.NombreBuque = NombreBuque;
            navePuertoRETRAMDTO.PaisUbigeoId = PaisUbigeoId;
            navePuertoRETRAMDTO.TipoNaveId = TipoNaveId;
            navePuertoRETRAMDTO.NumeroOMI = NumeroOMI;
            navePuertoRETRAMDTO.AB = AB;
            navePuertoRETRAMDTO.PaisProcedencia = PaisProcedencia;
            navePuertoRETRAMDTO.FechaArribo = FechaArribo;
            navePuertoRETRAMDTO.HoraArribo = HoraArribo;
            navePuertoRETRAMDTO.PuertoPeruId = PuertoPeruId;
            navePuertoRETRAMDTO.TiempoPermanencia = TiempoPermanencia;
            navePuertoRETRAMDTO.ProximosPuertos = ProximosPuertos;
            navePuertoRETRAMDTO.TripulantesChilenos = TripulantesChilenos;
            navePuertoRETRAMDTO.TripulantesEcuatorianos = TripulantesEcuatorianos;
            navePuertoRETRAMDTO.Observaciones = Observaciones;
            navePuertoRETRAMDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = navePuertoRETRAMBL.AgregarRegistro(navePuertoRETRAMDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(navePuertoRETRAMBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id,  int JefaturaDistritoCapitaniaId, int CapitaniaId, string IndicativoLlamada, string NombreBuque, 
            int PaisUbigeoId, int TipoNaveId, string NumeroOMI, string AB, int PaisProcedencia, string FechaArribo, string HoraArribo,
            int PuertoPeruId, string TiempoPermanencia, int ProximosPuertos, int TripulantesChilenos, int TripulantesEcuatorianos,
            string Observaciones)
        {
            NavePuertoRETRAMDTO navePuertoRETRAMDTO = new();
            navePuertoRETRAMDTO.NavePuertoRETRAMId = Id;
            navePuertoRETRAMDTO.JefaturaDistritoCapitaniaId = JefaturaDistritoCapitaniaId;
            navePuertoRETRAMDTO.CapitaniaId = CapitaniaId;
            navePuertoRETRAMDTO.IndicativoLlamada = IndicativoLlamada;
            navePuertoRETRAMDTO.NombreBuque = NombreBuque;
            ...
            var IND_OPERACION = navePuertoRETRAMBL.ActualizarFormato(navePuertoRETRAMDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (navePuertoRETRAMBL.EliminarFormato(navePuertoRETRAMDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = navePuertoRETRAMBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = navePuertoRETRAMBL.ObtenerLista();
