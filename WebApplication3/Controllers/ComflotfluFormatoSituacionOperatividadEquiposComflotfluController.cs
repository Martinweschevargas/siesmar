...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComflotfluFormatoSituacionOperatividadEquiposComflotfluController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        Usuario usuarioBL = new();

        FormatoSituacionOperatividadEquiposComflotflu formatoSituacionOperatividadEquiposComflotfluBL = new();
        ...
        public ComflotfluFormatoSituacionOperatividadEquiposComflotfluController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<FormatoSituacionOperatividadEquiposComflotfluDTO> select = formatoSituacionOperatividadEquiposComflotfluBL.ObtenerLista();
        ...
        public ActionResult Insertar(int DescripcionMaterialId, int Cantidad, int UnidadNavalId, string Ubicacion, int DepartamentoUbigeoId, int ProvinciaUbigeoId, int DistritoUbigeoId, int CondicionId, string Observaciones)
        {
            FormatoSituacionOperatividadEquiposComflotfluDTO formatoSituacionOperatividadEquiposComflotfluDTO = new();
            formatoSituacionOperatividadEquiposComflotfluDTO.DescripcionMaterialId = DescripcionMaterialId;
            formatoSituacionOperatividadEquiposComflotfluDTO.Cantidad = Cantidad;
            formatoSituacionOperatividadEquiposComflotfluDTO.UnidadNavalId = UnidadNavalId;
            formatoSituacionOperatividadEquiposComflotfluDTO.Ubicacion = Ubicacion;
            formatoSituacionOperatividadEquiposComflotfluDTO.DepartamentoUbigeoId = DepartamentoUbigeoId;
            formatoSituacionOperatividadEquiposComflotfluDTO.ProvinciaUbigeoId = ProvinciaUbigeoId;
            formatoSituacionOperatividadEquiposComflotfluDTO.DistritoUbigeoId = DistritoUbigeoId;
            formatoSituacionOperatividadEquiposComflotfluDTO.CondicionId = CondicionId;
            formatoSituacionOperatividadEquiposComflotfluDTO.Observaciones = Observaciones;
            
            formatoSituacionOperatividadEquiposComflotfluDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = formatoSituacionOperatividadEquiposComflotfluBL.AgregarRegistro(formatoSituacionOperatividadEquiposComflotfluDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(formatoSituacionOperatividadEquiposComflotfluBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int DescripcionMaterialId, int Cantidad, int UnidadNavalId, string Ubicacion, int DepartamentoUbigeoId, int ProvinciaUbigeoId, int DistritoUbigeoId, int CondicionId, string Observaciones)
        {
            FormatoSituacionOperatividadEquiposComflotfluDTO formatoSituacionOperatividadEquiposComflotfluDTO = new();
            formatoSituacionOperatividadEquiposComflotfluDTO.FormatoSituacionOperatividadEquipoId = Id;
            formatoSituacionOperatividadEquiposComflotfluDTO.DescripcionMaterialId = DescripcionMaterialId;
            formatoSituacionOperatividadEquiposComflotfluDTO.Cantidad = Cantidad;
            formatoSituacionOperatividadEquiposComflotfluDTO.UnidadNavalId = UnidadNavalId;
            formatoSituacionOperatividadEquiposComflotfluDTO.Ubicacion = Ubicacion;
            ...
            var IND_OPERACION = formatoSituacionOperatividadEquiposComflotfluBL.ActualizarFormato(formatoSituacionOperatividadEquiposComflotfluDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (formatoSituacionOperatividadEquiposComflotfluBL.EliminarFormato(formatoSituacionOperatividadEquiposComflotfluDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult MostrarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            List<FormatoSituacionOperatividadEquiposComflotfluDTO> lista = new List<FormatoSituacionOperatividadEquiposComflotfluDTO>();

            for (int i = 1; i <= cantidadFilas; i++)
            {
                IRow fila = HojaExcel.GetRow(i);

                lista.Add(new FormatoSituacionOperatividadEquiposComflotfluDTO
                {
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = formatoSituacionOperatividadEquiposComflotfluBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = formatoSituacionOperatividadEquiposComflotfluBL.ObtenerLista();
