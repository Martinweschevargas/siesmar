...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class JesehinAlistamientoMaterialJesehinController : Controller
    {
        private readonly IWebHostEnvironment _webHostEnviroment;
        AlistamientoMaterialJesehin alistamientoMaterialJesehinBL = new();
        UnidadNaval unidadNavalBL = new();
        CapacidadOperativa capacidadOperativaBL = new();
        AlistamientoMaterialRequerido3N alistamientoMaterialRequerido3NBL = new();

        public JesehinAlistamientoMaterialJesehinController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            List<AlistamientoMaterialJesehinDTO> select = alistamientoMaterialJesehinBL.ObtenerLista();
        ...
        public ActionResult Insertar(int UnidadNavalId, int CapacidadOperativaId, int AlistamientoMaterialRequerido3NId, int Requerido, int Operativo, decimal PorcentajeOperativo, decimal PonderadoFuncional, decimal NivelAlistamientoParcial)
        {
            AlistamientoMaterialJesehinDTO alistamientoMaterialJesehinDTO = new();
            alistamientoMaterialJesehinDTO.UnidadNavalId = UnidadNavalId;
            alistamientoMaterialJesehinDTO.CapacidadOperativaId = CapacidadOperativaId;
            alistamientoMaterialJesehinDTO.AlistamientoMaterialRequerido3NId = AlistamientoMaterialRequerido3NId;
            alistamientoMaterialJesehinDTO.Requerido = Requerido;
            alistamientoMaterialJesehinDTO.Operativo = Operativo;
            alistamientoMaterialJesehinDTO.PorcentajeOperatividad = PorcentajeOperativo;
            alistamientoMaterialJesehinDTO.PonderadoFuncional = PonderadoFuncional;
            alistamientoMaterialJesehinDTO.NivelAlistamientoParcial = NivelAlistamientoParcial;

            alistamientoMaterialJesehinDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoMaterialJesehinBL.AgregarRegistro(alistamientoMaterialJesehinDTO);
            return Content(IND_OPERACION);
        }

        public ActionResult Mostrar(int Id)
        {
            return Json(alistamientoMaterialJesehinBL.BuscarFormato(Id));
        }

        public ActionResult Actualizar(int Id, int UnidadNavalId, int CapacidadOperativaId, int AlistamientoMaterialRequerido3NId, int Requerido, int Operativo, decimal PorcentajeOperativo, decimal PonderadoFuncional, decimal NivelAlistamientoParcial)
        {
            AlistamientoMaterialJesehinDTO alistamientoMaterialJesehinDTO = new();
            alistamientoMaterialJesehinDTO.AlistamientoMaterialId = Id;
            alistamientoMaterialJesehinDTO.UnidadNavalId = UnidadNavalId;
            alistamientoMaterialJesehinDTO.CapacidadOperativaId = CapacidadOperativaId;
            alistamientoMaterialJesehinDTO.AlistamientoMaterialRequerido3NId = AlistamientoMaterialRequerido3NId;
            alistamientoMaterialJesehinDTO.Requerido = Requerido;
            ...
            var IND_OPERACION = alistamientoMaterialJesehinBL.ActualizarFormato(alistamientoMaterialJesehinDTO);
        ...
        public ActionResult Eliminar(int Id)
        {
            ...
            if (alistamientoMaterialJesehinBL.EliminarFormato(alistamientoMaterialJesehinDTO) == true)
                mensaje = "1";
            else
                mensaje = "0";
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoMaterialJesehinBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoMaterialJesehinBL.ObtenerLista();
