...
namespace Marina.Siesmar.Presentacion.Controllers
{
    ...
    public class ComfuavinavAlistamientoRepuestoCriticoController : Controller
    {
        ...
        public ActionResult Insertar(int UnidadNavalId, int AlistamientoRepuestoCriticoId)
        {
            AlistamientoRepuestoCriticoComfuavinavDTO alistamientoRepuestoCriticoComfuavinavDTO = new();
            alistamientoRepuestoCriticoComfuavinavDTO.UnidadNavalId = UnidadNavalId;
            alistamientoRepuestoCriticoComfuavinavDTO.AlistamientoRepuestoCriticoId = AlistamientoRepuestoCriticoId;

            alistamientoRepuestoCriticoComfuavinavDTO.UsuarioIngresoRegistro = User.obtenerUsuario();

            var IND_OPERACION = alistamientoRepuestoCriticoComfuavinavBL.AgregarRegistro(alistamientoRepuestoCriticoComfuavinavDTO);
        ...
        public ActionResult Actualizar(int Id, int UnidadNavalId, int AlistamientoRepuestoCriticoId)
        {
            AlistamientoRepuestoCriticoComfuavinavDTO alistamientoRepuestoCriticoComfuavinavDTO = new();
        ...
        public IActionResult EnviarDatos([FromForm] IFormFile ArchivoExcel)
        {
            ...
            try
            {
                var estado = alistamientoRepuestoCriticoComfuavinavBL.InsercionMasiva(lista);
                if (estado == true)
                {
                    mensaje = "ok";
                }
        ...
        public IActionResult ReporteEIHN()
        {
            ...
            var estudioInvestigacionesHistoricasNavales = alistamientoRepuestoCriticoComfuavinavBL.ObtenerLista();
