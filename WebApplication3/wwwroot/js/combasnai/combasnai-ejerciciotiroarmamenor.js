var tblCombasnaiEjercicioTiroArmaMenor;
...
$(document).ready(function () {
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/CombasnaiEjercicioTiroArmaMenor/Insertar',
                                data: {
                                ...
                                success: function (mensaje) {
                                    ...
                                    $('#listar').show();
                                    $('#nuevo').hide();
                                    $('#tblCombasnaiEjercicioTiroArmaMenor').DataTable().ajax.reload();
                                },
                                complete: function () {
                                    $('#loader-6').hide();
                                }
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/CombasnaiEjercicioTiroArmaMenor/Actualizar',
                                data: {
                                    'Id': $('#txtCodigo').val(),
    ...
    $('#tblCombasnaiEjercicioTiroArmaMenor').DataTable({
        ajax: {
            "url": '/CombasnaiEjercicioTiroArmaMenor/CargaTabla',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
        ...
        buttons: [
            //csv,
            {
                extend: 'csvHtml5',
                text: 'Exportar CSV',
                filename: 'Combasnai - Ejercicios de Tiro con Armas Menores',
                title: '',
                exportOptions: {
            ...
            //'excel',
            {
                ...
                text: 'Exportar Excel',
                filename: 'Combasnai - Ejercicios de Tiro con Armas Menores',
                title: 'Combasnai - Ejercicios de Tiro con Armas Menores',
                exportOptions: {
                    columns: [0, 1, 2, 3, 4, 5, 6, 7, 8]
                },
...
function edit(Id) {
    $('#listar').hide();
    $('#editar').show();
    $.getJSON('/CombasnaiEjercicioTiroArmaMenor/Mostrar?Id=' + Id, [], function (EjercicioTiroArmaMenorCombasnaiDTO) {
        $('#txtCodigo').val(EjercicioTiroArmaMenorCombasnaiDTO.ejercicioTiroArmaMenorId);
        $('#cbTipoPersonalMilitare').val(EjercicioTiroArmaMenorCombasnaiDTO.tipoPersonalMilitarId);
        $('#cbGradoPersonalMilitare').val(EjercicioTiroArmaMenorCombasnaiDTO.gradoPersonalMilitarId);
        $('#txtFechaEjercicioe').val(EjercicioTiroArmaMenorCombasnaiDTO.fechaEjercicio);
        $('#cbTipoArmamentoe').val(EjercicioTiroArmaMenorCombasnaiDTO.tipoArmamentoId);
        $('#cbPosicionTipoArmae').val(EjercicioTiroArmaMenorCombasnaiDTO.posicionTipoArmaId);
        $('#txtDistanciaMetrose').val(EjercicioTiroArmaMenorCombasnaiDTO.distanciaMetros);
        $('#txtCantidadTiroe').val(EjercicioTiroArmaMenorCombasnaiDTO.cantidadTiro);
        $('#txtPorcentajeEvaluacione').val(EjercicioTiroArmaMenorCombasnaiDTO.porcentajeEvaluacion); 
    });
}
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/CombasnaiEjercicioTiroArmaMenor/Eliminar',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function nuevaCombasnaiEjercicioTiroArmaMenor() {
    $('#listar').hide();
    $('#nuevo').show();
}
...
function cargaDatos() {
    $.getJSON('/CombasnaiEjercicioTiroArmaMenor/cargaCombs', [], function (Json) {
