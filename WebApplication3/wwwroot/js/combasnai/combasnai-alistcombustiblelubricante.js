var tblCombasnaiAlistCombustibleLubricante;
...
$(document).ready(function () {
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/CombasnaiAlistCombustibleLubricante/Insertar',
                                data: {
                                ...
                                success: function (mensaje) {
                                    ...
                                    $('#listar').show();
                                    $('#nuevo').hide();
                                    $('#tblCombasnaiAlistCombustibleLubricante').DataTable().ajax.reload();
                                },
                                complete: function () {
                                    $('#loader-6').hide();
                                }
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/CombasnaiAlistCombustibleLubricante/Actualizar',
                                data: {
                                    'Id': $('#txtCodigo').val(),
    ...
    $('#tblCombasnaiAlistCombustibleLubricante').DataTable({
        ajax: {
            "url": '/CombasnaiAlistCombustibleLubricante/CargaTabla',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...
function edit(Id) {
    $('#listar').hide();
    $('#editar').show();
    $.getJSON('/CombasnaiAlistCombustibleLubricante/Mostrar?Id=' + Id, [], function (AlistCombustibleLubricanteCombasnaiDTO) {
        $('#txtCodigo').val(AlistCombustibleLubricanteCombasnaiDTO.alistamientoCombustibleLubricanteId);
        $('#cbUnidadNavale').val(AlistCombustibleLubricanteCombasnaiDTO.unidadNavalId);
        $('#cbAlistamientoCombustibleLubricante2e').val(AlistCombustibleLubricanteCombasnaiDTO.alistamientoCombustibleLubricante2Id);
        $('#txtArticuloe').val(AlistCombustibleLubricanteCombasnaiDTO.articulo);
        $('#txtEquipoe').val(AlistCombustibleLubricanteCombasnaiDTO.equipo);
        $('#txtUnidadMedidae').val(AlistCombustibleLubricanteCombasnaiDTO.unidadMedida);
        $('#txtCargoe').val(AlistCombustibleLubricanteCombasnaiDTO.cargo);
        $('#txtAumentoe').val(AlistCombustibleLubricanteCombasnaiDTO.aumento);
        $('#txtConsuoe').val(AlistCombustibleLubricanteCombasnaiDTO.consuo);
        $('#txtExistenciae').val(AlistCombustibleLubricanteCombasnaiDTO.existencia); 
    });
}
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/CombasnaiAlistCombustibleLubricante/Eliminar',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function nuevaCombasnaiAlistCombustibleLubricante() {
    $('#listar').hide();
    $('#nuevo').show();
}
...
function cargaDatos() {
    $.getJSON('/CombasnaiAlistCombustibleLubricante/cargaCombs', [], function (Json) {
