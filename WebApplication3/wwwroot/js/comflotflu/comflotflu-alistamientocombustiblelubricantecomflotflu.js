var tblComflotfluAlistamientoCombustibleLubricanteComflotflu;
...
$(document).ready(function () {
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/ComflotfluAlistamientoCombustibleLubricanteComflotflu/Insertar',
                                data: {
                                ...
                                success: function (mensaje) {
                                    ...
                                    $('#listar').show();
                                    $('#nuevo').hide();
                                    $('#tblComflotfluAlistamientoCombustibleLubricanteComflotflu').DataTable().ajax.reload();
                                },
                                complete: function () {
                                    $('#loader-6').hide();
                                }
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/ComflotfluAlistamientoCombustibleLubricanteComflotflu/Actualizar',
                                data: {
                                    'Id': $('#txtCodigo').val(),
    ...
    $('#tblComflotfluAlistamientoCombustibleLubricanteComflotflu').DataTable({
        ajax: {
            "url": '/ComflotfluAlistamientoCombustibleLubricanteComflotflu/CargaTabla',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
        ...
        buttons: [
            //csv,
            {
                extend: 'csvHtml5',
                text: 'Exportar CSV',
                filename: 'Comflotflu - Alistamiento de combustibles y lubricantes (ACL)',
                title: '',
                exportOptions: {
                    columns: [0, 1, 2]
                },
            ...
            //'excel',
            {
                ...
                text: 'Exportar Excel',
                filename: 'Comflotflu - Alistamiento de combustibles y lubricantes (ACL)',
                title: 'Comflotflu - Alistamiento de combustibles y lubricantes (ACL)',
                exportOptions: {
                    columns: [0, 1, 2]
                },
...
function edit(Id) {
    $('#listar').hide();
    $('#editar').show();
    $.getJSON('/ComflotfluAlistamientoCombustibleLubricanteComflotflu/Mostrar?Id=' + Id, [], function (AlistamientoCombustibleLubricanteComflotfluDTO) {
        $('#txtCodigo').val(AlistamientoCombustibleLubricanteComflotfluDTO.alistamientoCombustibleLubricanteId);
        $('#cbUnidadNavale').val(AlistamientoCombustibleLubricanteComflotfluDTO.unidadNavalId);
        $('#cbAlistamientoCombustibleLubricante2e').val(AlistamientoCombustibleLubricanteComflotfluDTO.alistamientoCombustibleLubricante2Id);
        $('#txtArticuloAlistamientoe').val(AlistamientoCombustibleLubricanteComflotfluDTO.articulo);
        $('#txtEquipoAlistamientoe').val(AlistamientoCombustibleLubricanteComflotfluDTO.equipo);
        $('#txtUnidadMedidaAlistamientoe').val(AlistamientoCombustibleLubricanteComflotfluDTO.unidadMedida);
        $('#txtCargoAlistamientoe').val(AlistamientoCombustibleLubricanteComflotfluDTO.cargo);
        $('#txtAumentoAlistamientoe').val(AlistamientoCombustibleLubricanteComflotfluDTO.aumento);
        $('#txtConsumoAlistamientoe').val(AlistamientoCombustibleLubricanteComflotfluDTO.consumo);
        $('#txtExistenciaAlistamientoe').val(AlistamientoCombustibleLubricanteComflotfluDTO.existencia);
    });
}
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/ComflotfluAlistamientoCombustibleLubricanteComflotflu/Eliminar',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function nuevaComflotfluAlistamientoCombustibleLubricanteComflotflu() {
    $('#listar').hide();
    $('#nuevo').show();
}
...
function cargaDatos() {
    $.getJSON('/ComflotfluAlistamientoCombustibleLubricanteComflotflu/cargaCombs', [], function (Json) {
