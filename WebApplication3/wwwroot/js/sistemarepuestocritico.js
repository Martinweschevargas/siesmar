var tblSistemaRepuestoCriticos;
        ...
        "columns": [
            ...
            { "data": "descSistemaRepuestoCritico" },
            {
                "render": function (data, type, row) {
                    return '<a class="txt" onclick=edit(' + row.sistemaRepuestoCriticoId + ') title="Actualizar"><i class="fa fa-check-square-o" aria-hidden="true" style="color:black; padding-right:5px"></i>Editar</a>';
                }
            },
            {
                "render": function (data, type, row) {
                    return '<a class="txt btnconfirmation" onclick=eliminar(' + row.sistemaRepuestoCriticoId + ') title="Eliminar"><i class="fa fa-minus-square-o red" aria-hidden="true" style="color:red; padding-right:5px"></i>Eliminar</a>';
                }
            }
        ],
        language: {
...
function edit(SistemaRepuestoCriticoId) {
    $('#listar').hide();
    $('#editar').show();
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/SistemaRepuestoCritico/EliminarSistemaRepuestoCritico',
                data: {
                    'SistemaRepuestoCriticoId': id
                },
                beforeSend: function () {
                    $('#loader-6').show();
                },
...
function nuevaSistemaRepuestoCritico() {
    $('#listar').hide();
    $('#nuevo').show();
}
