var tblComfuinmarAlistamientoMaterial;
...
$(document).ready(function () {
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/ComfuinmarAlistamientoMaterialComfuinmar/Insertar',
                                data: {
                                ...
                                success: function (mensaje) {
                                    ...
                                    $('#listar').show();
                                    $('#nuevo').hide();
                                    $('#tblComfuinmarAlistamientoMaterial').DataTable().ajax.reload();
                                },
                                complete: function () {
                                    $('#loader-6').hide();
                                }
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/ComfuinmarAlistamientoMaterialComfuinmar/Actualizar',
                                data: {
                                    'Id': $('#txtCodigo').val(),
    ...
    tblComfuinmarAlistamientoMaterial = $('#tblComfuinmarAlistamientoMaterial').DataTable({
        ajax: {
            "url": '/ComfuinmarAlistamientoMaterialComfuinmar/CargaTabla',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
        ...
        buttons: [
            //csv,
            {
                extend: 'csvHtml5',
                text: 'Exportar CSV',
                filename: 'Comfuinmar-3 - Alistamiento de material',
                title: '',
                exportOptions: {
            ...
            //'excel',
            {
                ...
                text: 'Exportar Excel',
                filename: 'Comfuinmar-3 - Alistamiento de material',
                title: 'Comfuinmar-3 - Alistamiento de material',
                exportOptions: {
                    columns: [0, 1, 2, 3, 4, 5, 6]
                },
...
function cargaBusqueda() {
    ...
    tblComfuinmarAlistamientoMaterial.columns(7).search(CodigoCarga).draw();
}

function mostrarTodos() {
    tblComfuinmarAlistamientoMaterial.columns(7).search('').draw();
}

function edit(Id) {
    $('#listar').hide();
    $('#editar').show();
    $.getJSON('/ComfuinmarAlistamientoMaterialComfuinmar/Mostrar?Id=' + Id, [], function (AlistamientoMaterialComfuinmarDTO) {
        $('#txtCodigo').val(AlistamientoMaterialComfuinmarDTO.alistamientoMaterialId);
        $('#cbUnidadNavale').val(AlistamientoMaterialComfuinmarDTO.codigoUnidadNaval);
        $('#cbCapacidadOperativae').val(AlistamientoMaterialComfuinmarDTO.codigoCapacidadOperativa);
        $('#txtAlistamientoMaterialRequerido3Ne').val(AlistamientoMaterialComfuinmarDTO.codigoAlistamientoMaterialRequerido3N);
        $('#txtRequeridoe').val(AlistamientoMaterialComfuinmarDTO.requerido);
        $('#txtOperativoe').val(AlistamientoMaterialComfuinmarDTO.operativo);
        $('#txtPorcentajeOperativoe').val(AlistamientoMaterialComfuinmarDTO.porcentajeOperativo);
    });
}
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/ComfuinmarAlistamientoMaterialComfuinmar/Eliminar',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function eliminarCarga() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/ComfuinmarAlistamientoMaterialComfuinmar/EliminarCarga',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function nuevaComfuinmarAlistamientoMaterialComfuinmar() {
    $('#listar').hide();
    $('#nuevo').show();
}
...
function mostrarDatos() {
    ...
    $.ajax({
        type: "POST",
        url: 'ComfuinmarAlistamientoMaterialComfuinmar/MostrarDatos',
        data: formData,
        processData: false,
        contentType: false,
        beforeSend: function () {
...
function enviarDatos() {
    ...
    fetch("ComfuinmarAlistamientoMaterialComfuinmar/EnviarDatos", {
        method: "POST",
        body: formData
    })
...
function cargaDatos() {
    $.getJSON('/ComfuinmarAlistamientoMaterialComfuinmar/cargaCombs', [], function (Json) {
        ...
        $.each(alistamientoMaterialRequerido3N, function () {
            var RowContent = '<option value=' + this.codigoAlistamientoMaterialRequerido3N + '>' + this.subclasificacion + '</option>'
...
function optReporte(id) {
    ...
    reporteSeleccionado = '/ComfuinmarAlistamientoMaterialComfuinmar/ReporteARTR';
}
