var tblComfuinmarEvaluacionAlistamientoPersonal;
...
$(document).ready(function () {
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/ComfuinmarEvaluacionAlistamientoPersonalComfuinmar/Insertar',
                                data: {
                                    ...
                                    'CodigoEspecialidadGenericaPersonalActual': $('#cbEspecialidadGenericaPersonalActual').val(),
                                ...
                                success: function (mensaje) {
                                    ...
                                    $('#listar').show();
                                    $('#nuevo').hide();
                                    $('#tblComfuinmarEvaluacionAlistamientoPersonal').DataTable().ajax.reload();
                                },
                                complete: function () {
                                    $('#loader-6').hide();
                                }
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/ComfuinmarEvaluacionAlistamientoPersonalComfuinmar/Actualizar',
                                data: {
                                    'Id': $('#txtCodigo').val(),
                                    ...
                                    'CodigoEspecialidadGenericaPersonalActual': $('#cbEspecialidadGenericaPersonalActuale').val(),
    ...
    tblComfuinmarEvaluacionAlistamientoPersonal = $('#tblComfuinmarEvaluacionAlistamientoPersonal').DataTable({
        ajax: {
            "url": '/ComfuinmarEvaluacionAlistamientoPersonalComfuinmar/CargaTabla',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            ...
            { "data": "descEspecialidadEsperado" },
            { "data": "descGradoActual" },
            { "data": "descEspecialidadActual" },
...
function cargaBusqueda() {
    ...
    tblComfuinmarEvaluacionAlistamientoPersonal.columns(14).search(CodigoCarga).draw();
}

function mostrarTodos() {
    tblComfuinmarEvaluacionAlistamientoPersonal.columns(14).search('').draw();
}

function edit(Id) {
    $('#listar').hide();
    $('#editar').show();
    $.getJSON('/ComfuinmarEvaluacionAlistamientoPersonalComfuinmar/Mostrar?Id=' + Id, [], function (EvaluacionAlistamientoPersonalComfuinmarDTO) {
        $('#txtCodigo').val(EvaluacionAlistamientoPersonalComfuinmarDTO.evaluacionAlistamientoPersonalId);
        $('#cbUnidadNavale').val(EvaluacionAlistamientoPersonalComfuinmarDTO.codigoUnidadNaval);
        $('#txtFechaEvaluacione').val(EvaluacionAlistamientoPersonalComfuinmarDTO.fechaEvaluacion);
        $('#txtDNIPersonale').val(EvaluacionAlistamientoPersonalComfuinmarDTO.dniPersonal);
        $('#txtCIPPersonale').val(EvaluacionAlistamientoPersonalComfuinmarDTO.cipPersonal);
        $('#cbCargoe').val(EvaluacionAlistamientoPersonalComfuinmarDTO.codigoCargo);
        $('#cbGradoPersonalMilitare').val(EvaluacionAlistamientoPersonalComfuinmarDTO.codigoGradoPersonalMilitarEsperado);
        $('#cbEspecialidadGenericaPersonale').val(EvaluacionAlistamientoPersonalComfuinmarDTO.codigoEspecialidadGenericaPersonalEsperado);
        $('#cbGradoPersonalMilitarActuale').val(EvaluacionAlistamientoPersonalComfuinmarDTO.codigoGradoPersonalMilitarActual);
        $('#cbEspecialidadGenericaPersonalActuale').val(EvaluacionAlistamientoPersonalComfuinmarDTO.codigoEspecialidadGenericaPersonalActual);
        $('#txtGradoJerarquicoe').val(EvaluacionAlistamientoPersonalComfuinmarDTO.gradoJerarquico);
        $('#txtServicioExperienciae').val(EvaluacionAlistamientoPersonalComfuinmarDTO.servicioExperiencia);
        $('#txtEspecializacionProfesionale').val(EvaluacionAlistamientoPersonalComfuinmarDTO.especializacionProfesional);
        $('#txtCursoProfesionalRequeridoe').val(EvaluacionAlistamientoPersonalComfuinmarDTO.cursoProfesionalRequerido); 
    });
}
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/ComfuinmarEvaluacionAlistamientoPersonalComfuinmar/Eliminar',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function eliminarCarga() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/ComfuinmarEvaluacionAlistamientoPersonalComfuinmar/EliminarCarga',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function nuevaComfuinmarEvaluacionAlistamientoPersonalComfuinmar() {
    $('#listar').hide();
    $('#nuevo').show();
}
...
function mostrarDatos() {
    ...
    $.ajax({
        type: "POST",
        url: 'ComfuinmarEvaluacionAlistamientoPersonalComfuinmar/MostrarDatos',
        data: formData,
        processData: false,
        contentType: false,
        beforeSend: function () {
                ...
                dataJson["data1"].forEach((item) => {
                    $("#tbData tbody").append(
                        $("<tr>").append(
                            ...
                            $("<td>").text(item.descCargo),
                            $("<td>").text(item.descGradoEsperado),
                            $("<td>").text(item.descEspecialidadEsperado),
                            $("<td>").text(item.descGradoActual),
                            $("<td>").text(item.descEspecialidadActual),
...
function enviarDatos() {
    ...
    fetch("ComfuinmarEvaluacionAlistamientoPersonalComfuinmar/EnviarDatos", {
        method: "POST",
        body: formData
    })
...
function cargaDatos() {
    $.getJSON('/ComfuinmarEvaluacionAlistamientoPersonalComfuinmar/cargaCombs', [], function (Json) {
...
function optReporte(id) {
    ...
    reporteSeleccionado = '/ComfuinmarEvaluacionAlistamientoPersonalComfuinmar/ReporteARTR';
}
