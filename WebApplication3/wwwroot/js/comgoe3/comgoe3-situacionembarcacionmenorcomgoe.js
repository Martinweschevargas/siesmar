var tblComgoe3SituacionEmbarcacionMenorComgoe;
...
$(document).ready(function () {
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/Comgoe3SituacionEmbarcacionMenorComgoe/Insertar',
                                data: {
                                ...
                                success: function (mensaje) {
                                    ...
                                    $('#listar').show();
                                    $('#nuevo').hide();
                                    $('#tblComgoe3SituacionEmbarcacionMenorComgoe').DataTable().ajax.reload();
                                },
                                complete: function () {
                                    $('#loader-6').hide();
                                }
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/Comgoe3SituacionEmbarcacionMenorComgoe/Actualizar',
                                data: {
                                    'Id': $('#txtCodigo').val(),
    ...
    $('#tblComgoe3SituacionEmbarcacionMenorComgoe').DataTable({
        ajax: {
            "url": '/Comgoe3SituacionEmbarcacionMenorComgoe/CargaTabla',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...
function edit(Id) {
    $('#listar').hide();
    $('#editar').show();
    $.getJSON('/Comgoe3SituacionEmbarcacionMenorComgoe/Mostrar?Id=' + Id, [], function (SituacionEmbarcacionMenorComgoeDTO) {
        $('#txtCodigo').val(SituacionEmbarcacionMenorComgoeDTO.situacionEmbarcacionMenorId);
        $('#cbUnidadNavale').val(SituacionEmbarcacionMenorComgoeDTO.unidadNavalId);
        $('#cbTipoNavee').val(SituacionEmbarcacionMenorComgoeDTO.tipoNaveId);
        $('#txtTipoPlataformae').val(SituacionEmbarcacionMenorComgoeDTO.tipoPlataforma);
        $('#txtUnidadNavalDestinoe').val(SituacionEmbarcacionMenorComgoeDTO.unidadNavalDestino);
        $('#txtUbicacione').val(SituacionEmbarcacionMenorComgoeDTO.ubicacion);
        $('#cbDepartamentoUbigeoe').val(SituacionEmbarcacionMenorComgoeDTO.departamentoUbigeoId);
        $('#cbProvinciaUbigeoe').val(SituacionEmbarcacionMenorComgoeDTO.provinciaUbigeoId);
        $('#cbDistritoUbigeoe').val(SituacionEmbarcacionMenorComgoeDTO.distritoUbigeoId);
        $('#cbCapacidadOperativaRequeridae').val(SituacionEmbarcacionMenorComgoeDTO.capacidadOperativaRequeridaId);
        $('#txtCondicione').val(SituacionEmbarcacionMenorComgoeDTO.condicion);
        $('#txtObservacionese').val(SituacionEmbarcacionMenorComgoeDTO.observaciones); 
    });
}
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/Comgoe3SituacionEmbarcacionMenorComgoe/Eliminar',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function nuevaComgoe3SituacionEmbarcacionMenorComgoe() {
    $('#listar').hide();
    $('#nuevo').show();
}

function cargaDatos() {
    $.getJSON('/Comgoe3SituacionEmbarcacionMenorComgoe/cargaCombs', [], function (Json) {
