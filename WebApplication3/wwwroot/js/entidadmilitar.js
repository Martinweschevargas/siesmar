                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                success: function (mensaje) {
                                    ...
                                    $('#listar').show();
                                    $('#nuevo').hide();
                                    $('#tblEntidadMilitars').DataTable().ajax.reload();
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/EntidadMilitar/ActualizarEntidadMilitar',
                                data: {
        ...
        "columns": [
            ...
            { "data": "codigoEntidadMilitar" },
            {
                "render": function (data, type, row) {
                    return '<a class="txt" onclick=edit(' + row.entidadMilitarId + ') title="Actualizar"><i class="fa fa-check-square-o" aria-hidden="true" style="color:black; padding-right:5px"></i>Editar</a>';
                }
            },
            {
                "render": function (data, type, row) {
                    return '<a class="txt btnconfirmation" onclick=eliminar(' + row.entidadMilitarId + ') title="Eliminar"><i class="fa fa-minus-square-o red" aria-hidden="true" style="color:red; padding-right:5px"></i>Eliminar</a>';
                }
            }
        ],
        language: {
...
function edit(EntidadMilitarId) {
    $('#listar').hide();
    $('#editar').show();
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/EntidadMilitar/EliminarEntidadMilitar',
                data: {
                    'EntidadMilitarId': id
                },
                beforeSend: function () {
