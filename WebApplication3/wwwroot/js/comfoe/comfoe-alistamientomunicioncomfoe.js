var tblComfoeAlistamientoMunicionComfoe;
...
$(document).ready(function () {
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/ComfoeAlistamientoMunicionComfoe/Insertar',
                                data: {
                                ...
                                success: function (mensaje) {
                                    ...
                                    $('#listar').show();
                                    $('#nuevo').hide();
                                    $('#tblComfoeAlistamientoMunicionComfoe').DataTable().ajax.reload();
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/ComfoeAlistamientoMunicionComfoe/Actualizar',
                                data: {
                                    'Id': $('#txtCodigo').val(),
    ...
    tblComfoeAlistamientoMunicionComfoe = $('#tblComfoeAlistamientoMunicionComfoe').DataTable({
        ajax: {
            "url": '/ComfoeAlistamientoMunicionComfoe/CargaTabla',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            ...
            { "data": "cargaId" },  
            {
                "render": function (data, type, row) {
                    return '<a class="txt" onclick=edit(' + row.alistamientoMunicionComfoeId + ') title="Actualizar"><i class="fa fa-check-square-o" aria-hidden="true" style="color:black; padding-right:5px"></i>Editar</a>';
                }
            },
            {
                "render": function (data, type, row) {
                    return '<a class="txt btnconfirmation" onclick=eliminar(' + row.alistamientoMunicionComfoeId + ') title="Eliminar"><i class="fa fa-minus-square-o red" aria-hidden="true" style="color:red; padding-right:5px"></i>Eliminar</a>';
                }
            }
        ],
        language: {
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/ComfoeAlistamientoMunicionComfoe/Eliminar',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function eliminarCarga() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/ComfoeAlistamientoMunicionComfoe/EliminarCarga',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function nuevaComfoeAlistamientoMunicionComfoe() {
    $('#listar').hide();
    $('#nuevo').show();
}
...
function mostrarDatos() {
    ...
    $.ajax({
        type: "POST",
        url: 'ComfoeAlistamientoMunicionComfoe/MostrarDatos',
        data: formData,
        processData: false,
        contentType: false,
        beforeSend: function () {
...
function enviarDatos() {
    ...
    fetch("ComfoeAlistamientoMunicionComfoe/EnviarDatos", {
        method: "POST",
        body: formData
    })
...
function cargaDatos() {
    $.getJSON('/ComfoeAlistamientoMunicionComfoe/cargaCombs', [], function (Json) {
