var tblComzounoAlistamientoMaterialComzouno;
...
$(document).ready(function () {
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/ComzounoAlistamientoMaterialComzouno/Insertar',
                                data: {
                                ...
                                success: function (mensaje) {
                                    ...
                                    $('#listar').show();
                                    $('#nuevo').hide();
                                    $('#tblComzounoAlistamientoMaterialComzouno').DataTable().ajax.reload();
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/ComzounoAlistamientoMaterialComzouno/Actualizar',
                                data: {
                                    'Id': $('#txtCodigo').val(),
    ...
    tblComzounoAlistamientoMaterialComzouno = $('#tblComzounoAlistamientoMaterialComzouno').DataTable({
        ajax: {
            "url": '/ComzounoAlistamientoMaterialComzouno/CargaTabla',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
        ...
        buttons: [
            //csv,
            {
                extend: 'csvHtml5',
                text: 'Exportar CSV',
                filename: 'Comzouno - Alistamiento de material',
                title: '',
                exportOptions: {
            ...
            //'excel',
            {
                ...
                text: 'Exportar Excel',
                filename: 'Comzouno - Alistamiento de material',
                title: 'Comzouno - Alistamiento de material',
                exportOptions: {
                    columns: [0, 1, 2, 3, 4, 5, 6, 7, 8]
                },
...
function cargaBusqueda() {
    ...
    tblComzounoAlistamientoMaterialComzouno.columns(9).search(CodigoCarga).draw();
}

function mostrarTodos() {
    tblComzounoAlistamientoMaterialComzouno.columns(9).search('').draw();
}
...
function edit(Id) {
    $('#listar').hide();
    $('#editar').show();
    $.getJSON('/ComzounoAlistamientoMaterialComzouno/Mostrar?Id=' + Id, [], function (AlistamientoMaterialComzounoDTO) {
        $('#txtCodigo').val(AlistamientoMaterialComzounoDTO.alistamientoMaterialId);
        $('#cbUnidadNavale').val(AlistamientoMaterialComzounoDTO.codigoUnidadNaval);
        $('#cbCapacidadOperativae').val(AlistamientoMaterialComzounoDTO.codigoCapacidadOperativa);
        $('#cbAlistamientoMaterialRequerido3Ne').val(AlistamientoMaterialComzounoDTO.codigoAlistamientoMaterialRequerido3N);
        $('#txtRequeridoe').val(AlistamientoMaterialComzounoDTO.requerido);
        $('#txtOperativoe').val(AlistamientoMaterialComzounoDTO.operativo);
        $('#txtPorcentajeOperativoe').val(AlistamientoMaterialComzounoDTO.porcentajeOperatividad);
        $('#txtPonderadoFuncionale').val(AlistamientoMaterialComzounoDTO.ponderadoFuncional);
        $('#txtNivelAlistamientoe').val(AlistamientoMaterialComzounoDTO.nivelAlistamientoParcial);
    });
}
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/ComzounoAlistamientoMaterialComzouno/Eliminar',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function eliminarCarga() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/ComzounoAlistamientoMaterialComzouno/EliminarCarga',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function nuevaComzounoAlistamientoMaterialComzouno() {
    $('#listar').hide();
    $('#nuevo').show();
}
...
function mostrarDatos() {
    ...
    $.ajax({
        type: "POST",
        url: 'ComzounoAlistamientoMaterialComzouno/MostrarDatos',
        data: formData,
        processData: false,
        contentType: false,
        beforeSend: function () {
...
function enviarDatos() {
    ...
    fetch("ComzounoAlistamientoMaterialComzouno/EnviarDatos", {
        method: "POST",
        body: formData
    })
...
function cargaDatos() {
    $.getJSON('/ComzounoAlistamientoMaterialComzouno/cargaCombs', [], function (Json) {
