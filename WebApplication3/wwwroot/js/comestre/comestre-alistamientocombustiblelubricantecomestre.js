var tblComestreAlistamientoCombustibleLubricanteComestre;
...
$(document).ready(function () {
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/ComestreAlistamientoCombustibleLubricanteComestre/Insertar',
                                data: {
                                ...
                                success: function (mensaje) {
                                    ...
                                    $('#listar').show();
                                    $('#nuevo').hide();
                                    $('#tblComestreAlistamientoCombustibleLubricanteComestre').DataTable().ajax.reload();
                                },
                                complete: function () {
                                    $('#loader-6').hide();
                                }
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/ComestreAlistamientoCombustibleLubricanteComestre/Actualizar',
                                data: {
                                    'Id': $('#txtCodigo').val(),
    ...
    $('#tblComestreAlistamientoCombustibleLubricanteComestre').DataTable({
        ajax: {
            "url": '/ComestreAlistamientoCombustibleLubricanteComestre/CargaTabla',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
        ...
        buttons: [
            //csv,
            {
                extend: 'csvHtml5',
                text: 'Exportar CSV',
                filename: 'Comestre - Alistamiento de combustibles y lubricantes (ACL)',
                title: '',
                exportOptions: {
                    columns: [0, 1, 2, 3 ,4]
                },
            ...
            //'excel',
            {
                ...
                text: 'Exportar Excel',
                filename: 'Comestre - Alistamiento de combustibles y lubricantes (ACL)',
                title: 'Comestre - Alistamiento de combustibles y lubricantes (ACL)',
                exportOptions: {
                    columns: [0, 1, 2, 3, 4]
                },
...
function edit(Id) {
    $('#listar').hide();
    $('#editar').show();
    $.getJSON('/ComestreAlistamientoCombustibleLubricanteComestre/Mostrar?Id=' + Id, [], function (AlistamientoCombustibleLubricanteComestreDTO) {
        $('#txtCodigo').val(AlistamientoCombustibleLubricanteComestreDTO.alistamientoCombustibleLubricanteId);
        $('#cbUnidadNavale').val(AlistamientoCombustibleLubricanteComestreDTO.unidadNavalId);
        $('#cbAlistamientoCombustibleLubricante2e').val(AlistamientoCombustibleLubricanteComestreDTO.alistamientoCombustibleLubricante2Id);
        $('#txtArticuloAlistamientoe').val(AlistamientoCombustibleLubricanteComestreDTO.articulo);
        $('#txtEquipoAlistamientoe').val(AlistamientoCombustibleLubricanteComestreDTO.equipo);
        $('#txtUnidadMedidaAlistamientoe').val(AlistamientoCombustibleLubricanteComestreDTO.unidadMedida);
        $('#txtCargoAlistamientoe').val(AlistamientoCombustibleLubricanteComestreDTO.cargo);
        $('#txtAumentoAlistamientoe').val(AlistamientoCombustibleLubricanteComestreDTO.aumento);
        $('#txtConsumoAlistamientoe').val(AlistamientoCombustibleLubricanteComestreDTO.consumo);
        $('#txtExistenciaAlistamientoe').val(AlistamientoCombustibleLubricanteComestreDTO.existencia);
        $('#txtPromedioPonderadoe').val(AlistamientoCombustibleLubricanteComestreDTO.promedioPonderado);
        $('#txtSubPromedioParciale').val(AlistamientoCombustibleLubricanteComestreDTO.subPromedioParcial);
    });
}
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/ComestreAlistamientoCombustibleLubricanteComestre/Eliminar',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function nuevaComestreAlistamientoCombustibleLubricanteComestre() {
    $('#listar').hide();
    $('#nuevo').show();
}
...
function cargaDatos() {
    $.getJSON('/ComestreAlistamientoCombustibleLubricanteComestre/cargaCombs', [], function (Json) {
