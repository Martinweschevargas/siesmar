var tblJesehinAlistamientoMaterialJesehin;
...
$(document).ready(function () {
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/JesehinAlistamientoMaterialJesehin/Insertar',
                                data: {
                                ...
                                success: function (mensaje) {
                                    ...
                                    $('#listar').show();
                                    $('#nuevo').hide();
                                    $('#tblJesehinAlistamientoMaterialJesehin').DataTable().ajax.reload();
                                },
                                complete: function () {
                                    $('#loader-6').hide();
                                }
                ...
                if (!form.checkValidity()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: '/JesehinAlistamientoMaterialJesehin/Actualizar',
                                data: {
                                    'Id': $('#txtCodigo').val(),
    ...
    $('#tblJesehinAlistamientoMaterialJesehin').DataTable({
        ajax: {
            "url": '/JesehinAlistamientoMaterialJesehin/CargaTabla',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
        ...
        buttons: [
            //csv,
            {
                extend: 'csvHtml5',
                text: 'Exportar CSV',
                filename: 'Jesehin-3 - Alistamiento de material',
                title: '',
                exportOptions: {
            ...
            //'excel',
            {
                extend: 'excelHtml5',
                text: 'Exportar Excel',
                filename: 'Jesehin - Alistamiento de material',
                title: 'Jesehin - Alistamiento de material',
                exportOptions: {
                    columns: [0, 1, 2, 3, 4, 5, 6, 7, 8]
                },
...
function edit(Id) {
    $('#listar').hide();
    $('#editar').show();
    $.getJSON('/JesehinAlistamientoMaterialJesehin/Mostrar?Id=' + Id, [], function (AlistamientoMaterialJesehinDTO) {
        $('#txtCodigo').val(AlistamientoMaterialJesehinDTO.alistamientoMaterialId);
        $('#cbUnidadNavale').val(AlistamientoMaterialJesehinDTO.unidadNavalId);
        $('#cbCapacidadOperativa').val(AlistamientoMaterialJesehinDTO.capacidadOperativaId);
        $('#txtAlistamientoMaterialRequerido3N').val(AlistamientoMaterialJesehinDTO.alistamientoMaterialRequerido3NId);
        $('#txtCapacidadIntrinsecae').val(AlistamientoMaterialJesehinDTO.capacidadIntrinseca);
        $('#txtPonderacion1e').val(AlistamientoMaterialJesehinDTO.ponderacion1);
        $('#txtSubclasificacion2e').val(AlistamientoMaterialJesehinDTO.subclasificacion2);
        $('#txtPonderado2Nivele').val(AlistamientoMaterialJesehinDTO.ponderado2Nivel);
        $('#txtSubclasificacion3e').val(AlistamientoMaterialJesehinDTO.subclasificacion3);
        $('#txtPonderado3Nivele').val(AlistamientoMaterialJesehinDTO.ponderado3Nivel);
        $('#txtRequeridoe').val(AlistamientoMaterialJesehinDTO.requerido);
        $('#txtOperativoe').val(AlistamientoMaterialJesehinDTO.operativo);
        $('#txtPorcentajeOperativoe').val(AlistamientoMaterialJesehinDTO.porcentajeOperatividad);
        $('#txtPonderadoFuncionale').val(AlistamientoMaterialJesehinDTO.ponderadoFuncional);
        $('#txtNivelAlistamientoParciale').val(AlistamientoMaterialJesehinDTO.nivelAlistamientoParcial);
    });
}
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/JesehinAlistamientoMaterialJesehin/Eliminar',
                data: {
                    'Id': id
                },
                beforeSend: function () {
...
function nuevaJesehinAlistamientoMaterialJesehin() {
    $('#listar').hide();
    $('#nuevo').show();
}

function cargaDatos() {
    $.getJSON('/JesehinAlistamientoMaterialJesehin/cargaCombs', [], function (Json) {
