...
{
    public class FormatoSituacionOperatividadEquiposComflotfluDAO
    {
        ...
        public List<FormatoSituacionOperatividadEquiposComflotfluDTO> ObtenerLista()
        {
            ...
            {
                conexion.Open();
                cmd = new SqlCommand("Formato.usp_FormatoSituacionOperatividadEquiposComflotfluListar", conexion);
        ...
        public string AgregarRegistro(FormatoSituacionOperatividadEquiposComflotfluDTO formatoSituacionOperatividadEquiposComflotfluDTO)
        {
            ...
            using (var conexion = new SqlConnection(cn.getCadenaSQL()))
            {
                ...
                {
                    conexion.Open();
                    cmd = new SqlCommand("Formato.usp_FormatoSituacionOperatividadEquiposComflotfluRegistrar", conexion);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            FormatoSituacionOperatividadEquiposComflotfluDTO formatoSituacionOperatividadEquiposComflotfluDTO = new FormatoSituacionOperatividadEquiposComflotfluDTO();
            var cn = new ConfiguracionConexion();
            ...
            try
            {
                ...
                {
                    conexion.Open();
                    cmd = new SqlCommand("Formato.usp_FormatoSituacionOperatividadEquiposComflotfluEncontrar", conexion);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string ActualizaFormato(FormatoSituacionOperatividadEquiposComflotfluDTO formatoSituacionOperatividadEquiposComflotfluDTO)
        {
            string IND_OPERACION = "0";
            var cn = new ConfiguracionConexion();
            ...
            try
            {
                using (var conexion = new SqlConnection(cn.getCadenaSQL()))
                {
                    ...
                    cmd = new SqlCommand("Formato.usp_FormatoSituacionOperatividadEquiposComflotfluActualizar", conexion);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool EliminarFormato(FormatoSituacionOperatividadEquiposComflotfluDTO formatoSituacionOperatividadEquiposComflotfluDTO)
        {
            ...
            try
            {
                ...
                {
                    conexion.Open();
                    cmd = new SqlCommand("Formato.usp_FormatoSituacionOperatividadEquiposComflotfluEliminar", conexion);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool InsercionMasiva(IEnumerable<FormatoSituacionOperatividadEquiposComflotfluDTO> emisionNotaPrensaDTO)
        {
